...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	63f050ef          	jal	ffffffffc0205ea0 <memset>
...
ffffffffc020006e:	e6658593          	addi	a1,a1,-410 # ffffffffc0205ed0 <etext+0x6>
ffffffffc0200072:	00006517          	auipc	a0,0x6
ffffffffc0200076:	e7e50513          	addi	a0,a0,-386 # ffffffffc0205ef0 <etext+0x26>
...
ffffffffc0200092:	105030ef          	jal	ffffffffc0203996 <vmm_init>
    sched_init();
ffffffffc0200096:	6c6050ef          	jal	ffffffffc020575c <sched_init>
...
ffffffffc02000be:	e3e50513          	addi	a0,a0,-450 # ffffffffc0205ef8 <etext+0x2e>
...
ffffffffc020018a:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc020018c:	0fb050ef          	jal	ffffffffc0205a86 <vprintfmt>
    return cnt;
}
...
ffffffffc02001be:	e41a                	sd	t1,8(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001c0:	0c7050ef          	jal	ffffffffc0205a86 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200230:	cd450513          	addi	a0,a0,-812 # ffffffffc0205f00 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc0200246:	cde50513          	addi	a0,a0,-802 # ffffffffc0205f20 <etext+0x56>
ffffffffc020024a:	f4fff0ef          	jal	ffffffffc0200198 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020024e:	00006597          	auipc	a1,0x6
ffffffffc0200252:	c7c58593          	addi	a1,a1,-900 # ffffffffc0205eca <etext>
ffffffffc0200256:	00006517          	auipc	a0,0x6
ffffffffc020025a:	cea50513          	addi	a0,a0,-790 # ffffffffc0205f40 <etext+0x76>
...
ffffffffc020026e:	cf650513          	addi	a0,a0,-778 # ffffffffc0205f60 <etext+0x96>
...
ffffffffc0200282:	d0250513          	addi	a0,a0,-766 # ffffffffc0205f80 <etext+0xb6>
...
ffffffffc02002ae:	cf650513          	addi	a0,a0,-778 # ffffffffc0205fa0 <etext+0xd6>
}
...
ffffffffc02002bc:	d1860613          	addi	a2,a2,-744 # ffffffffc0205fd0 <etext+0x106>
ffffffffc02002c0:	04d00593          	li	a1,77
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	d2450513          	addi	a0,a0,-732 # ffffffffc0205fe8 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc02002de:	99640413          	addi	s0,s0,-1642 # ffffffffc0207c70 <commands>
ffffffffc02002e2:	00008497          	auipc	s1,0x8
ffffffffc02002e6:	9d648493          	addi	s1,s1,-1578 # ffffffffc0207cb8 <commands+0x48>
    int i;
...
ffffffffc02002f2:	d1250513          	addi	a0,a0,-750 # ffffffffc0206000 <etext+0x136>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200336:	cde50513          	addi	a0,a0,-802 # ffffffffc0206010 <etext+0x146>
kmonitor(struct trapframe *tf) {
...
ffffffffc020034e:	cee50513          	addi	a0,a0,-786 # ffffffffc0206038 <etext+0x16e>
...
ffffffffc0200364:	910a8a93          	addi	s5,s5,-1776 # ffffffffc0207c70 <commands>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
        if ((buf = readline("K> ")) != NULL) {
ffffffffc020036a:	00006517          	auipc	a0,0x6
ffffffffc020036e:	cf650513          	addi	a0,a0,-778 # ffffffffc0206060 <etext+0x196>
...
ffffffffc020038c:	8e848493          	addi	s1,s1,-1816 # ffffffffc0207c70 <commands>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200390:	4401                	li	s0,0
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc0200392:	6582                	ld	a1,0(sp)
ffffffffc0200394:	6088                	ld	a0,0(s1)
ffffffffc0200396:	29d050ef          	jal	ffffffffc0205e32 <strcmp>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003ac:	ce850513          	addi	a0,a0,-792 # ffffffffc0206090 <etext+0x1c6>
...
ffffffffc02003ba:	cb250513          	addi	a0,a0,-846 # ffffffffc0206068 <etext+0x19e>
ffffffffc02003be:	2d1050ef          	jal	ffffffffc0205e8e <strchr>
...
ffffffffc02003fc:	c7050513          	addi	a0,a0,-912 # ffffffffc0206068 <etext+0x19e>
ffffffffc0200400:	28f050ef          	jal	ffffffffc0205e8e <strchr>
...
ffffffffc0200414:	c6050513          	addi	a0,a0,-928 # ffffffffc0206070 <etext+0x1a6>
...
ffffffffc0200474:	cc850513          	addi	a0,a0,-824 # ffffffffc0206138 <etext+0x26e>
    is_panic = 1;
...
ffffffffc0200492:	cca50513          	addi	a0,a0,-822 # ffffffffc0206158 <etext+0x28e>
...
ffffffffc02004d6:	c8e50513          	addi	a0,a0,-882 # ffffffffc0206160 <etext+0x296>
    ticks = 0;
...
ffffffffc02005c4:	bc050513          	addi	a0,a0,-1088 # ffffffffc0206180 <etext+0x2b6>
void dtb_init(void) {
...
ffffffffc02005dc:	bb850513          	addi	a0,a0,-1096 # ffffffffc0206190 <etext+0x2c6>
...
ffffffffc02005f2:	bb250513          	addi	a0,a0,-1102 # ffffffffc02061a0 <etext+0x2d6>
...
ffffffffc0200600:	bbc50513          	addi	a0,a0,-1092 # ffffffffc02061b8 <etext+0x2ee>
    if (boot_dtb == 0) {
...
ffffffffc02006f2:	b9250513          	addi	a0,a0,-1134 # ffffffffc0206280 <etext+0x3b6>
...
ffffffffc0200702:	bba50513          	addi	a0,a0,-1094 # ffffffffc02062b8 <etext+0x3ee>
}
...
ffffffffc0200716:	ac650513          	addi	a0,a0,-1338 # ffffffffc02061d8 <etext+0x30e>
}
...
ffffffffc0200758:	694050ef          	jal	ffffffffc0205dec <strlen>
...
ffffffffc0200766:	a9e58593          	addi	a1,a1,-1378 # ffffffffc0206200 <etext+0x336>
ffffffffc020076a:	6fc050ef          	jal	ffffffffc0205e66 <strncmp>
...
ffffffffc0200792:	a7a58593          	addi	a1,a1,-1414 # ffffffffc0206208 <etext+0x33e>
...
ffffffffc02007c4:	66e050ef          	jal	ffffffffc0205e32 <strcmp>
...
ffffffffc02007e8:	a2c50513          	addi	a0,a0,-1492 # ffffffffc0206210 <etext+0x346>
           fdt32_to_cpu(x >> 32);
...
ffffffffc02008b2:	98250513          	addi	a0,a0,-1662 # ffffffffc0206230 <etext+0x366>
...
ffffffffc02008c4:	98850513          	addi	a0,a0,-1656 # ffffffffc0206248 <etext+0x37e>
...
ffffffffc02008d6:	99650513          	addi	a0,a0,-1642 # ffffffffc0206268 <etext+0x39e>
...
ffffffffc0200938:	99c50513          	addi	a0,a0,-1636 # ffffffffc02062d0 <etext+0x406>
{
...
ffffffffc0200948:	9a450513          	addi	a0,a0,-1628 # ffffffffc02062e8 <etext+0x41e>
...
ffffffffc0200956:	9ae50513          	addi	a0,a0,-1618 # ffffffffc0206300 <etext+0x436>
...
ffffffffc0200964:	9b850513          	addi	a0,a0,-1608 # ffffffffc0206318 <etext+0x44e>
...
ffffffffc0200972:	9c250513          	addi	a0,a0,-1598 # ffffffffc0206330 <etext+0x466>
...
ffffffffc0200980:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0206348 <etext+0x47e>
...
ffffffffc020098e:	9d650513          	addi	a0,a0,-1578 # ffffffffc0206360 <etext+0x496>
...
ffffffffc020099c:	9e050513          	addi	a0,a0,-1568 # ffffffffc0206378 <etext+0x4ae>
...
ffffffffc02009aa:	9ea50513          	addi	a0,a0,-1558 # ffffffffc0206390 <etext+0x4c6>
...
ffffffffc02009b8:	9f450513          	addi	a0,a0,-1548 # ffffffffc02063a8 <etext+0x4de>
...
ffffffffc02009c6:	9fe50513          	addi	a0,a0,-1538 # ffffffffc02063c0 <etext+0x4f6>
...
ffffffffc02009d4:	a0850513          	addi	a0,a0,-1528 # ffffffffc02063d8 <etext+0x50e>
...
ffffffffc02009e2:	a1250513          	addi	a0,a0,-1518 # ffffffffc02063f0 <etext+0x526>
...
ffffffffc02009f0:	a1c50513          	addi	a0,a0,-1508 # ffffffffc0206408 <etext+0x53e>
...
ffffffffc02009fe:	a2650513          	addi	a0,a0,-1498 # ffffffffc0206420 <etext+0x556>
...
ffffffffc0200a0c:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206438 <etext+0x56e>
...
ffffffffc0200a1a:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0206450 <etext+0x586>
...
ffffffffc0200a28:	a4450513          	addi	a0,a0,-1468 # ffffffffc0206468 <etext+0x59e>
...
ffffffffc0200a36:	a4e50513          	addi	a0,a0,-1458 # ffffffffc0206480 <etext+0x5b6>
...
ffffffffc0200a44:	a5850513          	addi	a0,a0,-1448 # ffffffffc0206498 <etext+0x5ce>
...
ffffffffc0200a52:	a6250513          	addi	a0,a0,-1438 # ffffffffc02064b0 <etext+0x5e6>
...
ffffffffc0200a60:	a6c50513          	addi	a0,a0,-1428 # ffffffffc02064c8 <etext+0x5fe>
...
ffffffffc0200a6e:	a7650513          	addi	a0,a0,-1418 # ffffffffc02064e0 <etext+0x616>
...
ffffffffc0200a7c:	a8050513          	addi	a0,a0,-1408 # ffffffffc02064f8 <etext+0x62e>
...
ffffffffc0200a8a:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0206510 <etext+0x646>
...
ffffffffc0200a98:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206528 <etext+0x65e>
...
ffffffffc0200aa6:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206540 <etext+0x676>
...
ffffffffc0200ab4:	aa850513          	addi	a0,a0,-1368 # ffffffffc0206558 <etext+0x68e>
...
ffffffffc0200ac2:	ab250513          	addi	a0,a0,-1358 # ffffffffc0206570 <etext+0x6a6>
...
ffffffffc0200ad0:	abc50513          	addi	a0,a0,-1348 # ffffffffc0206588 <etext+0x6be>
...
ffffffffc0200ade:	ac650513          	addi	a0,a0,-1338 # ffffffffc02065a0 <etext+0x6d6>
...
ffffffffc0200af0:	acc50513          	addi	a0,a0,-1332 # ffffffffc02065b8 <etext+0x6ee>
}
...
ffffffffc0200b06:	ace50513          	addi	a0,a0,-1330 # ffffffffc02065d0 <etext+0x706>
{
...
ffffffffc0200b1e:	ace50513          	addi	a0,a0,-1330 # ffffffffc02065e8 <etext+0x71e>
...
ffffffffc0200b2e:	ad650513          	addi	a0,a0,-1322 # ffffffffc0206600 <etext+0x736>
...
ffffffffc0200b3e:	ade50513          	addi	a0,a0,-1314 # ffffffffc0206618 <etext+0x74e>
...
ffffffffc0200b52:	ada50513          	addi	a0,a0,-1318 # ffffffffc0206628 <etext+0x75e>
}
...
ffffffffc0200b6e:	14e70713          	addi	a4,a4,334 # ffffffffc0207cb8 <commands+0x48>
...
ffffffffc0200bdc:	0141                	addi	sp,sp,16
        sched_class_proc_tick(current);
ffffffffc0200bde:	35b0406f          	j	ffffffffc0205738 <sched_class_proc_tick>
        cprintf("Supervisor external interrupt\n");
ffffffffc0200be2:	00006517          	auipc	a0,0x6
ffffffffc0200be6:	b2e50513          	addi	a0,a0,-1234 # ffffffffc0206710 <etext+0x846>
...
ffffffffc0200bfa:	aca50513          	addi	a0,a0,-1334 # ffffffffc02066c0 <etext+0x7f6>
ffffffffc0200bfe:	d9aff0ef          	jal	ffffffffc0200198 <cprintf>
    cprintf("End of Test.\n");
ffffffffc0200c02:	00006517          	auipc	a0,0x6
ffffffffc0200c06:	ace50513          	addi	a0,a0,-1330 # ffffffffc02066d0 <etext+0x806>
ffffffffc0200c0a:	d8eff0ef          	jal	ffffffffc0200198 <cprintf>
    panic("EOT: kernel seems ok.");
ffffffffc0200c0e:	00006617          	auipc	a2,0x6
ffffffffc0200c12:	ad260613          	addi	a2,a2,-1326 # ffffffffc02066e0 <etext+0x816>
ffffffffc0200c16:	45ed                	li	a1,27
ffffffffc0200c18:	00006517          	auipc	a0,0x6
ffffffffc0200c1c:	ae050513          	addi	a0,a0,-1312 # ffffffffc02066f8 <etext+0x82e>
...
ffffffffc0200c32:	0ba70713          	addi	a4,a4,186 # ffffffffc0207ce8 <commands+0x78>
...
ffffffffc0200c4c:	bb850513          	addi	a0,a0,-1096 # ffffffffc0206800 <etext+0x936>
...
ffffffffc0200c62:	6105                	addi	sp,sp,32
        syscall();
ffffffffc0200c64:	5290406f          	j	ffffffffc020598c <syscall>
}
ffffffffc0200c68:	60e2                	ld	ra,24(sp)
        cprintf("Environment call from H-mode\n");
ffffffffc0200c6a:	00006517          	auipc	a0,0x6
ffffffffc0200c6e:	bb650513          	addi	a0,a0,-1098 # ffffffffc0206820 <etext+0x956>
}
...
ffffffffc0200c7e:	bc650513          	addi	a0,a0,-1082 # ffffffffc0206840 <etext+0x976>
}
...
ffffffffc0200c8e:	bd650513          	addi	a0,a0,-1066 # ffffffffc0206860 <etext+0x996>
}
...
ffffffffc0200c9e:	bde50513          	addi	a0,a0,-1058 # ffffffffc0206878 <etext+0x9ae>
}
...
ffffffffc0200cae:	be650513          	addi	a0,a0,-1050 # ffffffffc0206890 <etext+0x9c6>
}
...
ffffffffc0200cbe:	a7650513          	addi	a0,a0,-1418 # ffffffffc0206730 <etext+0x866>
}
...
ffffffffc0200cce:	a8650513          	addi	a0,a0,-1402 # ffffffffc0206750 <etext+0x886>
}
...
ffffffffc0200cde:	a9650513          	addi	a0,a0,-1386 # ffffffffc0206770 <etext+0x8a6>
}
...
ffffffffc0200cee:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206788 <etext+0x8be>
}
...
ffffffffc0200cfe:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206798 <etext+0x8ce>
}
...
ffffffffc0200d0e:	aae50513          	addi	a0,a0,-1362 # ffffffffc02067b8 <etext+0x8ee>
}
...
ffffffffc0200d1e:	ace50513          	addi	a0,a0,-1330 # ffffffffc02067e8 <etext+0x91e>
}
...
ffffffffc0200d32:	aa260613          	addi	a2,a2,-1374 # ffffffffc02067d0 <etext+0x906>
ffffffffc0200d36:	0c800593          	li	a1,200
ffffffffc0200d3a:	00006517          	auipc	a0,0x6
ffffffffc0200d3e:	9be50513          	addi	a0,a0,-1602 # ffffffffc02066f8 <etext+0x82e>
...
ffffffffc0200db6:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200db8:	29f0406f          	j	ffffffffc0205856 <schedule>
                do_exit(-E_KILLED);
...
ffffffffc0200f64:	82063603          	ld	a2,-2016(a2) # ffffffffc0208780 <nbase>
...
ffffffffc02011cc:	6e068693          	addi	a3,a3,1760 # ffffffffc02068a8 <etext+0x9de>
ffffffffc02011d0:	00005617          	auipc	a2,0x5
ffffffffc02011d4:	6e860613          	addi	a2,a2,1768 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02011d8:	11000593          	li	a1,272
ffffffffc02011dc:	00005517          	auipc	a0,0x5
ffffffffc02011e0:	6f450513          	addi	a0,a0,1780 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02011e4:	a66ff0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc02011e8:	00005697          	auipc	a3,0x5
ffffffffc02011ec:	7a868693          	addi	a3,a3,1960 # ffffffffc0206990 <etext+0xac6>
ffffffffc02011f0:	00005617          	auipc	a2,0x5
ffffffffc02011f4:	6c860613          	addi	a2,a2,1736 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02011f8:	0dc00593          	li	a1,220
ffffffffc02011fc:	00005517          	auipc	a0,0x5
ffffffffc0201200:	6d450513          	addi	a0,a0,1748 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201204:	a46ff0ef          	jal	ffffffffc020044a <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201208:	00006697          	auipc	a3,0x6
ffffffffc020120c:	85068693          	addi	a3,a3,-1968 # ffffffffc0206a58 <etext+0xb8e>
ffffffffc0201210:	00005617          	auipc	a2,0x5
ffffffffc0201214:	6a860613          	addi	a2,a2,1704 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201218:	0f700593          	li	a1,247
ffffffffc020121c:	00005517          	auipc	a0,0x5
ffffffffc0201220:	6b450513          	addi	a0,a0,1716 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201224:	a26ff0ef          	jal	ffffffffc020044a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201228:	00005697          	auipc	a3,0x5
ffffffffc020122c:	7a868693          	addi	a3,a3,1960 # ffffffffc02069d0 <etext+0xb06>
ffffffffc0201230:	00005617          	auipc	a2,0x5
ffffffffc0201234:	68860613          	addi	a2,a2,1672 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201238:	0de00593          	li	a1,222
ffffffffc020123c:	00005517          	auipc	a0,0x5
ffffffffc0201240:	69450513          	addi	a0,a0,1684 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201244:	a06ff0ef          	jal	ffffffffc020044a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201248:	00005697          	auipc	a3,0x5
ffffffffc020124c:	72068693          	addi	a3,a3,1824 # ffffffffc0206968 <etext+0xa9e>
ffffffffc0201250:	00005617          	auipc	a2,0x5
ffffffffc0201254:	66860613          	addi	a2,a2,1640 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201258:	0db00593          	li	a1,219
ffffffffc020125c:	00005517          	auipc	a0,0x5
ffffffffc0201260:	67450513          	addi	a0,a0,1652 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201264:	9e6ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201268:	00005697          	auipc	a3,0x5
ffffffffc020126c:	6a068693          	addi	a3,a3,1696 # ffffffffc0206908 <etext+0xa3e>
ffffffffc0201270:	00005617          	auipc	a2,0x5
ffffffffc0201274:	64860613          	addi	a2,a2,1608 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201278:	0f000593          	li	a1,240
ffffffffc020127c:	00005517          	auipc	a0,0x5
ffffffffc0201280:	65450513          	addi	a0,a0,1620 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201284:	9c6ff0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_free == 3);
ffffffffc0201288:	00005697          	auipc	a3,0x5
ffffffffc020128c:	7c068693          	addi	a3,a3,1984 # ffffffffc0206a48 <etext+0xb7e>
ffffffffc0201290:	00005617          	auipc	a2,0x5
ffffffffc0201294:	62860613          	addi	a2,a2,1576 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201298:	0ee00593          	li	a1,238
ffffffffc020129c:	00005517          	auipc	a0,0x5
ffffffffc02012a0:	63450513          	addi	a0,a0,1588 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02012a4:	9a6ff0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012a8:	00005697          	auipc	a3,0x5
ffffffffc02012ac:	78868693          	addi	a3,a3,1928 # ffffffffc0206a30 <etext+0xb66>
ffffffffc02012b0:	00005617          	auipc	a2,0x5
ffffffffc02012b4:	60860613          	addi	a2,a2,1544 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02012b8:	0e900593          	li	a1,233
ffffffffc02012bc:	00005517          	auipc	a0,0x5
ffffffffc02012c0:	61450513          	addi	a0,a0,1556 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02012c4:	986ff0ef          	jal	ffffffffc020044a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02012c8:	00005697          	auipc	a3,0x5
ffffffffc02012cc:	74868693          	addi	a3,a3,1864 # ffffffffc0206a10 <etext+0xb46>
ffffffffc02012d0:	00005617          	auipc	a2,0x5
ffffffffc02012d4:	5e860613          	addi	a2,a2,1512 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02012d8:	0e000593          	li	a1,224
ffffffffc02012dc:	00005517          	auipc	a0,0x5
ffffffffc02012e0:	5f450513          	addi	a0,a0,1524 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02012e4:	966ff0ef          	jal	ffffffffc020044a <__panic>
    assert(p0 != NULL);
ffffffffc02012e8:	00005697          	auipc	a3,0x5
ffffffffc02012ec:	7b868693          	addi	a3,a3,1976 # ffffffffc0206aa0 <etext+0xbd6>
ffffffffc02012f0:	00005617          	auipc	a2,0x5
ffffffffc02012f4:	5c860613          	addi	a2,a2,1480 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02012f8:	11800593          	li	a1,280
ffffffffc02012fc:	00005517          	auipc	a0,0x5
ffffffffc0201300:	5d450513          	addi	a0,a0,1492 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201304:	946ff0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_free == 0);
ffffffffc0201308:	00005697          	auipc	a3,0x5
ffffffffc020130c:	78868693          	addi	a3,a3,1928 # ffffffffc0206a90 <etext+0xbc6>
ffffffffc0201310:	00005617          	auipc	a2,0x5
ffffffffc0201314:	5a860613          	addi	a2,a2,1448 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201318:	0fd00593          	li	a1,253
ffffffffc020131c:	00005517          	auipc	a0,0x5
ffffffffc0201320:	5b450513          	addi	a0,a0,1460 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201324:	926ff0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201328:	00005697          	auipc	a3,0x5
ffffffffc020132c:	70868693          	addi	a3,a3,1800 # ffffffffc0206a30 <etext+0xb66>
ffffffffc0201330:	00005617          	auipc	a2,0x5
ffffffffc0201334:	58860613          	addi	a2,a2,1416 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201338:	0fb00593          	li	a1,251
ffffffffc020133c:	00005517          	auipc	a0,0x5
ffffffffc0201340:	59450513          	addi	a0,a0,1428 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201344:	906ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201348:	00005697          	auipc	a3,0x5
ffffffffc020134c:	72868693          	addi	a3,a3,1832 # ffffffffc0206a70 <etext+0xba6>
ffffffffc0201350:	00005617          	auipc	a2,0x5
ffffffffc0201354:	56860613          	addi	a2,a2,1384 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201358:	0fa00593          	li	a1,250
ffffffffc020135c:	00005517          	auipc	a0,0x5
ffffffffc0201360:	57450513          	addi	a0,a0,1396 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201364:	8e6ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201368:	00005697          	auipc	a3,0x5
ffffffffc020136c:	5a068693          	addi	a3,a3,1440 # ffffffffc0206908 <etext+0xa3e>
ffffffffc0201370:	00005617          	auipc	a2,0x5
ffffffffc0201374:	54860613          	addi	a2,a2,1352 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201378:	0d700593          	li	a1,215
ffffffffc020137c:	00005517          	auipc	a0,0x5
ffffffffc0201380:	55450513          	addi	a0,a0,1364 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201384:	8c6ff0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201388:	00005697          	auipc	a3,0x5
ffffffffc020138c:	6a868693          	addi	a3,a3,1704 # ffffffffc0206a30 <etext+0xb66>
ffffffffc0201390:	00005617          	auipc	a2,0x5
ffffffffc0201394:	52860613          	addi	a2,a2,1320 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201398:	0f400593          	li	a1,244
ffffffffc020139c:	00005517          	auipc	a0,0x5
ffffffffc02013a0:	53450513          	addi	a0,a0,1332 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02013a4:	8a6ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02013a8:	00005697          	auipc	a3,0x5
ffffffffc02013ac:	5a068693          	addi	a3,a3,1440 # ffffffffc0206948 <etext+0xa7e>
ffffffffc02013b0:	00005617          	auipc	a2,0x5
ffffffffc02013b4:	50860613          	addi	a2,a2,1288 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02013b8:	0f200593          	li	a1,242
ffffffffc02013bc:	00005517          	auipc	a0,0x5
ffffffffc02013c0:	51450513          	addi	a0,a0,1300 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02013c4:	886ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02013c8:	00005697          	auipc	a3,0x5
ffffffffc02013cc:	56068693          	addi	a3,a3,1376 # ffffffffc0206928 <etext+0xa5e>
ffffffffc02013d0:	00005617          	auipc	a2,0x5
ffffffffc02013d4:	4e860613          	addi	a2,a2,1256 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02013d8:	0f100593          	li	a1,241
ffffffffc02013dc:	00005517          	auipc	a0,0x5
ffffffffc02013e0:	4f450513          	addi	a0,a0,1268 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02013e4:	866ff0ef          	jal	ffffffffc020044a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02013e8:	00005697          	auipc	a3,0x5
ffffffffc02013ec:	56068693          	addi	a3,a3,1376 # ffffffffc0206948 <etext+0xa7e>
ffffffffc02013f0:	00005617          	auipc	a2,0x5
ffffffffc02013f4:	4c860613          	addi	a2,a2,1224 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02013f8:	0d900593          	li	a1,217
ffffffffc02013fc:	00005517          	auipc	a0,0x5
ffffffffc0201400:	4d450513          	addi	a0,a0,1236 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201404:	846ff0ef          	jal	ffffffffc020044a <__panic>
    assert(count == 0);
ffffffffc0201408:	00005697          	auipc	a3,0x5
ffffffffc020140c:	7e868693          	addi	a3,a3,2024 # ffffffffc0206bf0 <etext+0xd26>
ffffffffc0201410:	00005617          	auipc	a2,0x5
ffffffffc0201414:	4a860613          	addi	a2,a2,1192 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201418:	14600593          	li	a1,326
ffffffffc020141c:	00005517          	auipc	a0,0x5
ffffffffc0201420:	4b450513          	addi	a0,a0,1204 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201424:	826ff0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_free == 0);
ffffffffc0201428:	00005697          	auipc	a3,0x5
ffffffffc020142c:	66868693          	addi	a3,a3,1640 # ffffffffc0206a90 <etext+0xbc6>
ffffffffc0201430:	00005617          	auipc	a2,0x5
ffffffffc0201434:	48860613          	addi	a2,a2,1160 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201438:	13a00593          	li	a1,314
ffffffffc020143c:	00005517          	auipc	a0,0x5
ffffffffc0201440:	49450513          	addi	a0,a0,1172 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201444:	806ff0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201448:	00005697          	auipc	a3,0x5
ffffffffc020144c:	5e868693          	addi	a3,a3,1512 # ffffffffc0206a30 <etext+0xb66>
ffffffffc0201450:	00005617          	auipc	a2,0x5
ffffffffc0201454:	46860613          	addi	a2,a2,1128 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201458:	13800593          	li	a1,312
ffffffffc020145c:	00005517          	auipc	a0,0x5
ffffffffc0201460:	47450513          	addi	a0,a0,1140 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201464:	fe7fe0ef          	jal	ffffffffc020044a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201468:	00005697          	auipc	a3,0x5
ffffffffc020146c:	58868693          	addi	a3,a3,1416 # ffffffffc02069f0 <etext+0xb26>
ffffffffc0201470:	00005617          	auipc	a2,0x5
ffffffffc0201474:	44860613          	addi	a2,a2,1096 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201478:	0df00593          	li	a1,223
ffffffffc020147c:	00005517          	auipc	a0,0x5
ffffffffc0201480:	45450513          	addi	a0,a0,1108 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201484:	fc7fe0ef          	jal	ffffffffc020044a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201488:	00005697          	auipc	a3,0x5
ffffffffc020148c:	72868693          	addi	a3,a3,1832 # ffffffffc0206bb0 <etext+0xce6>
ffffffffc0201490:	00005617          	auipc	a2,0x5
ffffffffc0201494:	42860613          	addi	a2,a2,1064 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201498:	13200593          	li	a1,306
ffffffffc020149c:	00005517          	auipc	a0,0x5
ffffffffc02014a0:	43450513          	addi	a0,a0,1076 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02014a4:	fa7fe0ef          	jal	ffffffffc020044a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02014a8:	00005697          	auipc	a3,0x5
ffffffffc02014ac:	6e868693          	addi	a3,a3,1768 # ffffffffc0206b90 <etext+0xcc6>
ffffffffc02014b0:	00005617          	auipc	a2,0x5
ffffffffc02014b4:	40860613          	addi	a2,a2,1032 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02014b8:	13000593          	li	a1,304
ffffffffc02014bc:	00005517          	auipc	a0,0x5
ffffffffc02014c0:	41450513          	addi	a0,a0,1044 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02014c4:	f87fe0ef          	jal	ffffffffc020044a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02014c8:	00005697          	auipc	a3,0x5
ffffffffc02014cc:	6a068693          	addi	a3,a3,1696 # ffffffffc0206b68 <etext+0xc9e>
ffffffffc02014d0:	00005617          	auipc	a2,0x5
ffffffffc02014d4:	3e860613          	addi	a2,a2,1000 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02014d8:	12e00593          	li	a1,302
ffffffffc02014dc:	00005517          	auipc	a0,0x5
ffffffffc02014e0:	3f450513          	addi	a0,a0,1012 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02014e4:	f67fe0ef          	jal	ffffffffc020044a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02014e8:	00005697          	auipc	a3,0x5
ffffffffc02014ec:	65868693          	addi	a3,a3,1624 # ffffffffc0206b40 <etext+0xc76>
ffffffffc02014f0:	00005617          	auipc	a2,0x5
ffffffffc02014f4:	3c860613          	addi	a2,a2,968 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02014f8:	12d00593          	li	a1,301
ffffffffc02014fc:	00005517          	auipc	a0,0x5
ffffffffc0201500:	3d450513          	addi	a0,a0,980 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201504:	f47fe0ef          	jal	ffffffffc020044a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201508:	00005697          	auipc	a3,0x5
ffffffffc020150c:	62868693          	addi	a3,a3,1576 # ffffffffc0206b30 <etext+0xc66>
ffffffffc0201510:	00005617          	auipc	a2,0x5
ffffffffc0201514:	3a860613          	addi	a2,a2,936 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201518:	12800593          	li	a1,296
ffffffffc020151c:	00005517          	auipc	a0,0x5
ffffffffc0201520:	3b450513          	addi	a0,a0,948 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201524:	f27fe0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201528:	00005697          	auipc	a3,0x5
ffffffffc020152c:	50868693          	addi	a3,a3,1288 # ffffffffc0206a30 <etext+0xb66>
ffffffffc0201530:	00005617          	auipc	a2,0x5
ffffffffc0201534:	38860613          	addi	a2,a2,904 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201538:	12700593          	li	a1,295
ffffffffc020153c:	00005517          	auipc	a0,0x5
ffffffffc0201540:	39450513          	addi	a0,a0,916 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201544:	f07fe0ef          	jal	ffffffffc020044a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201548:	00005697          	auipc	a3,0x5
ffffffffc020154c:	5c868693          	addi	a3,a3,1480 # ffffffffc0206b10 <etext+0xc46>
ffffffffc0201550:	00005617          	auipc	a2,0x5
ffffffffc0201554:	36860613          	addi	a2,a2,872 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201558:	12600593          	li	a1,294
ffffffffc020155c:	00005517          	auipc	a0,0x5
ffffffffc0201560:	37450513          	addi	a0,a0,884 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201564:	ee7fe0ef          	jal	ffffffffc020044a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201568:	00005697          	auipc	a3,0x5
ffffffffc020156c:	57868693          	addi	a3,a3,1400 # ffffffffc0206ae0 <etext+0xc16>
ffffffffc0201570:	00005617          	auipc	a2,0x5
ffffffffc0201574:	34860613          	addi	a2,a2,840 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201578:	12500593          	li	a1,293
ffffffffc020157c:	00005517          	auipc	a0,0x5
ffffffffc0201580:	35450513          	addi	a0,a0,852 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201584:	ec7fe0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201588:	00005697          	auipc	a3,0x5
ffffffffc020158c:	54068693          	addi	a3,a3,1344 # ffffffffc0206ac8 <etext+0xbfe>
ffffffffc0201590:	00005617          	auipc	a2,0x5
ffffffffc0201594:	32860613          	addi	a2,a2,808 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201598:	12400593          	li	a1,292
ffffffffc020159c:	00005517          	auipc	a0,0x5
ffffffffc02015a0:	33450513          	addi	a0,a0,820 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02015a4:	ea7fe0ef          	jal	ffffffffc020044a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02015a8:	00005697          	auipc	a3,0x5
ffffffffc02015ac:	48868693          	addi	a3,a3,1160 # ffffffffc0206a30 <etext+0xb66>
ffffffffc02015b0:	00005617          	auipc	a2,0x5
ffffffffc02015b4:	30860613          	addi	a2,a2,776 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02015b8:	11e00593          	li	a1,286
ffffffffc02015bc:	00005517          	auipc	a0,0x5
ffffffffc02015c0:	31450513          	addi	a0,a0,788 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02015c4:	e87fe0ef          	jal	ffffffffc020044a <__panic>
    assert(!PageProperty(p0));
ffffffffc02015c8:	00005697          	auipc	a3,0x5
ffffffffc02015cc:	4e868693          	addi	a3,a3,1256 # ffffffffc0206ab0 <etext+0xbe6>
ffffffffc02015d0:	00005617          	auipc	a2,0x5
ffffffffc02015d4:	2e860613          	addi	a2,a2,744 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02015d8:	11900593          	li	a1,281
ffffffffc02015dc:	00005517          	auipc	a0,0x5
ffffffffc02015e0:	2f450513          	addi	a0,a0,756 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02015e4:	e67fe0ef          	jal	ffffffffc020044a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02015e8:	00005697          	auipc	a3,0x5
ffffffffc02015ec:	5e868693          	addi	a3,a3,1512 # ffffffffc0206bd0 <etext+0xd06>
ffffffffc02015f0:	00005617          	auipc	a2,0x5
ffffffffc02015f4:	2c860613          	addi	a2,a2,712 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02015f8:	13700593          	li	a1,311
ffffffffc02015fc:	00005517          	auipc	a0,0x5
ffffffffc0201600:	2d450513          	addi	a0,a0,724 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201604:	e47fe0ef          	jal	ffffffffc020044a <__panic>
    assert(total == 0);
ffffffffc0201608:	00005697          	auipc	a3,0x5
ffffffffc020160c:	5f868693          	addi	a3,a3,1528 # ffffffffc0206c00 <etext+0xd36>
ffffffffc0201610:	00005617          	auipc	a2,0x5
ffffffffc0201614:	2a860613          	addi	a2,a2,680 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201618:	14700593          	li	a1,327
ffffffffc020161c:	00005517          	auipc	a0,0x5
ffffffffc0201620:	2b450513          	addi	a0,a0,692 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201624:	e27fe0ef          	jal	ffffffffc020044a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201628:	00005697          	auipc	a3,0x5
ffffffffc020162c:	2c068693          	addi	a3,a3,704 # ffffffffc02068e8 <etext+0xa1e>
ffffffffc0201630:	00005617          	auipc	a2,0x5
ffffffffc0201634:	28860613          	addi	a2,a2,648 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201638:	11300593          	li	a1,275
ffffffffc020163c:	00005517          	auipc	a0,0x5
ffffffffc0201640:	29450513          	addi	a0,a0,660 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201644:	e07fe0ef          	jal	ffffffffc020044a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201648:	00005697          	auipc	a3,0x5
ffffffffc020164c:	2e068693          	addi	a3,a3,736 # ffffffffc0206928 <etext+0xa5e>
ffffffffc0201650:	00005617          	auipc	a2,0x5
ffffffffc0201654:	26860613          	addi	a2,a2,616 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201658:	0d800593          	li	a1,216
ffffffffc020165c:	00005517          	auipc	a0,0x5
ffffffffc0201660:	27450513          	addi	a0,a0,628 # ffffffffc02068d0 <etext+0xa06>
...
ffffffffc020179c:	48068693          	addi	a3,a3,1152 # ffffffffc0206c18 <etext+0xd4e>
ffffffffc02017a0:	00005617          	auipc	a2,0x5
ffffffffc02017a4:	11860613          	addi	a2,a2,280 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02017a8:	09400593          	li	a1,148
ffffffffc02017ac:	00005517          	auipc	a0,0x5
ffffffffc02017b0:	12450513          	addi	a0,a0,292 # ffffffffc02068d0 <etext+0xa06>
ffffffffc02017b4:	c97fe0ef          	jal	ffffffffc020044a <__panic>
    assert(n > 0);
ffffffffc02017b8:	00005697          	auipc	a3,0x5
ffffffffc02017bc:	45868693          	addi	a3,a3,1112 # ffffffffc0206c10 <etext+0xd46>
ffffffffc02017c0:	00005617          	auipc	a2,0x5
ffffffffc02017c4:	0f860613          	addi	a2,a2,248 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02017c8:	09000593          	li	a1,144
ffffffffc02017cc:	00005517          	auipc	a0,0x5
ffffffffc02017d0:	10450513          	addi	a0,a0,260 # ffffffffc02068d0 <etext+0xa06>
...
ffffffffc0201872:	3a268693          	addi	a3,a3,930 # ffffffffc0206c10 <etext+0xd46>
ffffffffc0201876:	00005617          	auipc	a2,0x5
ffffffffc020187a:	04260613          	addi	a2,a2,66 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020187e:	06c00593          	li	a1,108
ffffffffc0201882:	00005517          	auipc	a0,0x5
ffffffffc0201886:	04e50513          	addi	a0,a0,78 # ffffffffc02068d0 <etext+0xa06>
{
...
ffffffffc0201948:	2fc68693          	addi	a3,a3,764 # ffffffffc0206c40 <etext+0xd76>
ffffffffc020194c:	00005617          	auipc	a2,0x5
ffffffffc0201950:	f6c60613          	addi	a2,a2,-148 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201954:	04b00593          	li	a1,75
ffffffffc0201958:	00005517          	auipc	a0,0x5
ffffffffc020195c:	f7850513          	addi	a0,a0,-136 # ffffffffc02068d0 <etext+0xa06>
ffffffffc0201960:	aebfe0ef          	jal	ffffffffc020044a <__panic>
    assert(n > 0);
ffffffffc0201964:	00005697          	auipc	a3,0x5
ffffffffc0201968:	2ac68693          	addi	a3,a3,684 # ffffffffc0206c10 <etext+0xd46>
ffffffffc020196c:	00005617          	auipc	a2,0x5
ffffffffc0201970:	f4c60613          	addi	a2,a2,-180 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201974:	04700593          	li	a1,71
ffffffffc0201978:	00005517          	auipc	a0,0x5
ffffffffc020197c:	f5850513          	addi	a0,a0,-168 # ffffffffc02068d0 <etext+0xa06>
...
ffffffffc0201ab2:	cd27b783          	ld	a5,-814(a5) # ffffffffc0208780 <nbase>
...
ffffffffc0201ae6:	18660613          	addi	a2,a2,390 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0201aea:	07100593          	li	a1,113
ffffffffc0201aee:	00005517          	auipc	a0,0x5
ffffffffc0201af2:	1a250513          	addi	a0,a0,418 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0201bc8:	0dc68693          	addi	a3,a3,220 # ffffffffc0206ca0 <etext+0xdd6>
ffffffffc0201bcc:	00005617          	auipc	a2,0x5
ffffffffc0201bd0:	cec60613          	addi	a2,a2,-788 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0201bd4:	06300593          	li	a1,99
ffffffffc0201bd8:	00005517          	auipc	a0,0x5
ffffffffc0201bdc:	0e850513          	addi	a0,a0,232 # ffffffffc0206cc0 <etext+0xdf6>
...
ffffffffc0201bea:	0f250513          	addi	a0,a0,242 # ffffffffc0206cd8 <etext+0xe0e>
{
...
ffffffffc0201bfa:	0fa50513          	addi	a0,a0,250 # ffffffffc0206cf0 <etext+0xe26>
}
...
ffffffffc0201d12:	a7263603          	ld	a2,-1422(a2) # ffffffffc0208780 <nbase>
...
ffffffffc0201d80:	fbc60613          	addi	a2,a2,-68 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc0201d84:	06900593          	li	a1,105
ffffffffc0201d88:	00005517          	auipc	a0,0x5
ffffffffc0201d8c:	f0850513          	addi	a0,a0,-248 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0201d9a:	f7a60613          	addi	a2,a2,-134 # ffffffffc0206d10 <etext+0xe46>
ffffffffc0201d9e:	07700593          	li	a1,119
ffffffffc0201da2:	00005517          	auipc	a0,0x5
ffffffffc0201da6:	eee50513          	addi	a0,a0,-274 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0201db4:	f8860613          	addi	a2,a2,-120 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc0201db8:	06900593          	li	a1,105
ffffffffc0201dbc:	00005517          	auipc	a0,0x5
ffffffffc0201dc0:	ed450513          	addi	a0,a0,-300 # ffffffffc0206c90 <etext+0xdc6>
pa2page(uintptr_t pa)
...
ffffffffc0201f08:	799030ef          	jal	ffffffffc0205ea0 <memset>
    return page - pages + nbase;
...
ffffffffc0201fbe:	6e3030ef          	jal	ffffffffc0205ea0 <memset>
    return page - pages + nbase;
...
ffffffffc0202072:	bfa60613          	addi	a2,a2,-1030 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0202076:	0fa00593          	li	a1,250
ffffffffc020207a:	00005517          	auipc	a0,0x5
ffffffffc020207e:	cde50513          	addi	a0,a0,-802 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202082:	bc8fe0ef          	jal	ffffffffc020044a <__panic>
    pde_t *pdep0 = &((pde_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0202086:	00005617          	auipc	a2,0x5
ffffffffc020208a:	be260613          	addi	a2,a2,-1054 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc020208e:	0ed00593          	li	a1,237
ffffffffc0202092:	00005517          	auipc	a0,0x5
ffffffffc0202096:	cc650513          	addi	a0,a0,-826 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc02020a4:	bc860613          	addi	a2,a2,-1080 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc02020a8:	0e900593          	li	a1,233
ffffffffc02020ac:	00005517          	auipc	a0,0x5
ffffffffc02020b0:	cac50513          	addi	a0,a0,-852 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02020b4:	b96fe0ef          	jal	ffffffffc020044a <__panic>
        memset(KADDR(pa), 0, PGSIZE);
ffffffffc02020b8:	00005617          	auipc	a2,0x5
ffffffffc02020bc:	bb060613          	addi	a2,a2,-1104 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc02020c0:	0f700593          	li	a1,247
ffffffffc02020c4:	00005517          	auipc	a0,0x5
ffffffffc02020c8:	c9450513          	addi	a0,a0,-876 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0202218:	b5468693          	addi	a3,a3,-1196 # ffffffffc0206d68 <etext+0xe9e>
ffffffffc020221c:	00004617          	auipc	a2,0x4
ffffffffc0202220:	69c60613          	addi	a2,a2,1692 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202224:	12200593          	li	a1,290
ffffffffc0202228:	00005517          	auipc	a0,0x5
ffffffffc020222c:	b3050513          	addi	a0,a0,-1232 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202230:	a1afe0ef          	jal	ffffffffc020044a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202234:	00005697          	auipc	a3,0x5
ffffffffc0202238:	b6468693          	addi	a3,a3,-1180 # ffffffffc0206d98 <etext+0xece>
ffffffffc020223c:	00004617          	auipc	a2,0x4
ffffffffc0202240:	67c60613          	addi	a2,a2,1660 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202244:	12300593          	li	a1,291
ffffffffc0202248:	00005517          	auipc	a0,0x5
ffffffffc020224c:	b1050513          	addi	a0,a0,-1264 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc020249a:	8d268693          	addi	a3,a3,-1838 # ffffffffc0206d68 <etext+0xe9e>
ffffffffc020249e:	00004617          	auipc	a2,0x4
ffffffffc02024a2:	41a60613          	addi	a2,a2,1050 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02024a6:	13700593          	li	a1,311
ffffffffc02024aa:	00005517          	auipc	a0,0x5
ffffffffc02024ae:	8ae50513          	addi	a0,a0,-1874 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02024b2:	f99fd0ef          	jal	ffffffffc020044a <__panic>
    return KADDR(page2pa(page));
ffffffffc02024b6:	00004617          	auipc	a2,0x4
ffffffffc02024ba:	7b260613          	addi	a2,a2,1970 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc02024be:	07100593          	li	a1,113
ffffffffc02024c2:	00004517          	auipc	a0,0x4
ffffffffc02024c6:	7ce50513          	addi	a0,a0,1998 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc02024d4:	79860613          	addi	a2,a2,1944 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc02024d8:	07100593          	li	a1,113
ffffffffc02024dc:	00004517          	auipc	a0,0x4
ffffffffc02024e0:	7b450513          	addi	a0,a0,1972 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc02024f0:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0206d98 <etext+0xece>
ffffffffc02024f4:	00004617          	auipc	a2,0x4
ffffffffc02024f8:	3c460613          	addi	a2,a2,964 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02024fc:	13800593          	li	a1,312
ffffffffc0202500:	00005517          	auipc	a0,0x5
ffffffffc0202504:	85850513          	addi	a0,a0,-1960 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc02026a2:	68a78793          	addi	a5,a5,1674 # ffffffffc0207d28 <default_pmm_manager>
...
ffffffffc02026cc:	6e850513          	addi	a0,a0,1768 # ffffffffc0206db0 <etext+0xee6>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0202704:	6e850513          	addi	a0,a0,1768 # ffffffffc0206de8 <etext+0xf1e>
...
ffffffffc020271c:	6e850513          	addi	a0,a0,1768 # ffffffffc0206e00 <etext+0xf36>
...
ffffffffc02027a0:	68c50513          	addi	a0,a0,1676 # ffffffffc0206e28 <etext+0xf5e>
...
ffffffffc02027bc:	68850513          	addi	a0,a0,1672 # ffffffffc0206e40 <etext+0xf76>
...
ffffffffc0202a6e:	72650513          	addi	a0,a0,1830 # ffffffffc0207190 <etext+0x12c6>
...
ffffffffc0202b2e:	7ae58593          	addi	a1,a1,1966 # ffffffffc02072d8 <etext+0x140e>
ffffffffc0202b32:	10000513          	li	a0,256
ffffffffc0202b36:	2ea030ef          	jal	ffffffffc0205e20 <strcpy>
...
ffffffffc0202b44:	2ee030ef          	jal	ffffffffc0205e32 <strcmp>
...
ffffffffc0202b74:	10078023          	sb	zero,256(a5) # 80100 <_binary_obj___user_matrix_out_size+0x74bd0>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202b78:	274030ef          	jal	ffffffffc0205dec <strlen>
...
ffffffffc0202c40:	71450513          	addi	a0,a0,1812 # ffffffffc0207350 <etext+0x1486>
...
ffffffffc0202da6:	ec660613          	addi	a2,a2,-314 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0202daa:	25100593          	li	a1,593
ffffffffc0202dae:	00004517          	auipc	a0,0x4
ffffffffc0202db2:	faa50513          	addi	a0,a0,-86 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202db6:	e94fd0ef          	jal	ffffffffc020044a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202dba:	00004697          	auipc	a3,0x4
ffffffffc0202dbe:	43668693          	addi	a3,a3,1078 # ffffffffc02071f0 <etext+0x1326>
ffffffffc0202dc2:	00004617          	auipc	a2,0x4
ffffffffc0202dc6:	af660613          	addi	a2,a2,-1290 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202dca:	25200593          	li	a1,594
ffffffffc0202dce:	00004517          	auipc	a0,0x4
ffffffffc0202dd2:	f8a50513          	addi	a0,a0,-118 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202dd6:	e74fd0ef          	jal	ffffffffc020044a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202dda:	00004697          	auipc	a3,0x4
ffffffffc0202dde:	3d668693          	addi	a3,a3,982 # ffffffffc02071b0 <etext+0x12e6>
ffffffffc0202de2:	00004617          	auipc	a2,0x4
ffffffffc0202de6:	ad660613          	addi	a2,a2,-1322 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202dea:	25100593          	li	a1,593
ffffffffc0202dee:	00004517          	auipc	a0,0x4
ffffffffc0202df2:	f6a50513          	addi	a0,a0,-150 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0202e02:	15260613          	addi	a2,a2,338 # ffffffffc0206f50 <etext+0x1086>
ffffffffc0202e06:	07f00593          	li	a1,127
ffffffffc0202e0a:	00004517          	auipc	a0,0x4
ffffffffc0202e0e:	e8650513          	addi	a0,a0,-378 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0202e12:	e38fd0ef          	jal	ffffffffc020044a <__panic>
        panic("DTB memory info not available");
ffffffffc0202e16:	00004617          	auipc	a2,0x4
ffffffffc0202e1a:	fb260613          	addi	a2,a2,-78 # ffffffffc0206dc8 <etext+0xefe>
ffffffffc0202e1e:	06500593          	li	a1,101
ffffffffc0202e22:	00004517          	auipc	a0,0x4
ffffffffc0202e26:	f3650513          	addi	a0,a0,-202 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202e2a:	e20fd0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202e2e:	00004697          	auipc	a3,0x4
ffffffffc0202e32:	33a68693          	addi	a3,a3,826 # ffffffffc0207168 <etext+0x129e>
ffffffffc0202e36:	00004617          	auipc	a2,0x4
ffffffffc0202e3a:	a8260613          	addi	a2,a2,-1406 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202e3e:	26c00593          	li	a1,620
ffffffffc0202e42:	00004517          	auipc	a0,0x4
ffffffffc0202e46:	f1650513          	addi	a0,a0,-234 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202e4a:	e00fd0ef          	jal	ffffffffc020044a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc0202e4e:	00004697          	auipc	a3,0x4
ffffffffc0202e52:	03268693          	addi	a3,a3,50 # ffffffffc0206e80 <etext+0xfb6>
ffffffffc0202e56:	00004617          	auipc	a2,0x4
ffffffffc0202e5a:	a6260613          	addi	a2,a2,-1438 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202e5e:	21300593          	li	a1,531
ffffffffc0202e62:	00004517          	auipc	a0,0x4
ffffffffc0202e66:	ef650513          	addi	a0,a0,-266 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202e6a:	de0fd0ef          	jal	ffffffffc020044a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202e6e:	00004697          	auipc	a3,0x4
ffffffffc0202e72:	ff268693          	addi	a3,a3,-14 # ffffffffc0206e60 <etext+0xf96>
ffffffffc0202e76:	00004617          	auipc	a2,0x4
ffffffffc0202e7a:	a4260613          	addi	a2,a2,-1470 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202e7e:	21200593          	li	a1,530
ffffffffc0202e82:	00004517          	auipc	a0,0x4
ffffffffc0202e86:	ed650513          	addi	a0,a0,-298 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202e8a:	dc0fd0ef          	jal	ffffffffc020044a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202e8e:	00004617          	auipc	a2,0x4
ffffffffc0202e92:	dda60613          	addi	a2,a2,-550 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0202e96:	07100593          	li	a1,113
ffffffffc0202e9a:	00004517          	auipc	a0,0x4
ffffffffc0202e9e:	df650513          	addi	a0,a0,-522 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0202ea2:	da8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202ea6:	00004697          	auipc	a3,0x4
ffffffffc0202eaa:	29268693          	addi	a3,a3,658 # ffffffffc0207138 <etext+0x126e>
ffffffffc0202eae:	00004617          	auipc	a2,0x4
ffffffffc0202eb2:	a0a60613          	addi	a2,a2,-1526 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202eb6:	23a00593          	li	a1,570
ffffffffc0202eba:	00004517          	auipc	a0,0x4
ffffffffc0202ebe:	e9e50513          	addi	a0,a0,-354 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202ec2:	d88fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ec6:	00004697          	auipc	a3,0x4
ffffffffc0202eca:	22a68693          	addi	a3,a3,554 # ffffffffc02070f0 <etext+0x1226>
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	9ea60613          	addi	a2,a2,-1558 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202ed6:	23800593          	li	a1,568
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	e7e50513          	addi	a0,a0,-386 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202ee2:	d68fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202ee6:	00004697          	auipc	a3,0x4
ffffffffc0202eea:	23a68693          	addi	a3,a3,570 # ffffffffc0207120 <etext+0x1256>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	9ca60613          	addi	a2,a2,-1590 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202ef6:	23700593          	li	a1,567
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	e5e50513          	addi	a0,a0,-418 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202f02:	d48fd0ef          	jal	ffffffffc020044a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc0202f06:	00004697          	auipc	a3,0x4
ffffffffc0202f0a:	30268693          	addi	a3,a3,770 # ffffffffc0207208 <etext+0x133e>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	9aa60613          	addi	a2,a2,-1622 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202f16:	25500593          	li	a1,597
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	e3e50513          	addi	a0,a0,-450 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202f22:	d28fd0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202f26:	00004697          	auipc	a3,0x4
ffffffffc0202f2a:	24268693          	addi	a3,a3,578 # ffffffffc0207168 <etext+0x129e>
ffffffffc0202f2e:	00004617          	auipc	a2,0x4
ffffffffc0202f32:	98a60613          	addi	a2,a2,-1654 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202f36:	24200593          	li	a1,578
ffffffffc0202f3a:	00004517          	auipc	a0,0x4
ffffffffc0202f3e:	e1e50513          	addi	a0,a0,-482 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202f42:	d08fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202f46:	00004697          	auipc	a3,0x4
ffffffffc0202f4a:	31a68693          	addi	a3,a3,794 # ffffffffc0207260 <etext+0x1396>
ffffffffc0202f4e:	00004617          	auipc	a2,0x4
ffffffffc0202f52:	96a60613          	addi	a2,a2,-1686 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202f56:	25a00593          	li	a1,602
ffffffffc0202f5a:	00004517          	auipc	a0,0x4
ffffffffc0202f5e:	dfe50513          	addi	a0,a0,-514 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202f62:	ce8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202f66:	00004697          	auipc	a3,0x4
ffffffffc0202f6a:	2ba68693          	addi	a3,a3,698 # ffffffffc0207220 <etext+0x1356>
ffffffffc0202f6e:	00004617          	auipc	a2,0x4
ffffffffc0202f72:	94a60613          	addi	a2,a2,-1718 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202f76:	25900593          	li	a1,601
ffffffffc0202f7a:	00004517          	auipc	a0,0x4
ffffffffc0202f7e:	dde50513          	addi	a0,a0,-546 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202f82:	cc8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f86:	00004697          	auipc	a3,0x4
ffffffffc0202f8a:	16a68693          	addi	a3,a3,362 # ffffffffc02070f0 <etext+0x1226>
ffffffffc0202f8e:	00004617          	auipc	a2,0x4
ffffffffc0202f92:	92a60613          	addi	a2,a2,-1750 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202f96:	23400593          	li	a1,564
ffffffffc0202f9a:	00004517          	auipc	a0,0x4
ffffffffc0202f9e:	dbe50513          	addi	a0,a0,-578 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202fa2:	ca8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202fa6:	00004697          	auipc	a3,0x4
ffffffffc0202faa:	fea68693          	addi	a3,a3,-22 # ffffffffc0206f90 <etext+0x10c6>
ffffffffc0202fae:	00004617          	auipc	a2,0x4
ffffffffc0202fb2:	90a60613          	addi	a2,a2,-1782 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202fb6:	23300593          	li	a1,563
ffffffffc0202fba:	00004517          	auipc	a0,0x4
ffffffffc0202fbe:	d9e50513          	addi	a0,a0,-610 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202fc2:	c88fd0ef          	jal	ffffffffc020044a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202fc6:	00004697          	auipc	a3,0x4
ffffffffc0202fca:	14268693          	addi	a3,a3,322 # ffffffffc0207108 <etext+0x123e>
ffffffffc0202fce:	00004617          	auipc	a2,0x4
ffffffffc0202fd2:	8ea60613          	addi	a2,a2,-1814 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202fd6:	23000593          	li	a1,560
ffffffffc0202fda:	00004517          	auipc	a0,0x4
ffffffffc0202fde:	d7e50513          	addi	a0,a0,-642 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0202fe2:	c68fd0ef          	jal	ffffffffc020044a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202fe6:	00004697          	auipc	a3,0x4
ffffffffc0202fea:	f9268693          	addi	a3,a3,-110 # ffffffffc0206f78 <etext+0x10ae>
ffffffffc0202fee:	00004617          	auipc	a2,0x4
ffffffffc0202ff2:	8ca60613          	addi	a2,a2,-1846 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0202ff6:	22f00593          	li	a1,559
ffffffffc0202ffa:	00004517          	auipc	a0,0x4
ffffffffc0202ffe:	d5e50513          	addi	a0,a0,-674 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203002:	c48fd0ef          	jal	ffffffffc020044a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0203006:	00004697          	auipc	a3,0x4
ffffffffc020300a:	01268693          	addi	a3,a3,18 # ffffffffc0207018 <etext+0x114e>
ffffffffc020300e:	00004617          	auipc	a2,0x4
ffffffffc0203012:	8aa60613          	addi	a2,a2,-1878 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203016:	22e00593          	li	a1,558
ffffffffc020301a:	00004517          	auipc	a0,0x4
ffffffffc020301e:	d3e50513          	addi	a0,a0,-706 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203022:	c28fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0203026:	00004697          	auipc	a3,0x4
ffffffffc020302a:	0ca68693          	addi	a3,a3,202 # ffffffffc02070f0 <etext+0x1226>
ffffffffc020302e:	00004617          	auipc	a2,0x4
ffffffffc0203032:	88a60613          	addi	a2,a2,-1910 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203036:	22d00593          	li	a1,557
ffffffffc020303a:	00004517          	auipc	a0,0x4
ffffffffc020303e:	d1e50513          	addi	a0,a0,-738 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203042:	c08fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0203046:	00004697          	auipc	a3,0x4
ffffffffc020304a:	09268693          	addi	a3,a3,146 # ffffffffc02070d8 <etext+0x120e>
ffffffffc020304e:	00004617          	auipc	a2,0x4
ffffffffc0203052:	86a60613          	addi	a2,a2,-1942 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203056:	22c00593          	li	a1,556
ffffffffc020305a:	00004517          	auipc	a0,0x4
ffffffffc020305e:	cfe50513          	addi	a0,a0,-770 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203062:	be8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0203066:	00004697          	auipc	a3,0x4
ffffffffc020306a:	04268693          	addi	a3,a3,66 # ffffffffc02070a8 <etext+0x11de>
ffffffffc020306e:	00004617          	auipc	a2,0x4
ffffffffc0203072:	84a60613          	addi	a2,a2,-1974 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203076:	22b00593          	li	a1,555
ffffffffc020307a:	00004517          	auipc	a0,0x4
ffffffffc020307e:	cde50513          	addi	a0,a0,-802 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203082:	bc8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0203086:	00004697          	auipc	a3,0x4
ffffffffc020308a:	00a68693          	addi	a3,a3,10 # ffffffffc0207090 <etext+0x11c6>
ffffffffc020308e:	00004617          	auipc	a2,0x4
ffffffffc0203092:	82a60613          	addi	a2,a2,-2006 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203096:	22900593          	li	a1,553
ffffffffc020309a:	00004517          	auipc	a0,0x4
ffffffffc020309e:	cbe50513          	addi	a0,a0,-834 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02030a2:	ba8fd0ef          	jal	ffffffffc020044a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc02030a6:	00004697          	auipc	a3,0x4
ffffffffc02030aa:	fca68693          	addi	a3,a3,-54 # ffffffffc0207070 <etext+0x11a6>
ffffffffc02030ae:	00004617          	auipc	a2,0x4
ffffffffc02030b2:	80a60613          	addi	a2,a2,-2038 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02030b6:	22800593          	li	a1,552
ffffffffc02030ba:	00004517          	auipc	a0,0x4
ffffffffc02030be:	c9e50513          	addi	a0,a0,-866 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02030c2:	b88fd0ef          	jal	ffffffffc020044a <__panic>
    assert(*ptep & PTE_W);
ffffffffc02030c6:	00004697          	auipc	a3,0x4
ffffffffc02030ca:	f9a68693          	addi	a3,a3,-102 # ffffffffc0207060 <etext+0x1196>
ffffffffc02030ce:	00003617          	auipc	a2,0x3
ffffffffc02030d2:	7ea60613          	addi	a2,a2,2026 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02030d6:	22700593          	li	a1,551
ffffffffc02030da:	00004517          	auipc	a0,0x4
ffffffffc02030de:	c7e50513          	addi	a0,a0,-898 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02030e2:	b68fd0ef          	jal	ffffffffc020044a <__panic>
    assert(*ptep & PTE_U);
ffffffffc02030e6:	00004697          	auipc	a3,0x4
ffffffffc02030ea:	f6a68693          	addi	a3,a3,-150 # ffffffffc0207050 <etext+0x1186>
ffffffffc02030ee:	00003617          	auipc	a2,0x3
ffffffffc02030f2:	7ca60613          	addi	a2,a2,1994 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02030f6:	22600593          	li	a1,550
ffffffffc02030fa:	00004517          	auipc	a0,0x4
ffffffffc02030fe:	c5e50513          	addi	a0,a0,-930 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203102:	b48fd0ef          	jal	ffffffffc020044a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0203106:	00004617          	auipc	a2,0x4
ffffffffc020310a:	c0a60613          	addi	a2,a2,-1014 # ffffffffc0206d10 <etext+0xe46>
ffffffffc020310e:	08100593          	li	a1,129
ffffffffc0203112:	00004517          	auipc	a0,0x4
ffffffffc0203116:	c4650513          	addi	a0,a0,-954 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020311a:	b30fd0ef          	jal	ffffffffc020044a <__panic>
    assert(get_pte(boot_pgdir_va, PGSIZE, 0) == ptep);
ffffffffc020311e:	00004697          	auipc	a3,0x4
ffffffffc0203122:	e8a68693          	addi	a3,a3,-374 # ffffffffc0206fa8 <etext+0x10de>
ffffffffc0203126:	00003617          	auipc	a2,0x3
ffffffffc020312a:	79260613          	addi	a2,a2,1938 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020312e:	22100593          	li	a1,545
ffffffffc0203132:	00004517          	auipc	a0,0x4
ffffffffc0203136:	c2650513          	addi	a0,a0,-986 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020313a:	b10fd0ef          	jal	ffffffffc020044a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc020313e:	00004697          	auipc	a3,0x4
ffffffffc0203142:	eda68693          	addi	a3,a3,-294 # ffffffffc0207018 <etext+0x114e>
ffffffffc0203146:	00003617          	auipc	a2,0x3
ffffffffc020314a:	77260613          	addi	a2,a2,1906 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020314e:	22500593          	li	a1,549
ffffffffc0203152:	00004517          	auipc	a0,0x4
ffffffffc0203156:	c0650513          	addi	a0,a0,-1018 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020315a:	af0fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc020315e:	00004697          	auipc	a3,0x4
ffffffffc0203162:	e7a68693          	addi	a3,a3,-390 # ffffffffc0206fd8 <etext+0x110e>
ffffffffc0203166:	00003617          	auipc	a2,0x3
ffffffffc020316a:	75260613          	addi	a2,a2,1874 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020316e:	22400593          	li	a1,548
ffffffffc0203172:	00004517          	auipc	a0,0x4
ffffffffc0203176:	be650513          	addi	a0,a0,-1050 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0203184:	ae860613          	addi	a2,a2,-1304 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0203188:	22000593          	li	a1,544
ffffffffc020318c:	00004517          	auipc	a0,0x4
ffffffffc0203190:	bcc50513          	addi	a0,a0,-1076 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203194:	ab6fd0ef          	jal	ffffffffc020044a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0203198:	00004617          	auipc	a2,0x4
ffffffffc020319c:	ad060613          	addi	a2,a2,-1328 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc02031a0:	21f00593          	li	a1,543
ffffffffc02031a4:	00004517          	auipc	a0,0x4
ffffffffc02031a8:	bb450513          	addi	a0,a0,-1100 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02031ac:	a9efd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02031b0:	00004697          	auipc	a3,0x4
ffffffffc02031b4:	de068693          	addi	a3,a3,-544 # ffffffffc0206f90 <etext+0x10c6>
ffffffffc02031b8:	00003617          	auipc	a2,0x3
ffffffffc02031bc:	70060613          	addi	a2,a2,1792 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02031c0:	21d00593          	li	a1,541
ffffffffc02031c4:	00004517          	auipc	a0,0x4
ffffffffc02031c8:	b9450513          	addi	a0,a0,-1132 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02031cc:	a7efd0ef          	jal	ffffffffc020044a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02031d0:	00004697          	auipc	a3,0x4
ffffffffc02031d4:	da868693          	addi	a3,a3,-600 # ffffffffc0206f78 <etext+0x10ae>
ffffffffc02031d8:	00003617          	auipc	a2,0x3
ffffffffc02031dc:	6e060613          	addi	a2,a2,1760 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02031e0:	21c00593          	li	a1,540
ffffffffc02031e4:	00004517          	auipc	a0,0x4
ffffffffc02031e8:	b7450513          	addi	a0,a0,-1164 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02031ec:	a5efd0ef          	jal	ffffffffc020044a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02031f0:	00004697          	auipc	a3,0x4
ffffffffc02031f4:	13868693          	addi	a3,a3,312 # ffffffffc0207328 <etext+0x145e>
ffffffffc02031f8:	00003617          	auipc	a2,0x3
ffffffffc02031fc:	6c060613          	addi	a2,a2,1728 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203200:	26300593          	li	a1,611
ffffffffc0203204:	00004517          	auipc	a0,0x4
ffffffffc0203208:	b5450513          	addi	a0,a0,-1196 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020320c:	a3efd0ef          	jal	ffffffffc020044a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0203210:	00004697          	auipc	a3,0x4
ffffffffc0203214:	0e068693          	addi	a3,a3,224 # ffffffffc02072f0 <etext+0x1426>
ffffffffc0203218:	00003617          	auipc	a2,0x3
ffffffffc020321c:	6a060613          	addi	a2,a2,1696 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203220:	26000593          	li	a1,608
ffffffffc0203224:	00004517          	auipc	a0,0x4
ffffffffc0203228:	b3450513          	addi	a0,a0,-1228 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020322c:	a1efd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0203230:	00004697          	auipc	a3,0x4
ffffffffc0203234:	09068693          	addi	a3,a3,144 # ffffffffc02072c0 <etext+0x13f6>
ffffffffc0203238:	00003617          	auipc	a2,0x3
ffffffffc020323c:	68060613          	addi	a2,a2,1664 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203240:	25c00593          	li	a1,604
ffffffffc0203244:	00004517          	auipc	a0,0x4
ffffffffc0203248:	b1450513          	addi	a0,a0,-1260 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020324c:	9fefd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0203250:	00004697          	auipc	a3,0x4
ffffffffc0203254:	02868693          	addi	a3,a3,40 # ffffffffc0207278 <etext+0x13ae>
ffffffffc0203258:	00003617          	auipc	a2,0x3
ffffffffc020325c:	66060613          	addi	a2,a2,1632 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203260:	25b00593          	li	a1,603
ffffffffc0203264:	00004517          	auipc	a0,0x4
ffffffffc0203268:	af450513          	addi	a0,a0,-1292 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020326c:	9defd0ef          	jal	ffffffffc020044a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc0203270:	00004697          	auipc	a3,0x4
ffffffffc0203274:	c5068693          	addi	a3,a3,-944 # ffffffffc0206ec0 <etext+0xff6>
ffffffffc0203278:	00003617          	auipc	a2,0x3
ffffffffc020327c:	64060613          	addi	a2,a2,1600 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203280:	21400593          	li	a1,532
ffffffffc0203284:	00004517          	auipc	a0,0x4
ffffffffc0203288:	ad450513          	addi	a0,a0,-1324 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc020328c:	9befd0ef          	jal	ffffffffc020044a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0203290:	00004617          	auipc	a2,0x4
ffffffffc0203294:	a8060613          	addi	a2,a2,-1408 # ffffffffc0206d10 <etext+0xe46>
ffffffffc0203298:	0c900593          	li	a1,201
ffffffffc020329c:	00004517          	auipc	a0,0x4
ffffffffc02032a0:	abc50513          	addi	a0,a0,-1348 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02032a4:	9a6fd0ef          	jal	ffffffffc020044a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc02032a8:	00004697          	auipc	a3,0x4
ffffffffc02032ac:	c7868693          	addi	a3,a3,-904 # ffffffffc0206f20 <etext+0x1056>
ffffffffc02032b0:	00003617          	auipc	a2,0x3
ffffffffc02032b4:	60860613          	addi	a2,a2,1544 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02032b8:	21b00593          	li	a1,539
ffffffffc02032bc:	00004517          	auipc	a0,0x4
ffffffffc02032c0:	a9c50513          	addi	a0,a0,-1380 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02032c4:	986fd0ef          	jal	ffffffffc020044a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc02032c8:	00004697          	auipc	a3,0x4
ffffffffc02032cc:	c2868693          	addi	a3,a3,-984 # ffffffffc0206ef0 <etext+0x1026>
ffffffffc02032d0:	00003617          	auipc	a2,0x3
ffffffffc02032d4:	5e860613          	addi	a2,a2,1512 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02032d8:	21800593          	li	a1,536
ffffffffc02032dc:	00004517          	auipc	a0,0x4
ffffffffc02032e0:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0203420:	293020ef          	jal	ffffffffc0205eb2 <memcpy>
...
ffffffffc0203438:	f5c68693          	addi	a3,a3,-164 # ffffffffc0207390 <etext+0x14c6>
ffffffffc020343c:	00003617          	auipc	a2,0x3
ffffffffc0203440:	47c60613          	addi	a2,a2,1148 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203444:	1b000593          	li	a1,432
ffffffffc0203448:	00004517          	auipc	a0,0x4
ffffffffc020344c:	91050513          	addi	a0,a0,-1776 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0203486:	7e660613          	addi	a2,a2,2022 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc020348a:	07100593          	li	a1,113
ffffffffc020348e:	00004517          	auipc	a0,0x4
ffffffffc0203492:	80250513          	addi	a0,a0,-2046 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0203496:	fb5fc0ef          	jal	ffffffffc020044a <__panic>
            assert(npage != NULL);
ffffffffc020349a:	00004697          	auipc	a3,0x4
ffffffffc020349e:	ee668693          	addi	a3,a3,-282 # ffffffffc0207380 <etext+0x14b6>
ffffffffc02034a2:	00003617          	auipc	a2,0x3
ffffffffc02034a6:	41660613          	addi	a2,a2,1046 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02034aa:	19700593          	li	a1,407
ffffffffc02034ae:	00004517          	auipc	a0,0x4
ffffffffc02034b2:	8aa50513          	addi	a0,a0,-1878 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02034b6:	f95fc0ef          	jal	ffffffffc020044a <__panic>
            assert(page != NULL);
ffffffffc02034ba:	00004697          	auipc	a3,0x4
ffffffffc02034be:	eb668693          	addi	a3,a3,-330 # ffffffffc0207370 <etext+0x14a6>
ffffffffc02034c2:	00003617          	auipc	a2,0x3
ffffffffc02034c6:	3f660613          	addi	a2,a2,1014 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02034ca:	19600593          	li	a1,406
ffffffffc02034ce:	00004517          	auipc	a0,0x4
ffffffffc02034d2:	88a50513          	addi	a0,a0,-1910 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc02034d6:	f75fc0ef          	jal	ffffffffc020044a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02034da:	00004617          	auipc	a2,0x4
ffffffffc02034de:	85e60613          	addi	a2,a2,-1954 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc02034e2:	06900593          	li	a1,105
ffffffffc02034e6:	00003517          	auipc	a0,0x3
ffffffffc02034ea:	7aa50513          	addi	a0,a0,1962 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc02034ee:	f5dfc0ef          	jal	ffffffffc020044a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02034f2:	00004617          	auipc	a2,0x4
ffffffffc02034f6:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0206f50 <etext+0x1086>
ffffffffc02034fa:	07f00593          	li	a1,127
ffffffffc02034fe:	00003517          	auipc	a0,0x3
ffffffffc0203502:	79250513          	addi	a0,a0,1938 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0203506:	f45fc0ef          	jal	ffffffffc020044a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc020350a:	00004697          	auipc	a3,0x4
ffffffffc020350e:	88e68693          	addi	a3,a3,-1906 # ffffffffc0206d98 <etext+0xece>
ffffffffc0203512:	00003617          	auipc	a2,0x3
ffffffffc0203516:	3a660613          	addi	a2,a2,934 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020351a:	17e00593          	li	a1,382
ffffffffc020351e:	00004517          	auipc	a0,0x4
ffffffffc0203522:	83a50513          	addi	a0,a0,-1990 # ffffffffc0206d58 <etext+0xe8e>
ffffffffc0203526:	f25fc0ef          	jal	ffffffffc020044a <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc020352a:	00004697          	auipc	a3,0x4
ffffffffc020352e:	83e68693          	addi	a3,a3,-1986 # ffffffffc0206d68 <etext+0xe9e>
ffffffffc0203532:	00003617          	auipc	a2,0x3
ffffffffc0203536:	38660613          	addi	a2,a2,902 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020353a:	17d00593          	li	a1,381
ffffffffc020353e:	00004517          	auipc	a0,0x4
ffffffffc0203542:	81a50513          	addi	a0,a0,-2022 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc0203596:	e0e68693          	addi	a3,a3,-498 # ffffffffc02073a0 <etext+0x14d6>
ffffffffc020359a:	00003617          	auipc	a2,0x3
ffffffffc020359e:	31e60613          	addi	a2,a2,798 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02035a2:	1f900593          	li	a1,505
ffffffffc02035a6:	00003517          	auipc	a0,0x3
ffffffffc02035aa:	7b250513          	addi	a0,a0,1970 # ffffffffc0206d58 <etext+0xe8e>
...
ffffffffc020360e:	dae68693          	addi	a3,a3,-594 # ffffffffc02073b8 <etext+0x14ee>
ffffffffc0203612:	00003617          	auipc	a2,0x3
ffffffffc0203616:	2a660613          	addi	a2,a2,678 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020361a:	07400593          	li	a1,116
ffffffffc020361e:	00004517          	auipc	a0,0x4
ffffffffc0203622:	dba50513          	addi	a0,a0,-582 # ffffffffc02073d8 <etext+0x150e>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc020370e:	cde68693          	addi	a3,a3,-802 # ffffffffc02073e8 <etext+0x151e>
ffffffffc0203712:	00003617          	auipc	a2,0x3
ffffffffc0203716:	1a660613          	addi	a2,a2,422 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020371a:	07a00593          	li	a1,122
ffffffffc020371e:	00004517          	auipc	a0,0x4
ffffffffc0203722:	cba50513          	addi	a0,a0,-838 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203726:	d25fc0ef          	jal	ffffffffc020044a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020372a:	00004697          	auipc	a3,0x4
ffffffffc020372e:	cfe68693          	addi	a3,a3,-770 # ffffffffc0207428 <etext+0x155e>
ffffffffc0203732:	00003617          	auipc	a2,0x3
ffffffffc0203736:	18660613          	addi	a2,a2,390 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020373a:	07300593          	li	a1,115
ffffffffc020373e:	00004517          	auipc	a0,0x4
ffffffffc0203742:	c9a50513          	addi	a0,a0,-870 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203746:	d05fc0ef          	jal	ffffffffc020044a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020374a:	00004697          	auipc	a3,0x4
ffffffffc020374e:	cbe68693          	addi	a3,a3,-834 # ffffffffc0207408 <etext+0x153e>
ffffffffc0203752:	00003617          	auipc	a2,0x3
ffffffffc0203756:	16660613          	addi	a2,a2,358 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020375a:	07200593          	li	a1,114
ffffffffc020375e:	00004517          	auipc	a0,0x4
ffffffffc0203762:	c7a50513          	addi	a0,a0,-902 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc02037a0:	cac68693          	addi	a3,a3,-852 # ffffffffc0207448 <etext+0x157e>
ffffffffc02037a4:	00003617          	auipc	a2,0x3
ffffffffc02037a8:	11460613          	addi	a2,a2,276 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02037ac:	09e00593          	li	a1,158
ffffffffc02037b0:	00004517          	auipc	a0,0x4
ffffffffc02037b4:	c2850513          	addi	a0,a0,-984 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc020386c:	bf868693          	addi	a3,a3,-1032 # ffffffffc0207460 <etext+0x1596>
ffffffffc0203870:	00003617          	auipc	a2,0x3
ffffffffc0203874:	04860613          	addi	a2,a2,72 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203878:	0b300593          	li	a1,179
ffffffffc020387c:	00004517          	auipc	a0,0x4
ffffffffc0203880:	b5c50513          	addi	a0,a0,-1188 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc0203904:	b7068693          	addi	a3,a3,-1168 # ffffffffc0207470 <etext+0x15a6>
ffffffffc0203908:	00003617          	auipc	a2,0x3
ffffffffc020390c:	fb060613          	addi	a2,a2,-80 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203910:	0cf00593          	li	a1,207
ffffffffc0203914:	00004517          	auipc	a0,0x4
ffffffffc0203918:	ac450513          	addi	a0,a0,-1340 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc020397a:	b1a68693          	addi	a3,a3,-1254 # ffffffffc0207490 <etext+0x15c6>
ffffffffc020397e:	00003617          	auipc	a2,0x3
ffffffffc0203982:	f3a60613          	addi	a2,a2,-198 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203986:	0e800593          	li	a1,232
ffffffffc020398a:	00004517          	auipc	a0,0x4
ffffffffc020398e:	a4e50513          	addi	a0,a0,-1458 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc0203ae2:	b2250513          	addi	a0,a0,-1246 # ffffffffc0207600 <etext+0x1736>
...
ffffffffc0203afa:	b2a50513          	addi	a0,a0,-1238 # ffffffffc0207620 <etext+0x1756>
}
...
ffffffffc0203b08:	9ac68693          	addi	a3,a3,-1620 # ffffffffc02074b0 <etext+0x15e6>
ffffffffc0203b0c:	00003617          	auipc	a2,0x3
ffffffffc0203b10:	dac60613          	addi	a2,a2,-596 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203b14:	12c00593          	li	a1,300
ffffffffc0203b18:	00004517          	auipc	a0,0x4
ffffffffc0203b1c:	8c050513          	addi	a0,a0,-1856 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203b20:	92bfc0ef          	jal	ffffffffc020044a <__panic>
    assert(mm != NULL);
ffffffffc0203b24:	00004697          	auipc	a3,0x4
ffffffffc0203b28:	93c68693          	addi	a3,a3,-1732 # ffffffffc0207460 <etext+0x1596>
ffffffffc0203b2c:	00003617          	auipc	a2,0x3
ffffffffc0203b30:	d8c60613          	addi	a2,a2,-628 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203b34:	12400593          	li	a1,292
ffffffffc0203b38:	00004517          	auipc	a0,0x4
ffffffffc0203b3c:	8a050513          	addi	a0,a0,-1888 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203b40:	90bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma != NULL);
ffffffffc0203b44:	00004697          	auipc	a3,0x4
ffffffffc0203b48:	96c68693          	addi	a3,a3,-1684 # ffffffffc02074b0 <etext+0x15e6>
ffffffffc0203b4c:	00003617          	auipc	a2,0x3
ffffffffc0203b50:	d6c60613          	addi	a2,a2,-660 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203b54:	13300593          	li	a1,307
ffffffffc0203b58:	00004517          	auipc	a0,0x4
ffffffffc0203b5c:	88050513          	addi	a0,a0,-1920 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203b60:	8ebfc0ef          	jal	ffffffffc020044a <__panic>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203b64:	00004697          	auipc	a3,0x4
ffffffffc0203b68:	97468693          	addi	a3,a3,-1676 # ffffffffc02074d8 <etext+0x160e>
ffffffffc0203b6c:	00003617          	auipc	a2,0x3
ffffffffc0203b70:	d4c60613          	addi	a2,a2,-692 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203b74:	13d00593          	li	a1,317
ffffffffc0203b78:	00004517          	auipc	a0,0x4
ffffffffc0203b7c:	86050513          	addi	a0,a0,-1952 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203b80:	8cbfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203b84:	00004697          	auipc	a3,0x4
ffffffffc0203b88:	a0c68693          	addi	a3,a3,-1524 # ffffffffc0207590 <etext+0x16c6>
ffffffffc0203b8c:	00003617          	auipc	a2,0x3
ffffffffc0203b90:	d2c60613          	addi	a2,a2,-724 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203b94:	14f00593          	li	a1,335
ffffffffc0203b98:	00004517          	auipc	a0,0x4
ffffffffc0203b9c:	84050513          	addi	a0,a0,-1984 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203ba0:	8abfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc0203ba4:	00004697          	auipc	a3,0x4
ffffffffc0203ba8:	9bc68693          	addi	a3,a3,-1604 # ffffffffc0207560 <etext+0x1696>
ffffffffc0203bac:	00003617          	auipc	a2,0x3
ffffffffc0203bb0:	d0c60613          	addi	a2,a2,-756 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203bb4:	14e00593          	li	a1,334
ffffffffc0203bb8:	00004517          	auipc	a0,0x4
ffffffffc0203bbc:	82050513          	addi	a0,a0,-2016 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203bc0:	88bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma5 == NULL);
ffffffffc0203bc4:	00004697          	auipc	a3,0x4
ffffffffc0203bc8:	98c68693          	addi	a3,a3,-1652 # ffffffffc0207550 <etext+0x1686>
ffffffffc0203bcc:	00003617          	auipc	a2,0x3
ffffffffc0203bd0:	cec60613          	addi	a2,a2,-788 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203bd4:	14c00593          	li	a1,332
ffffffffc0203bd8:	00004517          	auipc	a0,0x4
ffffffffc0203bdc:	80050513          	addi	a0,a0,-2048 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203be0:	86bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma4 == NULL);
ffffffffc0203be4:	00004697          	auipc	a3,0x4
ffffffffc0203be8:	95c68693          	addi	a3,a3,-1700 # ffffffffc0207540 <etext+0x1676>
ffffffffc0203bec:	00003617          	auipc	a2,0x3
ffffffffc0203bf0:	ccc60613          	addi	a2,a2,-820 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203bf4:	14a00593          	li	a1,330
ffffffffc0203bf8:	00003517          	auipc	a0,0x3
ffffffffc0203bfc:	7e050513          	addi	a0,a0,2016 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203c00:	84bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma3 == NULL);
ffffffffc0203c04:	00004697          	auipc	a3,0x4
ffffffffc0203c08:	92c68693          	addi	a3,a3,-1748 # ffffffffc0207530 <etext+0x1666>
ffffffffc0203c0c:	00003617          	auipc	a2,0x3
ffffffffc0203c10:	cac60613          	addi	a2,a2,-852 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203c14:	14800593          	li	a1,328
ffffffffc0203c18:	00003517          	auipc	a0,0x3
ffffffffc0203c1c:	7c050513          	addi	a0,a0,1984 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203c20:	82bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203c24:	00004697          	auipc	a3,0x4
ffffffffc0203c28:	89c68693          	addi	a3,a3,-1892 # ffffffffc02074c0 <etext+0x15f6>
ffffffffc0203c2c:	00003617          	auipc	a2,0x3
ffffffffc0203c30:	c8c60613          	addi	a2,a2,-884 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203c34:	13b00593          	li	a1,315
ffffffffc0203c38:	00003517          	auipc	a0,0x3
ffffffffc0203c3c:	7a050513          	addi	a0,a0,1952 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203c40:	80bfc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma2 != NULL);
ffffffffc0203c44:	00004697          	auipc	a3,0x4
ffffffffc0203c48:	8dc68693          	addi	a3,a3,-1828 # ffffffffc0207520 <etext+0x1656>
ffffffffc0203c4c:	00003617          	auipc	a2,0x3
ffffffffc0203c50:	c6c60613          	addi	a2,a2,-916 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203c54:	14600593          	li	a1,326
ffffffffc0203c58:	00003517          	auipc	a0,0x3
ffffffffc0203c5c:	78050513          	addi	a0,a0,1920 # ffffffffc02073d8 <etext+0x150e>
ffffffffc0203c60:	feafc0ef          	jal	ffffffffc020044a <__panic>
        assert(vma1 != NULL);
ffffffffc0203c64:	00004697          	auipc	a3,0x4
ffffffffc0203c68:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0207510 <etext+0x1646>
ffffffffc0203c6c:	00003617          	auipc	a2,0x3
ffffffffc0203c70:	c4c60613          	addi	a2,a2,-948 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203c74:	14400593          	li	a1,324
ffffffffc0203c78:	00003517          	auipc	a0,0x3
ffffffffc0203c7c:	76050513          	addi	a0,a0,1888 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc0203c90:	93450513          	addi	a0,a0,-1740 # ffffffffc02075c0 <etext+0x16f6>
ffffffffc0203c94:	d04fc0ef          	jal	ffffffffc0200198 <cprintf>
        assert(vma_below_5 == NULL);
ffffffffc0203c98:	00004697          	auipc	a3,0x4
ffffffffc0203c9c:	95068693          	addi	a3,a3,-1712 # ffffffffc02075e8 <etext+0x171e>
ffffffffc0203ca0:	00003617          	auipc	a2,0x3
ffffffffc0203ca4:	c1860613          	addi	a2,a2,-1000 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0203ca8:	15900593          	li	a1,345
ffffffffc0203cac:	00003517          	auipc	a0,0x3
ffffffffc0203cb0:	72c50513          	addi	a0,a0,1836 # ffffffffc02073d8 <etext+0x150e>
...
ffffffffc0203d9a:	106020ef          	jal	ffffffffc0205ea0 <memset>
        proc->tf = NULL;
...
ffffffffc0203db8:	0e8020ef          	jal	ffffffffc0205ea0 <memset>
...
ffffffffc0203e36:	94e7b783          	ld	a5,-1714(a5) # ffffffffc0208780 <nbase>
...
ffffffffc0203e56:	ebe60613          	addi	a2,a2,-322 # ffffffffc0206d10 <etext+0xe46>
ffffffffc0203e5a:	07700593          	li	a1,119
ffffffffc0203e5e:	00003517          	auipc	a0,0x3
ffffffffc0203e62:	e3250513          	addi	a0,a0,-462 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0203e66:	de4fc0ef          	jal	ffffffffc020044a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203e6a:	00003617          	auipc	a2,0x3
ffffffffc0203e6e:	ece60613          	addi	a2,a2,-306 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc0203e72:	06900593          	li	a1,105
ffffffffc0203e76:	00003517          	auipc	a0,0x3
ffffffffc0203e7a:	e1a50513          	addi	a0,a0,-486 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0203f44:	840a0a13          	addi	s4,s4,-1984 # ffffffffc0208780 <nbase>
...
ffffffffc02040ae:	15d010ef          	jal	ffffffffc0205a0a <hash32>
...
ffffffffc020410c:	6a4010ef          	jal	ffffffffc02057b0 <wakeup_proc>
...
ffffffffc020416c:	547010ef          	jal	ffffffffc0205eb2 <memcpy>
static inline void
...
ffffffffc0204186:	cb91                	beqz	a5,ffffffffc020419a <do_fork+0x2b6>
    {
        schedule();
ffffffffc0204188:	6ce010ef          	jal	ffffffffc0205856 <schedule>
...
ffffffffc0204270:	acc60613          	addi	a2,a2,-1332 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc0204274:	06900593          	li	a1,105
ffffffffc0204278:	00003517          	auipc	a0,0x3
ffffffffc020427c:	a1850513          	addi	a0,a0,-1512 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0204280:	9cafc0ef          	jal	ffffffffc020044a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204284:	00003617          	auipc	a2,0x3
ffffffffc0204288:	9e460613          	addi	a2,a2,-1564 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc020428c:	07100593          	li	a1,113
ffffffffc0204290:	00003517          	auipc	a0,0x3
ffffffffc0204294:	a0050513          	addi	a0,a0,-1536 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc02042a2:	a7260613          	addi	a2,a2,-1422 # ffffffffc0206d10 <etext+0xe46>
ffffffffc02042a6:	19700593          	li	a1,407
ffffffffc02042aa:	00003517          	auipc	a0,0x3
ffffffffc02042ae:	3ae50513          	addi	a0,a0,942 # ffffffffc0207658 <etext+0x178e>
ffffffffc02042b2:	998fc0ef          	jal	ffffffffc020044a <__panic>
    return pa2page(PADDR(kva));
ffffffffc02042b6:	00003617          	auipc	a2,0x3
ffffffffc02042ba:	a5a60613          	addi	a2,a2,-1446 # ffffffffc0206d10 <etext+0xe46>
ffffffffc02042be:	07700593          	li	a1,119
ffffffffc02042c2:	00003517          	auipc	a0,0x3
ffffffffc02042c6:	9ce50513          	addi	a0,a0,-1586 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc02042ca:	980fc0ef          	jal	ffffffffc020044a <__panic>
    {
        panic("Unlock failed.\n");
ffffffffc02042ce:	00003617          	auipc	a2,0x3
ffffffffc02042d2:	3a260613          	addi	a2,a2,930 # ffffffffc0207670 <etext+0x17a6>
ffffffffc02042d6:	04000593          	li	a1,64
ffffffffc02042da:	00003517          	auipc	a0,0x3
ffffffffc02042de:	3a650513          	addi	a0,a0,934 # ffffffffc0207680 <etext+0x17b6>
ffffffffc02042e2:	968fc0ef          	jal	ffffffffc020044a <__panic>
    assert(current->wait_state == 0);
ffffffffc02042e6:	00003697          	auipc	a3,0x3
ffffffffc02042ea:	35268693          	addi	a3,a3,850 # ffffffffc0207638 <etext+0x176e>
ffffffffc02042ee:	00002617          	auipc	a2,0x2
ffffffffc02042f2:	5ca60613          	addi	a2,a2,1482 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02042f6:	1d700593          	li	a1,471
ffffffffc02042fa:	00003517          	auipc	a0,0x3
ffffffffc02042fe:	35e50513          	addi	a0,a0,862 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204316:	95660613          	addi	a2,a2,-1706 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc020431a:	07100593          	li	a1,113
ffffffffc020431e:	00003517          	auipc	a0,0x3
ffffffffc0204322:	97250513          	addi	a0,a0,-1678 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0204340:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204342:	35f010ef          	jal	ffffffffc0205ea0 <memset>
...
ffffffffc0204432:	37e010ef          	jal	ffffffffc02057b0 <wakeup_proc>
...
ffffffffc0204440:	02091263          	bnez	s2,ffffffffc0204464 <do_exit+0xea>
    ...
    local_intr_restore(intr_flag);
    schedule();
ffffffffc0204444:	412010ef          	jal	ffffffffc0205856 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc0204448:	601c                	ld	a5,0(s0)
ffffffffc020444a:	00003617          	auipc	a2,0x3
ffffffffc020444e:	26e60613          	addi	a2,a2,622 # ffffffffc02076b8 <etext+0x17ee>
ffffffffc0204452:	24000593          	li	a1,576
ffffffffc0204456:	43d4                	lw	a3,4(a5)
ffffffffc0204458:	00003517          	auipc	a0,0x3
ffffffffc020445c:	20050513          	addi	a0,a0,512 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc020446e:	22e60613          	addi	a2,a2,558 # ffffffffc0207698 <etext+0x17ce>
ffffffffc0204472:	20c00593          	li	a1,524
ffffffffc0204476:	00003517          	auipc	a0,0x3
ffffffffc020447a:	1e250513          	addi	a0,a0,482 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc020449c:	21060613          	addi	a2,a2,528 # ffffffffc02076a8 <etext+0x17de>
ffffffffc02044a0:	21000593          	li	a1,528
ffffffffc02044a4:	00003517          	auipc	a0,0x3
ffffffffc02044a8:	1b450513          	addi	a0,a0,436 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc02044b6:	b735                	j	ffffffffc02043e2 <do_exit+0x68>
            wakeup_proc(proc);
ffffffffc02044b8:	2f8010ef          	jal	ffffffffc02057b0 <wakeup_proc>
...
ffffffffc020459c:	1e87b783          	ld	a5,488(a5) # ffffffffc0208780 <nbase>
...
ffffffffc02045f4:	c314                	sw	a3,0(a4)
        schedule();
ffffffffc02045f6:	260010ef          	jal	ffffffffc0205856 <schedule>
        if (current->flags & PF_EXITING)
...
ffffffffc020460e:	3fc010ef          	jal	ffffffffc0205a0a <hash32>
...
ffffffffc020465c:	08060613          	addi	a2,a2,128 # ffffffffc02076d8 <etext+0x180e>
ffffffffc0204660:	36200593          	li	a1,866
ffffffffc0204664:	00003517          	auipc	a0,0x3
ffffffffc0204668:	ff450513          	addi	a0,a0,-12 # ffffffffc0207658 <etext+0x178e>
ffffffffc020466c:	ddffb0ef          	jal	ffffffffc020044a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204670:	00002617          	auipc	a2,0x2
ffffffffc0204674:	6c860613          	addi	a2,a2,1736 # ffffffffc0206d38 <etext+0xe6e>
ffffffffc0204678:	06900593          	li	a1,105
ffffffffc020467c:	00002517          	auipc	a0,0x2
ffffffffc0204680:	61450513          	addi	a0,a0,1556 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0204684:	dc7fb0ef          	jal	ffffffffc020044a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204688:	00002617          	auipc	a2,0x2
ffffffffc020468c:	68860613          	addi	a2,a2,1672 # ffffffffc0206d10 <etext+0xe46>
ffffffffc0204690:	07700593          	li	a1,119
ffffffffc0204694:	00002517          	auipc	a0,0x2
ffffffffc0204698:	5fc50513          	addi	a0,a0,1532 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc02046c0:	a071                	j	ffffffffc020474c <init_main+0xac>
    ...
    {
        schedule();
ffffffffc02046c2:	194010ef          	jal	ffffffffc0205856 <schedule>
    if (code_store != NULL)
...
ffffffffc02046d4:	04850513          	addi	a0,a0,72 # ffffffffc0207718 <etext+0x184e>
...
ffffffffc020471c:	0e850513          	addi	a0,a0,232 # ffffffffc0207800 <etext+0x1936>
...
ffffffffc0204730:	01468693          	addi	a3,a3,20 # ffffffffc0207740 <etext+0x1876>
ffffffffc0204734:	00002617          	auipc	a2,0x2
ffffffffc0204738:	18460613          	addi	a2,a2,388 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc020473c:	3ce00593          	li	a1,974
ffffffffc0204740:	00003517          	auipc	a0,0x3
ffffffffc0204744:	f1850513          	addi	a0,a0,-232 # ffffffffc0207658 <etext+0x178e>
ffffffffc0204748:	d03fb0ef          	jal	ffffffffc020044a <__panic>
        panic("create user_main failed.\n");
ffffffffc020474c:	00003617          	auipc	a2,0x3
ffffffffc0204750:	fac60613          	addi	a2,a2,-84 # ffffffffc02076f8 <etext+0x182e>
ffffffffc0204754:	3c500593          	li	a1,965
ffffffffc0204758:	00003517          	auipc	a0,0x3
ffffffffc020475c:	f0050513          	addi	a0,a0,-256 # ffffffffc0207658 <etext+0x178e>
ffffffffc0204760:	cebfb0ef          	jal	ffffffffc020044a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0204764:	00003697          	auipc	a3,0x3
ffffffffc0204768:	06c68693          	addi	a3,a3,108 # ffffffffc02077d0 <etext+0x1906>
ffffffffc020476c:	00002617          	auipc	a2,0x2
ffffffffc0204770:	14c60613          	addi	a2,a2,332 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204774:	3d100593          	li	a1,977
ffffffffc0204778:	00003517          	auipc	a0,0x3
ffffffffc020477c:	ee050513          	addi	a0,a0,-288 # ffffffffc0207658 <etext+0x178e>
ffffffffc0204780:	ccbfb0ef          	jal	ffffffffc020044a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc0204784:	00003697          	auipc	a3,0x3
ffffffffc0204788:	01c68693          	addi	a3,a3,28 # ffffffffc02077a0 <etext+0x18d6>
ffffffffc020478c:	00002617          	auipc	a2,0x2
ffffffffc0204790:	12c60613          	addi	a2,a2,300 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204794:	3d000593          	li	a1,976
ffffffffc0204798:	00003517          	auipc	a0,0x3
ffffffffc020479c:	ec050513          	addi	a0,a0,-320 # ffffffffc0207658 <etext+0x178e>
ffffffffc02047a0:	cabfb0ef          	jal	ffffffffc020044a <__panic>
    assert(nr_process == 2);
ffffffffc02047a4:	00003697          	auipc	a3,0x3
ffffffffc02047a8:	fec68693          	addi	a3,a3,-20 # ffffffffc0207790 <etext+0x18c6>
ffffffffc02047ac:	00002617          	auipc	a2,0x2
ffffffffc02047b0:	10c60613          	addi	a2,a2,268 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc02047b4:	3cf00593          	li	a1,975
ffffffffc02047b8:	00003517          	auipc	a0,0x3
ffffffffc02047bc:	ea050513          	addi	a0,a0,-352 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc02047fc:	6a4010ef          	jal	ffffffffc0205ea0 <memset>
...
ffffffffc020480c:	6a6010ef          	jal	ffffffffc0205eb2 <memcpy>
    if (mm != NULL)
ffffffffc0204810:	10090063          	beqz	s2,ffffffffc0204910 <do_execve+0x14c>
        cputs("mm != NULL");
ffffffffc0204814:	00003517          	auipc	a0,0x3
ffffffffc0204818:	c4c50513          	addi	a0,a0,-948 # ffffffffc0207460 <etext+0x1596>
...
ffffffffc0204872:	f12bbb83          	ld	s7,-238(s7) # ffffffffc0208780 <nbase>
...
ffffffffc02048bc:	5f6010ef          	jal	ffffffffc0205eb2 <memcpy>
...
ffffffffc0204908:	5aa010ef          	jal	ffffffffc0205eb2 <memcpy>
    if (mm != NULL)
...
ffffffffc020491c:	f0860613          	addi	a2,a2,-248 # ffffffffc0207820 <etext+0x1956>
ffffffffc0204920:	24c00593          	li	a1,588
ffffffffc0204924:	00003517          	auipc	a0,0x3
ffffffffc0204928:	d3450513          	addi	a0,a0,-716 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204a14:	10043903          	ld	s2,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0204a18:	488010ef          	jal	ffffffffc0205ea0 <memset>
    tf->epc = elf->e_entry;
...
ffffffffc0204b16:	39c010ef          	jal	ffffffffc0205eb2 <memcpy>
...
ffffffffc0204bb4:	2ec010ef          	jal	ffffffffc0205ea0 <memset>
            start += size;
...
ffffffffc0204bd0:	c7c68693          	addi	a3,a3,-900 # ffffffffc0207848 <etext+0x197e>
ffffffffc0204bd4:	00002617          	auipc	a2,0x2
ffffffffc0204bd8:	ce460613          	addi	a2,a2,-796 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204bdc:	2b500593          	li	a1,693
ffffffffc0204be0:	00003517          	auipc	a0,0x3
ffffffffc0204be4:	a7850513          	addi	a0,a0,-1416 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204c3a:	e042                	sd	a6,0(sp)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204c3c:	264010ef          	jal	ffffffffc0205ea0 <memset>
        while (start < end)
...
ffffffffc0204c8c:	fe060613          	addi	a2,a2,-32 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0204c90:	07100593          	li	a1,113
ffffffffc0204c94:	00002517          	auipc	a0,0x2
ffffffffc0204c98:	ffc50513          	addi	a0,a0,-4 # ffffffffc0206c90 <etext+0xdc6>
ffffffffc0204c9c:	faefb0ef          	jal	ffffffffc020044a <__panic>
ffffffffc0204ca0:	00002617          	auipc	a2,0x2
ffffffffc0204ca4:	fc860613          	addi	a2,a2,-56 # ffffffffc0206c68 <etext+0xd9e>
ffffffffc0204ca8:	07100593          	li	a1,113
ffffffffc0204cac:	00002517          	auipc	a0,0x2
ffffffffc0204cb0:	fe450513          	addi	a0,a0,-28 # ffffffffc0206c90 <etext+0xdc6>
...
ffffffffc0204cc2:	05260613          	addi	a2,a2,82 # ffffffffc0206d10 <etext+0xe46>
ffffffffc0204cc6:	2d400593          	li	a1,724
ffffffffc0204cca:	00003517          	auipc	a0,0x3
ffffffffc0204cce:	98e50513          	addi	a0,a0,-1650 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204cdc:	c8868693          	addi	a3,a3,-888 # ffffffffc0207960 <etext+0x1a96>
ffffffffc0204ce0:	00002617          	auipc	a2,0x2
ffffffffc0204ce4:	bd860613          	addi	a2,a2,-1064 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204ce8:	2cf00593          	li	a1,719
ffffffffc0204cec:	00003517          	auipc	a0,0x3
ffffffffc0204cf0:	96c50513          	addi	a0,a0,-1684 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204cfe:	c1e68693          	addi	a3,a3,-994 # ffffffffc0207918 <etext+0x1a4e>
ffffffffc0204d02:	00002617          	auipc	a2,0x2
ffffffffc0204d06:	bb660613          	addi	a2,a2,-1098 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204d0a:	2ce00593          	li	a1,718
ffffffffc0204d0e:	00003517          	auipc	a0,0x3
ffffffffc0204d12:	94a50513          	addi	a0,a0,-1718 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204d20:	bb468693          	addi	a3,a3,-1100 # ffffffffc02078d0 <etext+0x1a06>
ffffffffc0204d24:	00002617          	auipc	a2,0x2
ffffffffc0204d28:	b9460613          	addi	a2,a2,-1132 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204d2c:	2cd00593          	li	a1,717
ffffffffc0204d30:	00003517          	auipc	a0,0x3
ffffffffc0204d34:	92850513          	addi	a0,a0,-1752 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204d42:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0207888 <etext+0x19be>
ffffffffc0204d46:	00002617          	auipc	a2,0x2
ffffffffc0204d4a:	b7260613          	addi	a2,a2,-1166 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0204d4e:	2cc00593          	li	a1,716
ffffffffc0204d52:	00003517          	auipc	a0,0x3
ffffffffc0204d56:	90650513          	addi	a0,a0,-1786 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204d72:	c3a60613          	addi	a2,a2,-966 # ffffffffc02079a8 <etext+0x1ade>
ffffffffc0204d76:	00003517          	auipc	a0,0x3
ffffffffc0204d7a:	c4250513          	addi	a0,a0,-958 # ffffffffc02079b8 <etext+0x1aee>
...
ffffffffc0204d8e:	c1e50513          	addi	a0,a0,-994 # ffffffffc02079a8 <etext+0x1ade>
ffffffffc0204d92:	05a010ef          	jal	ffffffffc0205dec <strlen>
...
ffffffffc0204dac:	106010ef          	jal	ffffffffc0205eb2 <memcpy>
    current->tf = new_tf;
...
ffffffffc0204dca:	be250513          	addi	a0,a0,-1054 # ffffffffc02079a8 <etext+0x1ade>
...
ffffffffc0204ddc:	c0860613          	addi	a2,a2,-1016 # ffffffffc02079e0 <etext+0x1b16>
ffffffffc0204de0:	3b800593          	li	a1,952
ffffffffc0204de4:	00003517          	auipc	a0,0x3
ffffffffc0204de8:	87450513          	addi	a0,a0,-1932 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0204e4c:	e42a                	sd	a0,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204e4e:	3bd000ef          	jal	ffffffffc0205a0a <hash32>
...
ffffffffc0204ea4:	10d000ef          	jal	ffffffffc02057b0 <wakeup_proc>
...
ffffffffc0204f14:	78d000ef          	jal	ffffffffc0205ea0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204f18:	8522                	mv	a0,s0
ffffffffc0204f1a:	463d                	li	a2,15
ffffffffc0204f1c:	00003597          	auipc	a1,0x3
ffffffffc0204f20:	afc58593          	addi	a1,a1,-1284 # ffffffffc0207a18 <etext+0x1b4e>
ffffffffc0204f24:	78f000ef          	jal	ffffffffc0205eb2 <memcpy>
...
ffffffffc0204f6a:	2a1000ef          	jal	ffffffffc0205a0a <hash32>
...
ffffffffc0204f9c:	6af73c23          	sd	a5,1720(a4) # ffffffffc02b5650 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204fa0:	701000ef          	jal	ffffffffc0205ea0 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204fa4:	8522                	mv	a0,s0
ffffffffc0204fa6:	463d                	li	a2,15
ffffffffc0204fa8:	00003597          	auipc	a1,0x3
ffffffffc0204fac:	a9858593          	addi	a1,a1,-1384 # ffffffffc0207a40 <etext+0x1b76>
ffffffffc0204fb0:	703000ef          	jal	ffffffffc0205eb2 <memcpy>
...
ffffffffc0204fe6:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0207a20 <etext+0x1b56>
ffffffffc0204fea:	3f400593          	li	a1,1012
ffffffffc0204fee:	00002517          	auipc	a0,0x2
ffffffffc0204ff2:	66a50513          	addi	a0,a0,1642 # ffffffffc0207658 <etext+0x178e>
ffffffffc0204ff6:	c54fb0ef          	jal	ffffffffc020044a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0204ffa:	00003617          	auipc	a2,0x3
ffffffffc0204ffe:	a0660613          	addi	a2,a2,-1530 # ffffffffc0207a00 <etext+0x1b36>
ffffffffc0205002:	3e500593          	li	a1,997
ffffffffc0205006:	00002517          	auipc	a0,0x2
ffffffffc020500a:	65250513          	addi	a0,a0,1618 # ffffffffc0207658 <etext+0x178e>
ffffffffc020500e:	c3cfb0ef          	jal	ffffffffc020044a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205012:	00003697          	auipc	a3,0x3
ffffffffc0205016:	a5e68693          	addi	a3,a3,-1442 # ffffffffc0207a70 <etext+0x1ba6>
ffffffffc020501a:	00002617          	auipc	a2,0x2
ffffffffc020501e:	89e60613          	addi	a2,a2,-1890 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0205022:	3fb00593          	li	a1,1019
ffffffffc0205026:	00002517          	auipc	a0,0x2
ffffffffc020502a:	63250513          	addi	a0,a0,1586 # ffffffffc0207658 <etext+0x178e>
ffffffffc020502e:	c1cfb0ef          	jal	ffffffffc020044a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205032:	00003697          	auipc	a3,0x3
ffffffffc0205036:	a1668693          	addi	a3,a3,-1514 # ffffffffc0207a48 <etext+0x1b7e>
ffffffffc020503a:	00002617          	auipc	a2,0x2
ffffffffc020503e:	87e60613          	addi	a2,a2,-1922 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0205042:	3fa00593          	li	a1,1018
ffffffffc0205046:	00002517          	auipc	a0,0x2
ffffffffc020504a:	61250513          	addi	a0,a0,1554 # ffffffffc0207658 <etext+0x178e>
...
ffffffffc0205064:	dffd                	beqz	a5,ffffffffc0205062 <cpu_idle+0x10>
        {
            schedule();
ffffffffc0205066:	7f0000ef          	jal	ffffffffc0205856 <schedule>
...
ffffffffc020508a:	a1250513          	addi	a0,a0,-1518 # ffffffffc0207a98 <etext+0x1bce>
{
...
ffffffffc020512e <stride_pick_next>:
...
ffffffffc020512e:	6d1c                	ld	a5,24(a0)
ffffffffc0205130:	cb8d                	beqz	a5,ffffffffc0205162 <stride_pick_next+0x34>
...
ffffffffc0205132:	4fd8                	lw	a4,28(a5)
     struct proc_struct *p = le2proc(rq->lab6_run_pool, lab6_run_pool);
ffffffffc0205134:	ed878513          	addi	a0,a5,-296
     uint32_t priority = (p->lab6_priority == 0) ? 1 : p->lab6_priority;
ffffffffc0205138:	86ba                	mv	a3,a4
ffffffffc020513a:	cb11                	beqz	a4,ffffffffc020514e <stride_pick_next+0x20>
     p->lab6_stride += BIG_STRIDE / priority;
ffffffffc020513c:	80000737          	lui	a4,0x80000
ffffffffc0205140:	377d                	addiw	a4,a4,-1 # 7fffffff <_binary_obj___user_matrix_out_size+0x7fff4acf>
ffffffffc0205142:	02d7573b          	divuw	a4,a4,a3
ffffffffc0205146:	4f94                	lw	a3,24(a5)
ffffffffc0205148:	9f35                	addw	a4,a4,a3
ffffffffc020514a:	cf98                	sw	a4,24(a5)
     // 3. 返回选中的进程
     return p;
}
ffffffffc020514c:	8082                	ret
     p->lab6_stride += BIG_STRIDE / priority;
ffffffffc020514e:	80000737          	lui	a4,0x80000
     uint32_t priority = (p->lab6_priority == 0) ? 1 : p->lab6_priority;
ffffffffc0205152:	4685                	li	a3,1
     p->lab6_stride += BIG_STRIDE / priority;
ffffffffc0205154:	377d                	addiw	a4,a4,-1 # 7fffffff <_binary_obj___user_matrix_out_size+0x7fff4acf>
ffffffffc0205156:	02d7573b          	divuw	a4,a4,a3
ffffffffc020515a:	4f94                	lw	a3,24(a5)
ffffffffc020515c:	9f35                	addw	a4,a4,a3
ffffffffc020515e:	cf98                	sw	a4,24(a5)
}
ffffffffc0205160:	8082                	ret
         return idleproc;  // 无就绪进程，返回空闲进程
ffffffffc0205162:	000b0517          	auipc	a0,0xb0
ffffffffc0205166:	4f653503          	ld	a0,1270(a0) # ffffffffc02b5658 <idleproc>
ffffffffc020516a:	8082                	ret

ffffffffc020516c <stride_proc_tick>:
 */
static void
...
ffffffffc0205170:	4ec7b783          	ld	a5,1260(a5) # ffffffffc02b5658 <idleproc>
ffffffffc0205174:	00b78d63          	beq	a5,a1,ffffffffc020518e <stride_proc_tick+0x22>
ffffffffc0205178:	c999                	beqz	a1,ffffffffc020518e <stride_proc_tick+0x22>
         return;
     }
     // 1. 时间片递减（同RR调度）
     if (proc->time_slice > 0) {
ffffffffc020517a:	1205a783          	lw	a5,288(a1)
ffffffffc020517e:	00f05563          	blez	a5,ffffffffc0205188 <stride_proc_tick+0x1c>
         proc->time_slice--;
ffffffffc0205182:	37fd                	addiw	a5,a5,-1
ffffffffc0205184:	12f5a023          	sw	a5,288(a1)
     }
     // 2. 时间片耗尽，标记需要重新调度
     if (proc->time_slice == 0) {
ffffffffc0205188:	e399                	bnez	a5,ffffffffc020518e <stride_proc_tick+0x22>
         proc->need_resched = 1;
ffffffffc020518a:	4785                	li	a5,1
ffffffffc020518c:	ed9c                	sd	a5,24(a1)
     }
}
ffffffffc020518e:	8082                	ret

ffffffffc0205190 <skew_heap_merge.constprop.0>:
{
...
ffffffffc0205190:	87ae                	mv	a5,a1
                compare_f comp)
{
     if (a == NULL) return b;
ffffffffc0205192:	1c050963          	beqz	a0,ffffffffc0205364 <skew_heap_merge.constprop.0+0x1d4>
ffffffffc0205196:	862a                	mv	a2,a0
     else if (b == NULL) return a;
ffffffffc0205198:	1c058863          	beqz	a1,ffffffffc0205368 <skew_heap_merge.constprop.0+0x1d8>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc020519c:	4d14                	lw	a3,24(a0)
ffffffffc020519e:	4d98                	lw	a4,24(a1)
skew_heap_merge(skew_heap_entry_t *a, skew_heap_entry_t *b,
ffffffffc02051a0:	7139                	addi	sp,sp,-64
ffffffffc02051a2:	fc06                	sd	ra,56(sp)
ffffffffc02051a4:	40e6883b          	subw	a6,a3,a4
     else if (c == 0)
ffffffffc02051a8:	06084d63          	bltz	a6,ffffffffc0205222 <skew_heap_merge.constprop.0+0x92>
          return a;
     }
     else
     {
...
ffffffffc02051ac:	6998                	ld	a4,16(a1)
          r = b->left;
ffffffffc02051ae:	0085b883          	ld	a7,8(a1)
     else if (b == NULL) return a;
ffffffffc02051b2:	10070d63          	beqz	a4,ffffffffc02052cc <skew_heap_merge.constprop.0+0x13c>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc02051b6:	4f0c                	lw	a1,24(a4)
ffffffffc02051b8:	40b6883b          	subw	a6,a3,a1
     else if (c == 0)
ffffffffc02051bc:	0c084663          	bltz	a6,ffffffffc0205288 <skew_heap_merge.constprop.0+0xf8>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02051c0:	01073803          	ld	a6,16(a4)
          r = b->left;
ffffffffc02051c4:	00873303          	ld	t1,8(a4)
     else if (b == NULL) return a;
ffffffffc02051c8:	04080163          	beqz	a6,ffffffffc020520a <skew_heap_merge.constprop.0+0x7a>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc02051cc:	01882583          	lw	a1,24(a6) # fffffffffffff018 <end+0x3fd499a8>
ffffffffc02051d0:	f43e                	sd	a5,40(sp)
ffffffffc02051d2:	f01a                	sd	t1,32(sp)
ffffffffc02051d4:	9e8d                	subw	a3,a3,a1
ffffffffc02051d6:	ec3a                	sd	a4,24(sp)
ffffffffc02051d8:	e846                	sd	a7,16(sp)
     else if (c == 0)
ffffffffc02051da:	1606c263          	bltz	a3,ffffffffc020533e <skew_heap_merge.constprop.0+0x1ae>
          r = b->left;
ffffffffc02051de:	00883683          	ld	a3,8(a6)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02051e2:	01083583          	ld	a1,16(a6)
          r = b->left;
ffffffffc02051e6:	e442                	sd	a6,8(sp)
ffffffffc02051e8:	e036                	sd	a3,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02051ea:	fa7ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          
          b->left = l;
          b->right = r;
ffffffffc02051ee:	6822                	ld	a6,8(sp)
ffffffffc02051f0:	6682                	ld	a3,0(sp)
          if (l) l->parent = b;
ffffffffc02051f2:	68c2                	ld	a7,16(sp)
          b->left = l;
ffffffffc02051f4:	00a83423          	sd	a0,8(a6)
          b->right = r;
ffffffffc02051f8:	00d83823          	sd	a3,16(a6)
          if (l) l->parent = b;
ffffffffc02051fc:	6762                	ld	a4,24(sp)
ffffffffc02051fe:	7302                	ld	t1,32(sp)
ffffffffc0205200:	77a2                	ld	a5,40(sp)
ffffffffc0205202:	c119                	beqz	a0,ffffffffc0205208 <skew_heap_merge.constprop.0+0x78>
ffffffffc0205204:	01053023          	sd	a6,0(a0)
     if (a == NULL) return b;
ffffffffc0205208:	8642                	mv	a2,a6
          b->left = l;
ffffffffc020520a:	e710                	sd	a2,8(a4)
          b->right = r;
ffffffffc020520c:	00673823          	sd	t1,16(a4)
          if (l) l->parent = b;
ffffffffc0205210:	e218                	sd	a4,0(a2)

          return b;
     }
}
ffffffffc0205212:	70e2                	ld	ra,56(sp)
          b->left = l;
ffffffffc0205214:	e798                	sd	a4,8(a5)
          b->right = r;
ffffffffc0205216:	0117b823          	sd	a7,16(a5)
          if (l) l->parent = b;
ffffffffc020521a:	e31c                	sd	a5,0(a4)
     if (a == NULL) return b;
ffffffffc020521c:	853e                	mv	a0,a5
}
ffffffffc020521e:	6121                	addi	sp,sp,64
ffffffffc0205220:	8082                	ret
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205222:	6914                	ld	a3,16(a0)
          r = a->left;
ffffffffc0205224:	00853803          	ld	a6,8(a0)
     if (a == NULL) return b;
ffffffffc0205228:	caa1                	beqz	a3,ffffffffc0205278 <skew_heap_merge.constprop.0+0xe8>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc020522a:	4e88                	lw	a0,24(a3)
ffffffffc020522c:	40e5073b          	subw	a4,a0,a4
     else if (c == 0)
ffffffffc0205230:	0a074063          	bltz	a4,ffffffffc02052d0 <skew_heap_merge.constprop.0+0x140>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc0205234:	6998                	ld	a4,16(a1)
          r = b->left;
ffffffffc0205236:	0085b883          	ld	a7,8(a1)
     else if (b == NULL) return a;
ffffffffc020523a:	cb1d                	beqz	a4,ffffffffc0205270 <skew_heap_merge.constprop.0+0xe0>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc020523c:	4f0c                	lw	a1,24(a4)
ffffffffc020523e:	f43e                	sd	a5,40(sp)
ffffffffc0205240:	f032                	sd	a2,32(sp)
ffffffffc0205242:	9d0d                	subw	a0,a0,a1
ffffffffc0205244:	ec46                	sd	a7,24(sp)
ffffffffc0205246:	e842                	sd	a6,16(sp)
     else if (c == 0)
ffffffffc0205248:	0c054963          	bltz	a0,ffffffffc020531a <skew_heap_merge.constprop.0+0x18a>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc020524c:	6b0c                	ld	a1,16(a4)
ffffffffc020524e:	8536                	mv	a0,a3
          r = b->left;
ffffffffc0205250:	6714                	ld	a3,8(a4)
ffffffffc0205252:	e43a                	sd	a4,8(sp)
ffffffffc0205254:	e036                	sd	a3,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc0205256:	f3bff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          b->right = r;
ffffffffc020525a:	6722                	ld	a4,8(sp)
ffffffffc020525c:	6682                	ld	a3,0(sp)
          if (l) l->parent = b;
ffffffffc020525e:	6842                	ld	a6,16(sp)
          b->left = l;
ffffffffc0205260:	e708                	sd	a0,8(a4)
          b->right = r;
ffffffffc0205262:	eb14                	sd	a3,16(a4)
          if (l) l->parent = b;
ffffffffc0205264:	68e2                	ld	a7,24(sp)
ffffffffc0205266:	7602                	ld	a2,32(sp)
ffffffffc0205268:	77a2                	ld	a5,40(sp)
ffffffffc020526a:	c111                	beqz	a0,ffffffffc020526e <skew_heap_merge.constprop.0+0xde>
ffffffffc020526c:	e118                	sd	a4,0(a0)
     if (a == NULL) return b;
ffffffffc020526e:	86ba                	mv	a3,a4
          b->left = l;
ffffffffc0205270:	e794                	sd	a3,8(a5)
          b->right = r;
ffffffffc0205272:	0117b823          	sd	a7,16(a5)
          if (l) l->parent = b;
ffffffffc0205276:	e29c                	sd	a5,0(a3)
}
ffffffffc0205278:	70e2                	ld	ra,56(sp)
          a->left = l;
ffffffffc020527a:	e61c                	sd	a5,8(a2)
          a->right = r;
ffffffffc020527c:	01063823          	sd	a6,16(a2)
          if (l) l->parent = a;
ffffffffc0205280:	e390                	sd	a2,0(a5)
     else if (b == NULL) return a;
ffffffffc0205282:	8532                	mv	a0,a2
}
ffffffffc0205284:	6121                	addi	sp,sp,64
ffffffffc0205286:	8082                	ret
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205288:	6914                	ld	a3,16(a0)
          r = a->left;
ffffffffc020528a:	00853803          	ld	a6,8(a0)
     if (a == NULL) return b;
ffffffffc020528e:	ca9d                	beqz	a3,ffffffffc02052c4 <skew_heap_merge.constprop.0+0x134>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc0205290:	4e88                	lw	a0,24(a3)
ffffffffc0205292:	f43e                	sd	a5,40(sp)
ffffffffc0205294:	f032                	sd	a2,32(sp)
ffffffffc0205296:	40b505bb          	subw	a1,a0,a1
ffffffffc020529a:	ec42                	sd	a6,24(sp)
ffffffffc020529c:	e846                	sd	a7,16(sp)
     else if (c == 0)
ffffffffc020529e:	0405cb63          	bltz	a1,ffffffffc02052f4 <skew_heap_merge.constprop.0+0x164>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02052a2:	6b0c                	ld	a1,16(a4)
ffffffffc02052a4:	8536                	mv	a0,a3
          r = b->left;
ffffffffc02052a6:	6714                	ld	a3,8(a4)
ffffffffc02052a8:	e43a                	sd	a4,8(sp)
ffffffffc02052aa:	e036                	sd	a3,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02052ac:	ee5ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          b->right = r;
ffffffffc02052b0:	6722                	ld	a4,8(sp)
ffffffffc02052b2:	6682                	ld	a3,0(sp)
          if (l) l->parent = b;
ffffffffc02052b4:	68c2                	ld	a7,16(sp)
          b->left = l;
ffffffffc02052b6:	e708                	sd	a0,8(a4)
          b->right = r;
ffffffffc02052b8:	eb14                	sd	a3,16(a4)
          if (l) l->parent = b;
ffffffffc02052ba:	6862                	ld	a6,24(sp)
ffffffffc02052bc:	7602                	ld	a2,32(sp)
ffffffffc02052be:	77a2                	ld	a5,40(sp)
ffffffffc02052c0:	c111                	beqz	a0,ffffffffc02052c4 <skew_heap_merge.constprop.0+0x134>
ffffffffc02052c2:	e118                	sd	a4,0(a0)
          a->left = l;
ffffffffc02052c4:	e618                	sd	a4,8(a2)
          a->right = r;
ffffffffc02052c6:	01063823          	sd	a6,16(a2)
          if (l) l->parent = a;
ffffffffc02052ca:	e310                	sd	a2,0(a4)
     else if (b == NULL) return a;
ffffffffc02052cc:	8732                	mv	a4,a2
ffffffffc02052ce:	b791                	j	ffffffffc0205212 <skew_heap_merge.constprop.0+0x82>
          r = a->left;
ffffffffc02052d0:	669c                	ld	a5,8(a3)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02052d2:	6a88                	ld	a0,16(a3)
ffffffffc02052d4:	ec32                	sd	a2,24(sp)
ffffffffc02052d6:	e842                	sd	a6,16(sp)
          r = a->left;
ffffffffc02052d8:	e436                	sd	a3,8(sp)
ffffffffc02052da:	e03e                	sd	a5,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02052dc:	eb5ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc02052e0:	66a2                	ld	a3,8(sp)
ffffffffc02052e2:	6782                	ld	a5,0(sp)
          if (l) l->parent = a;
ffffffffc02052e4:	6842                	ld	a6,16(sp)
          a->left = l;
ffffffffc02052e6:	e688                	sd	a0,8(a3)
          a->right = r;
ffffffffc02052e8:	ea9c                	sd	a5,16(a3)
          if (l) l->parent = a;
ffffffffc02052ea:	6662                	ld	a2,24(sp)
ffffffffc02052ec:	c111                	beqz	a0,ffffffffc02052f0 <skew_heap_merge.constprop.0+0x160>
ffffffffc02052ee:	e114                	sd	a3,0(a0)
     else if (b == NULL) return a;
ffffffffc02052f0:	87b6                	mv	a5,a3
ffffffffc02052f2:	b759                	j	ffffffffc0205278 <skew_heap_merge.constprop.0+0xe8>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02052f4:	6a88                	ld	a0,16(a3)
ffffffffc02052f6:	85ba                	mv	a1,a4
          r = a->left;
ffffffffc02052f8:	6698                	ld	a4,8(a3)
ffffffffc02052fa:	e436                	sd	a3,8(sp)
ffffffffc02052fc:	e03a                	sd	a4,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02052fe:	e93ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc0205302:	66a2                	ld	a3,8(sp)
ffffffffc0205304:	6702                	ld	a4,0(sp)
          if (l) l->parent = a;
ffffffffc0205306:	68c2                	ld	a7,16(sp)
          a->left = l;
ffffffffc0205308:	e688                	sd	a0,8(a3)
          a->right = r;
ffffffffc020530a:	ea98                	sd	a4,16(a3)
          if (l) l->parent = a;
ffffffffc020530c:	6862                	ld	a6,24(sp)
ffffffffc020530e:	7602                	ld	a2,32(sp)
ffffffffc0205310:	77a2                	ld	a5,40(sp)
ffffffffc0205312:	c111                	beqz	a0,ffffffffc0205316 <skew_heap_merge.constprop.0+0x186>
ffffffffc0205314:	e114                	sd	a3,0(a0)
     else if (b == NULL) return a;
ffffffffc0205316:	8736                	mv	a4,a3
ffffffffc0205318:	b775                	j	ffffffffc02052c4 <skew_heap_merge.constprop.0+0x134>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc020531a:	6a88                	ld	a0,16(a3)
ffffffffc020531c:	85ba                	mv	a1,a4
          r = a->left;
ffffffffc020531e:	6698                	ld	a4,8(a3)
ffffffffc0205320:	e436                	sd	a3,8(sp)
ffffffffc0205322:	e03a                	sd	a4,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205324:	e6dff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc0205328:	66a2                	ld	a3,8(sp)
ffffffffc020532a:	6702                	ld	a4,0(sp)
          if (l) l->parent = a;
ffffffffc020532c:	6842                	ld	a6,16(sp)
          a->left = l;
ffffffffc020532e:	e688                	sd	a0,8(a3)
          a->right = r;
ffffffffc0205330:	ea98                	sd	a4,16(a3)
          if (l) l->parent = a;
ffffffffc0205332:	68e2                	ld	a7,24(sp)
ffffffffc0205334:	7602                	ld	a2,32(sp)
ffffffffc0205336:	77a2                	ld	a5,40(sp)
ffffffffc0205338:	dd05                	beqz	a0,ffffffffc0205270 <skew_heap_merge.constprop.0+0xe0>
ffffffffc020533a:	e114                	sd	a3,0(a0)
          if (l) l->parent = b;
ffffffffc020533c:	bf15                	j	ffffffffc0205270 <skew_heap_merge.constprop.0+0xe0>
          r = a->left;
ffffffffc020533e:	6614                	ld	a3,8(a2)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205340:	6908                	ld	a0,16(a0)
ffffffffc0205342:	85c2                	mv	a1,a6
          r = a->left;
ffffffffc0205344:	e432                	sd	a2,8(sp)
ffffffffc0205346:	e036                	sd	a3,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205348:	e49ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc020534c:	6622                	ld	a2,8(sp)
ffffffffc020534e:	6682                	ld	a3,0(sp)
          if (l) l->parent = a;
ffffffffc0205350:	68c2                	ld	a7,16(sp)
          a->left = l;
ffffffffc0205352:	e608                	sd	a0,8(a2)
          a->right = r;
ffffffffc0205354:	ea14                	sd	a3,16(a2)
          if (l) l->parent = a;
ffffffffc0205356:	6762                	ld	a4,24(sp)
ffffffffc0205358:	7302                	ld	t1,32(sp)
ffffffffc020535a:	77a2                	ld	a5,40(sp)
ffffffffc020535c:	ea0507e3          	beqz	a0,ffffffffc020520a <skew_heap_merge.constprop.0+0x7a>
ffffffffc0205360:	e110                	sd	a2,0(a0)
          if (l) l->parent = b;
ffffffffc0205362:	b565                	j	ffffffffc020520a <skew_heap_merge.constprop.0+0x7a>
     if (a == NULL) return b;
ffffffffc0205364:	852e                	mv	a0,a1
}
ffffffffc0205366:	8082                	ret
ffffffffc0205368:	8082                	ret

ffffffffc020536a <stride_enqueue>:
{
ffffffffc020536a:	7139                	addi	sp,sp,-64
ffffffffc020536c:	fc06                	sd	ra,56(sp)
     assert(proc && rq);
ffffffffc020536e:	c5cd                	beqz	a1,ffffffffc0205418 <stride_enqueue+0xae>
ffffffffc0205370:	872a                	mv	a4,a0
ffffffffc0205372:	c15d                	beqz	a0,ffffffffc0205418 <stride_enqueue+0xae>
     rq->lab6_run_pool = skew_heap_insert(rq->lab6_run_pool, &proc->lab6_run_pool, proc_stride_comp_f);
ffffffffc0205374:	6d14                	ld	a3,24(a0)
     a->left = a->right = a->parent = NULL;
ffffffffc0205376:	1205b423          	sd	zero,296(a1)
ffffffffc020537a:	1205bc23          	sd	zero,312(a1)
ffffffffc020537e:	1205b823          	sd	zero,304(a1)
ffffffffc0205382:	87ae                	mv	a5,a1
ffffffffc0205384:	12858593          	addi	a1,a1,296
     if (a == NULL) return b;
ffffffffc0205388:	ca91                	beqz	a3,ffffffffc020539c <stride_enqueue+0x32>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc020538a:	1407a503          	lw	a0,320(a5)
ffffffffc020538e:	4e90                	lw	a2,24(a3)
ffffffffc0205390:	9e09                	subw	a2,a2,a0
     else if (c == 0)
ffffffffc0205392:	02064963          	bltz	a2,ffffffffc02053c4 <stride_enqueue+0x5a>
          b->left = l;
ffffffffc0205396:	12d7b823          	sd	a3,304(a5)
          if (l) l->parent = b;
ffffffffc020539a:	e28c                	sd	a1,0(a3)
     if (a == NULL) return b;
ffffffffc020539c:	86ae                	mv	a3,a1
     if (proc != idleproc) {
ffffffffc020539e:	000b0617          	auipc	a2,0xb0
ffffffffc02053a2:	2ba63603          	ld	a2,698(a2) # ffffffffc02b5658 <idleproc>
     rq->lab6_run_pool = skew_heap_insert(rq->lab6_run_pool, &proc->lab6_run_pool, proc_stride_comp_f);
ffffffffc02053a6:	ef14                	sd	a3,24(a4)
     if (proc != idleproc) {
ffffffffc02053a8:	00f60563          	beq	a2,a5,ffffffffc02053b2 <stride_enqueue+0x48>
         proc->time_slice = rq->max_time_slice;
ffffffffc02053ac:	4b54                	lw	a3,20(a4)
ffffffffc02053ae:	12d7a023          	sw	a3,288(a5)
     rq->proc_num++;
ffffffffc02053b2:	4b14                	lw	a3,16(a4)
}
ffffffffc02053b4:	70e2                	ld	ra,56(sp)
     proc->rq = rq;
ffffffffc02053b6:	10e7b423          	sd	a4,264(a5)
     rq->proc_num++;
ffffffffc02053ba:	0016879b          	addiw	a5,a3,1
ffffffffc02053be:	cb1c                	sw	a5,16(a4)
}
ffffffffc02053c0:	6121                	addi	sp,sp,64
ffffffffc02053c2:	8082                	ret
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02053c4:	6a90                	ld	a2,16(a3)
          r = a->left;
ffffffffc02053c6:	0086b883          	ld	a7,8(a3)
     if (a == NULL) return b;
ffffffffc02053ca:	ca11                	beqz	a2,ffffffffc02053de <stride_enqueue+0x74>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc02053cc:	01862803          	lw	a6,24(a2)
ffffffffc02053d0:	40a8053b          	subw	a0,a6,a0
     else if (c == 0)
ffffffffc02053d4:	00054b63          	bltz	a0,ffffffffc02053ea <stride_enqueue+0x80>
          b->left = l;
ffffffffc02053d8:	12c7b823          	sd	a2,304(a5)
          if (l) l->parent = b;
ffffffffc02053dc:	e20c                	sd	a1,0(a2)
     if (a == NULL) return b;
ffffffffc02053de:	862e                	mv	a2,a1
          a->left = l;
ffffffffc02053e0:	e690                	sd	a2,8(a3)
          a->right = r;
ffffffffc02053e2:	0116b823          	sd	a7,16(a3)
          if (l) l->parent = a;
ffffffffc02053e6:	e214                	sd	a3,0(a2)
ffffffffc02053e8:	bf5d                	j	ffffffffc020539e <stride_enqueue+0x34>
          r = a->left;
ffffffffc02053ea:	00863803          	ld	a6,8(a2)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02053ee:	6a08                	ld	a0,16(a2)
ffffffffc02053f0:	f43e                	sd	a5,40(sp)
ffffffffc02053f2:	f03a                	sd	a4,32(sp)
ffffffffc02053f4:	ec46                	sd	a7,24(sp)
ffffffffc02053f6:	e836                	sd	a3,16(sp)
          r = a->left;
ffffffffc02053f8:	e432                	sd	a2,8(sp)
ffffffffc02053fa:	e042                	sd	a6,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02053fc:	d95ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc0205400:	6622                	ld	a2,8(sp)
ffffffffc0205402:	6802                	ld	a6,0(sp)
          if (l) l->parent = a;
ffffffffc0205404:	66c2                	ld	a3,16(sp)
          a->left = l;
ffffffffc0205406:	e608                	sd	a0,8(a2)
          a->right = r;
ffffffffc0205408:	01063823          	sd	a6,16(a2)
          if (l) l->parent = a;
ffffffffc020540c:	68e2                	ld	a7,24(sp)
ffffffffc020540e:	7702                	ld	a4,32(sp)
ffffffffc0205410:	77a2                	ld	a5,40(sp)
ffffffffc0205412:	d579                	beqz	a0,ffffffffc02053e0 <stride_enqueue+0x76>
ffffffffc0205414:	e110                	sd	a2,0(a0)
ffffffffc0205416:	b7e9                	j	ffffffffc02053e0 <stride_enqueue+0x76>
     assert(proc && rq);
ffffffffc0205418:	00002697          	auipc	a3,0x2
ffffffffc020541c:	69868693          	addi	a3,a3,1688 # ffffffffc0207ab0 <etext+0x1be6>
ffffffffc0205420:	00001617          	auipc	a2,0x1
ffffffffc0205424:	49860613          	addi	a2,a2,1176 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0205428:	05100593          	li	a1,81
ffffffffc020542c:	00002517          	auipc	a0,0x2
ffffffffc0205430:	69450513          	addi	a0,a0,1684 # ffffffffc0207ac0 <etext+0x1bf6>
ffffffffc0205434:	816fb0ef          	jal	ffffffffc020044a <__panic>

ffffffffc0205438 <stride_dequeue>:
{
ffffffffc0205438:	711d                	addi	sp,sp,-96
ffffffffc020543a:	ec86                	sd	ra,88(sp)
     assert(proc && rq && proc->rq == rq);
ffffffffc020543c:	2c058e63          	beqz	a1,ffffffffc0205718 <stride_dequeue+0x2e0>
ffffffffc0205440:	86aa                	mv	a3,a0
ffffffffc0205442:	2c050b63          	beqz	a0,ffffffffc0205718 <stride_dequeue+0x2e0>
ffffffffc0205446:	1085b783          	ld	a5,264(a1)
ffffffffc020544a:	872e                	mv	a4,a1
ffffffffc020544c:	2ca79663          	bne	a5,a0,ffffffffc0205718 <stride_dequeue+0x2e0>
static inline skew_heap_entry_t *
...
ffffffffc0205450:	1305b603          	ld	a2,304(a1)
     rq->lab6_run_pool = skew_heap_remove(rq->lab6_run_pool, &proc->lab6_run_pool, proc_stride_comp_f);
ffffffffc0205454:	01853303          	ld	t1,24(a0)
     skew_heap_entry_t *p   = b->parent;
ffffffffc0205458:	1285b803          	ld	a6,296(a1)
     skew_heap_entry_t *rep = skew_heap_merge(b->left, b->right, comp);
ffffffffc020545c:	1385b783          	ld	a5,312(a1)
     if (a == NULL) return b;
ffffffffc0205460:	16060263          	beqz	a2,ffffffffc02055c4 <stride_dequeue+0x18c>
     else if (b == NULL) return a;
ffffffffc0205464:	14078963          	beqz	a5,ffffffffc02055b6 <stride_dequeue+0x17e>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc0205468:	4e0c                	lw	a1,24(a2)
ffffffffc020546a:	4f88                	lw	a0,24(a5)
ffffffffc020546c:	40a588bb          	subw	a7,a1,a0
     else if (c == 0)
ffffffffc0205470:	0a08cf63          	bltz	a7,ffffffffc020552e <stride_dequeue+0xf6>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc0205474:	0107b883          	ld	a7,16(a5)
          r = b->left;
ffffffffc0205478:	0087be83          	ld	t4,8(a5)
     else if (b == NULL) return a;
ffffffffc020547c:	1a088b63          	beqz	a7,ffffffffc0205632 <stride_dequeue+0x1fa>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc0205480:	0188a503          	lw	a0,24(a7)
ffffffffc0205484:	40a58e3b          	subw	t3,a1,a0
     else if (c == 0)
ffffffffc0205488:	140e4263          	bltz	t3,ffffffffc02055cc <stride_dequeue+0x194>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc020548c:	0108be03          	ld	t3,16(a7)
          r = b->left;
ffffffffc0205490:	0088bf03          	ld	t5,8(a7)
     else if (b == NULL) return a;
ffffffffc0205494:	040e0a63          	beqz	t3,ffffffffc02054e8 <stride_dequeue+0xb0>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc0205498:	018e2503          	lw	a0,24(t3)
ffffffffc020549c:	e4ba                	sd	a4,72(sp)
ffffffffc020549e:	e0b6                	sd	a3,64(sp)
ffffffffc02054a0:	9d89                	subw	a1,a1,a0
ffffffffc02054a2:	fc3e                	sd	a5,56(sp)
ffffffffc02054a4:	f87a                	sd	t5,48(sp)
ffffffffc02054a6:	f446                	sd	a7,40(sp)
ffffffffc02054a8:	f076                	sd	t4,32(sp)
ffffffffc02054aa:	ec42                	sd	a6,24(sp)
ffffffffc02054ac:	e81a                	sd	t1,16(sp)
     else if (c == 0)
ffffffffc02054ae:	2205cc63          	bltz	a1,ffffffffc02056e6 <stride_dequeue+0x2ae>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02054b2:	010e3583          	ld	a1,16(t3)
ffffffffc02054b6:	8532                	mv	a0,a2
          r = b->left;
ffffffffc02054b8:	008e3603          	ld	a2,8(t3)
ffffffffc02054bc:	e472                	sd	t3,8(sp)
ffffffffc02054be:	e032                	sd	a2,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02054c0:	cd1ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          b->right = r;
ffffffffc02054c4:	6e22                	ld	t3,8(sp)
ffffffffc02054c6:	6602                	ld	a2,0(sp)
          if (l) l->parent = b;
ffffffffc02054c8:	6342                	ld	t1,16(sp)
          b->left = l;
ffffffffc02054ca:	00ae3423          	sd	a0,8(t3)
          b->right = r;
ffffffffc02054ce:	00ce3823          	sd	a2,16(t3)
          if (l) l->parent = b;
ffffffffc02054d2:	6862                	ld	a6,24(sp)
ffffffffc02054d4:	7e82                	ld	t4,32(sp)
ffffffffc02054d6:	78a2                	ld	a7,40(sp)
ffffffffc02054d8:	7f42                	ld	t5,48(sp)
ffffffffc02054da:	77e2                	ld	a5,56(sp)
ffffffffc02054dc:	6686                	ld	a3,64(sp)
ffffffffc02054de:	6726                	ld	a4,72(sp)
ffffffffc02054e0:	c119                	beqz	a0,ffffffffc02054e6 <stride_dequeue+0xae>
ffffffffc02054e2:	01c53023          	sd	t3,0(a0)
     if (a == NULL) return b;
ffffffffc02054e6:	8672                	mv	a2,t3
          b->left = l;
ffffffffc02054e8:	00c8b423          	sd	a2,8(a7)
          b->right = r;
ffffffffc02054ec:	01e8b823          	sd	t5,16(a7)
          if (l) l->parent = b;
ffffffffc02054f0:	01163023          	sd	a7,0(a2)
          b->left = l;
ffffffffc02054f4:	0117b423          	sd	a7,8(a5)
          b->right = r;
ffffffffc02054f8:	01d7b823          	sd	t4,16(a5)
          if (l) l->parent = b;
ffffffffc02054fc:	00f8b023          	sd	a5,0(a7)
     if (rep) rep->parent = p;
ffffffffc0205500:	0107b023          	sd	a6,0(a5)
     
     if (p)
ffffffffc0205504:	00080b63          	beqz	a6,ffffffffc020551a <stride_dequeue+0xe2>
     {
          if (p->left == b)
ffffffffc0205508:	00883583          	ld	a1,8(a6)
     rq->lab6_run_pool = skew_heap_remove(rq->lab6_run_pool, &proc->lab6_run_pool, proc_stride_comp_f);
ffffffffc020550c:	12870613          	addi	a2,a4,296
ffffffffc0205510:	0ac58763          	beq	a1,a2,ffffffffc02055be <stride_dequeue+0x186>
               p->left = rep;
          else p->right = rep;
ffffffffc0205514:	00f83823          	sd	a5,16(a6)
          return a;
ffffffffc0205518:	879a                	mv	a5,t1
     rq->proc_num--;
ffffffffc020551a:	4a90                	lw	a2,16(a3)
     rq->lab6_run_pool = skew_heap_remove(rq->lab6_run_pool, &proc->lab6_run_pool, proc_stride_comp_f);
ffffffffc020551c:	ee9c                	sd	a5,24(a3)
}
ffffffffc020551e:	60e6                	ld	ra,88(sp)
     proc->rq = NULL;
ffffffffc0205520:	10073423          	sd	zero,264(a4)
     rq->proc_num--;
ffffffffc0205524:	fff6079b          	addiw	a5,a2,-1
ffffffffc0205528:	ca9c                	sw	a5,16(a3)
}
ffffffffc020552a:	6125                	addi	sp,sp,96
ffffffffc020552c:	8082                	ret
          l = skew_heap_merge(a->right, b, comp);
ffffffffc020552e:	01063883          	ld	a7,16(a2)
          r = a->left;
ffffffffc0205532:	00863e83          	ld	t4,8(a2)
     if (a == NULL) return b;
ffffffffc0205536:	06088c63          	beqz	a7,ffffffffc02055ae <stride_dequeue+0x176>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc020553a:	0188a583          	lw	a1,24(a7)
ffffffffc020553e:	40a5853b          	subw	a0,a1,a0
     else if (c == 0)
ffffffffc0205542:	0e054a63          	bltz	a0,ffffffffc0205636 <stride_dequeue+0x1fe>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc0205546:	0107be03          	ld	t3,16(a5)
          r = b->left;
ffffffffc020554a:	0087bf03          	ld	t5,8(a5)
     else if (b == NULL) return a;
ffffffffc020554e:	040e0a63          	beqz	t3,ffffffffc02055a2 <stride_dequeue+0x16a>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc0205552:	018e2503          	lw	a0,24(t3)
ffffffffc0205556:	e4ba                	sd	a4,72(sp)
ffffffffc0205558:	e0b6                	sd	a3,64(sp)
ffffffffc020555a:	9d89                	subw	a1,a1,a0
ffffffffc020555c:	fc3e                	sd	a5,56(sp)
ffffffffc020555e:	f87a                	sd	t5,48(sp)
ffffffffc0205560:	f476                	sd	t4,40(sp)
ffffffffc0205562:	f032                	sd	a2,32(sp)
ffffffffc0205564:	ec42                	sd	a6,24(sp)
ffffffffc0205566:	e81a                	sd	t1,16(sp)
     else if (c == 0)
ffffffffc0205568:	1405c363          	bltz	a1,ffffffffc02056ae <stride_dequeue+0x276>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc020556c:	010e3583          	ld	a1,16(t3)
ffffffffc0205570:	8546                	mv	a0,a7
          r = b->left;
ffffffffc0205572:	008e3883          	ld	a7,8(t3)
ffffffffc0205576:	e472                	sd	t3,8(sp)
ffffffffc0205578:	e046                	sd	a7,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc020557a:	c17ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          b->right = r;
ffffffffc020557e:	6e22                	ld	t3,8(sp)
ffffffffc0205580:	6882                	ld	a7,0(sp)
          if (l) l->parent = b;
ffffffffc0205582:	6342                	ld	t1,16(sp)
          b->left = l;
ffffffffc0205584:	00ae3423          	sd	a0,8(t3)
          b->right = r;
ffffffffc0205588:	011e3823          	sd	a7,16(t3)
          if (l) l->parent = b;
ffffffffc020558c:	6862                	ld	a6,24(sp)
ffffffffc020558e:	7602                	ld	a2,32(sp)
ffffffffc0205590:	7ea2                	ld	t4,40(sp)
ffffffffc0205592:	7f42                	ld	t5,48(sp)
ffffffffc0205594:	77e2                	ld	a5,56(sp)
ffffffffc0205596:	6686                	ld	a3,64(sp)
ffffffffc0205598:	6726                	ld	a4,72(sp)
ffffffffc020559a:	c119                	beqz	a0,ffffffffc02055a0 <stride_dequeue+0x168>
ffffffffc020559c:	01c53023          	sd	t3,0(a0)
     if (a == NULL) return b;
ffffffffc02055a0:	88f2                	mv	a7,t3
          b->left = l;
ffffffffc02055a2:	0117b423          	sd	a7,8(a5)
          b->right = r;
ffffffffc02055a6:	01e7b823          	sd	t5,16(a5)
          if (l) l->parent = b;
ffffffffc02055aa:	00f8b023          	sd	a5,0(a7)
          a->left = l;
ffffffffc02055ae:	e61c                	sd	a5,8(a2)
          a->right = r;
ffffffffc02055b0:	01d63823          	sd	t4,16(a2)
          if (l) l->parent = a;
ffffffffc02055b4:	e390                	sd	a2,0(a5)
     else if (b == NULL) return a;
ffffffffc02055b6:	87b2                	mv	a5,a2
     if (rep) rep->parent = p;
ffffffffc02055b8:	0107b023          	sd	a6,0(a5)
ffffffffc02055bc:	b7a1                	j	ffffffffc0205504 <stride_dequeue+0xcc>
               p->left = rep;
ffffffffc02055be:	00f83423          	sd	a5,8(a6)
ffffffffc02055c2:	bf99                	j	ffffffffc0205518 <stride_dequeue+0xe0>
     if (rep) rep->parent = p;
ffffffffc02055c4:	d3a1                	beqz	a5,ffffffffc0205504 <stride_dequeue+0xcc>
ffffffffc02055c6:	0107b023          	sd	a6,0(a5)
ffffffffc02055ca:	bf2d                	j	ffffffffc0205504 <stride_dequeue+0xcc>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02055cc:	01063e03          	ld	t3,16(a2)
          r = a->left;
ffffffffc02055d0:	00863f03          	ld	t5,8(a2)
     if (a == NULL) return b;
ffffffffc02055d4:	040e0963          	beqz	t3,ffffffffc0205626 <stride_dequeue+0x1ee>
     int32_t c = p->lab6_stride - q->lab6_stride;
ffffffffc02055d8:	018e2583          	lw	a1,24(t3)
ffffffffc02055dc:	e4ba                	sd	a4,72(sp)
ffffffffc02055de:	e0b6                	sd	a3,64(sp)
ffffffffc02055e0:	9d89                	subw	a1,a1,a0
ffffffffc02055e2:	fc3e                	sd	a5,56(sp)
ffffffffc02055e4:	f87a                	sd	t5,48(sp)
ffffffffc02055e6:	f476                	sd	t4,40(sp)
ffffffffc02055e8:	f032                	sd	a2,32(sp)
ffffffffc02055ea:	ec42                	sd	a6,24(sp)
ffffffffc02055ec:	e81a                	sd	t1,16(sp)
     else if (c == 0)
ffffffffc02055ee:	0805c463          	bltz	a1,ffffffffc0205676 <stride_dequeue+0x23e>
          l = skew_heap_merge(a, b->right, comp);
ffffffffc02055f2:	0108b583          	ld	a1,16(a7)
ffffffffc02055f6:	8572                	mv	a0,t3
          r = b->left;
ffffffffc02055f8:	0088be03          	ld	t3,8(a7)
ffffffffc02055fc:	e446                	sd	a7,8(sp)
ffffffffc02055fe:	e072                	sd	t3,0(sp)
          l = skew_heap_merge(a, b->right, comp);
ffffffffc0205600:	b91ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          b->right = r;
ffffffffc0205604:	68a2                	ld	a7,8(sp)
ffffffffc0205606:	6e02                	ld	t3,0(sp)
          if (l) l->parent = b;
ffffffffc0205608:	6342                	ld	t1,16(sp)
          b->left = l;
ffffffffc020560a:	00a8b423          	sd	a0,8(a7)
          b->right = r;
ffffffffc020560e:	01c8b823          	sd	t3,16(a7)
          if (l) l->parent = b;
ffffffffc0205612:	6862                	ld	a6,24(sp)
ffffffffc0205614:	7602                	ld	a2,32(sp)
ffffffffc0205616:	7ea2                	ld	t4,40(sp)
ffffffffc0205618:	7f42                	ld	t5,48(sp)
ffffffffc020561a:	77e2                	ld	a5,56(sp)
ffffffffc020561c:	6686                	ld	a3,64(sp)
ffffffffc020561e:	6726                	ld	a4,72(sp)
ffffffffc0205620:	c119                	beqz	a0,ffffffffc0205626 <stride_dequeue+0x1ee>
ffffffffc0205622:	01153023          	sd	a7,0(a0)
          a->left = l;
ffffffffc0205626:	01163423          	sd	a7,8(a2)
          a->right = r;
ffffffffc020562a:	01e63823          	sd	t5,16(a2)
          if (l) l->parent = a;
ffffffffc020562e:	00c8b023          	sd	a2,0(a7)
     else if (b == NULL) return a;
ffffffffc0205632:	88b2                	mv	a7,a2
ffffffffc0205634:	b5c1                	j	ffffffffc02054f4 <stride_dequeue+0xbc>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205636:	0108b503          	ld	a0,16(a7)
ffffffffc020563a:	85be                	mv	a1,a5
          r = a->left;
ffffffffc020563c:	0088b783          	ld	a5,8(a7)
ffffffffc0205640:	fc3a                	sd	a4,56(sp)
ffffffffc0205642:	f836                	sd	a3,48(sp)
ffffffffc0205644:	f476                	sd	t4,40(sp)
ffffffffc0205646:	f032                	sd	a2,32(sp)
ffffffffc0205648:	ec42                	sd	a6,24(sp)
ffffffffc020564a:	e81a                	sd	t1,16(sp)
ffffffffc020564c:	e446                	sd	a7,8(sp)
ffffffffc020564e:	e03e                	sd	a5,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205650:	b41ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc0205654:	68a2                	ld	a7,8(sp)
ffffffffc0205656:	6782                	ld	a5,0(sp)
          if (l) l->parent = a;
ffffffffc0205658:	6342                	ld	t1,16(sp)
          a->left = l;
ffffffffc020565a:	00a8b423          	sd	a0,8(a7)
          a->right = r;
ffffffffc020565e:	00f8b823          	sd	a5,16(a7)
          if (l) l->parent = a;
ffffffffc0205662:	6862                	ld	a6,24(sp)
ffffffffc0205664:	7602                	ld	a2,32(sp)
ffffffffc0205666:	7ea2                	ld	t4,40(sp)
ffffffffc0205668:	76c2                	ld	a3,48(sp)
ffffffffc020566a:	7762                	ld	a4,56(sp)
ffffffffc020566c:	c119                	beqz	a0,ffffffffc0205672 <stride_dequeue+0x23a>
ffffffffc020566e:	01153023          	sd	a7,0(a0)
     else if (b == NULL) return a;
ffffffffc0205672:	87c6                	mv	a5,a7
ffffffffc0205674:	bf2d                	j	ffffffffc02055ae <stride_dequeue+0x176>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205676:	010e3503          	ld	a0,16(t3)
ffffffffc020567a:	85c6                	mv	a1,a7
          r = a->left;
ffffffffc020567c:	008e3883          	ld	a7,8(t3)
ffffffffc0205680:	e472                	sd	t3,8(sp)
ffffffffc0205682:	e046                	sd	a7,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc0205684:	b0dff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc0205688:	6e22                	ld	t3,8(sp)
ffffffffc020568a:	6882                	ld	a7,0(sp)
          if (l) l->parent = a;
ffffffffc020568c:	6342                	ld	t1,16(sp)
          a->left = l;
ffffffffc020568e:	00ae3423          	sd	a0,8(t3)
          a->right = r;
ffffffffc0205692:	011e3823          	sd	a7,16(t3)
          if (l) l->parent = a;
ffffffffc0205696:	6862                	ld	a6,24(sp)
ffffffffc0205698:	7602                	ld	a2,32(sp)
ffffffffc020569a:	7ea2                	ld	t4,40(sp)
ffffffffc020569c:	7f42                	ld	t5,48(sp)
ffffffffc020569e:	77e2                	ld	a5,56(sp)
ffffffffc02056a0:	6686                	ld	a3,64(sp)
ffffffffc02056a2:	6726                	ld	a4,72(sp)
ffffffffc02056a4:	c119                	beqz	a0,ffffffffc02056aa <stride_dequeue+0x272>
ffffffffc02056a6:	01c53023          	sd	t3,0(a0)
     else if (b == NULL) return a;
ffffffffc02056aa:	88f2                	mv	a7,t3
ffffffffc02056ac:	bfad                	j	ffffffffc0205626 <stride_dequeue+0x1ee>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02056ae:	0108b503          	ld	a0,16(a7)
ffffffffc02056b2:	85f2                	mv	a1,t3
          r = a->left;
ffffffffc02056b4:	0088be03          	ld	t3,8(a7)
ffffffffc02056b8:	e446                	sd	a7,8(sp)
ffffffffc02056ba:	e072                	sd	t3,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02056bc:	ad5ff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc02056c0:	68a2                	ld	a7,8(sp)
ffffffffc02056c2:	6e02                	ld	t3,0(sp)
          if (l) l->parent = a;
ffffffffc02056c4:	6342                	ld	t1,16(sp)
          a->left = l;
ffffffffc02056c6:	00a8b423          	sd	a0,8(a7)
          a->right = r;
ffffffffc02056ca:	01c8b823          	sd	t3,16(a7)
          if (l) l->parent = a;
ffffffffc02056ce:	6862                	ld	a6,24(sp)
ffffffffc02056d0:	7602                	ld	a2,32(sp)
ffffffffc02056d2:	7ea2                	ld	t4,40(sp)
ffffffffc02056d4:	7f42                	ld	t5,48(sp)
ffffffffc02056d6:	77e2                	ld	a5,56(sp)
ffffffffc02056d8:	6686                	ld	a3,64(sp)
ffffffffc02056da:	6726                	ld	a4,72(sp)
ffffffffc02056dc:	ec0503e3          	beqz	a0,ffffffffc02055a2 <stride_dequeue+0x16a>
ffffffffc02056e0:	01153023          	sd	a7,0(a0)
          if (l) l->parent = b;
ffffffffc02056e4:	bd7d                	j	ffffffffc02055a2 <stride_dequeue+0x16a>
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02056e6:	6a08                	ld	a0,16(a2)
ffffffffc02056e8:	85f2                	mv	a1,t3
          r = a->left;
ffffffffc02056ea:	00863e03          	ld	t3,8(a2)
ffffffffc02056ee:	e432                	sd	a2,8(sp)
ffffffffc02056f0:	e072                	sd	t3,0(sp)
          l = skew_heap_merge(a->right, b, comp);
ffffffffc02056f2:	a9fff0ef          	jal	ffffffffc0205190 <skew_heap_merge.constprop.0>
          a->right = r;
ffffffffc02056f6:	6622                	ld	a2,8(sp)
ffffffffc02056f8:	6e02                	ld	t3,0(sp)
          if (l) l->parent = a;
ffffffffc02056fa:	6342                	ld	t1,16(sp)
          a->left = l;
ffffffffc02056fc:	e608                	sd	a0,8(a2)
          a->right = r;
ffffffffc02056fe:	01c63823          	sd	t3,16(a2)
          if (l) l->parent = a;
ffffffffc0205702:	6862                	ld	a6,24(sp)
ffffffffc0205704:	7e82                	ld	t4,32(sp)
ffffffffc0205706:	78a2                	ld	a7,40(sp)
ffffffffc0205708:	7f42                	ld	t5,48(sp)
ffffffffc020570a:	77e2                	ld	a5,56(sp)
ffffffffc020570c:	6686                	ld	a3,64(sp)
ffffffffc020570e:	6726                	ld	a4,72(sp)
ffffffffc0205710:	dc050ce3          	beqz	a0,ffffffffc02054e8 <stride_dequeue+0xb0>
ffffffffc0205714:	e110                	sd	a2,0(a0)
          if (l) l->parent = b;
ffffffffc0205716:	bbc9                	j	ffffffffc02054e8 <stride_dequeue+0xb0>
     assert(proc && rq && proc->rq == rq);
ffffffffc0205718:	00002697          	auipc	a3,0x2
ffffffffc020571c:	3d068693          	addi	a3,a3,976 # ffffffffc0207ae8 <etext+0x1c1e>
ffffffffc0205720:	00001617          	auipc	a2,0x1
ffffffffc0205724:	19860613          	addi	a2,a2,408 # ffffffffc02068b8 <etext+0x9ee>
ffffffffc0205728:	06e00593          	li	a1,110
ffffffffc020572c:	00002517          	auipc	a0,0x2
ffffffffc0205730:	39450513          	addi	a0,a0,916 # ffffffffc0207ac0 <etext+0x1bf6>
ffffffffc0205734:	d17fa0ef          	jal	ffffffffc020044a <__panic>

ffffffffc0205738 <sched_class_proc_tick>:
...
{
    if (proc != idleproc) {
ffffffffc0205738:	000b0797          	auipc	a5,0xb0
ffffffffc020573c:	f207b783          	ld	a5,-224(a5) # ffffffffc02b5658 <idleproc>
{
ffffffffc0205740:	85aa                	mv	a1,a0
    if (proc != idleproc) {
ffffffffc0205742:	00a78c63          	beq	a5,a0,ffffffffc020575a <sched_class_proc_tick+0x22>
        sched_class->proc_tick(rq, proc);
ffffffffc0205746:	000b0797          	auipc	a5,0xb0
ffffffffc020574a:	f227b783          	ld	a5,-222(a5) # ffffffffc02b5668 <sched_class>
ffffffffc020574e:	000b0517          	auipc	a0,0xb0
ffffffffc0205752:	f1253503          	ld	a0,-238(a0) # ffffffffc02b5660 <rq>
ffffffffc0205756:	779c                	ld	a5,40(a5)
ffffffffc0205758:	8782                	jr	a5
    } else {
...
ffffffffc020575c:	000ac797          	auipc	a5,0xac
ffffffffc0205760:	9ec78793          	addi	a5,a5,-1556 # ffffffffc02b1148 <stride_sched_class>
{
ffffffffc0205764:	1141                	addi	sp,sp,-16

    rq = &__rq;
    rq->max_time_slice = MAX_TIME_SLICE;
    /* ensure run_queue fields initialized by class */
    sched_class->init(rq);
ffffffffc0205766:	6794                	ld	a3,8(a5)
    sched_class = &stride_sched_class;
ffffffffc0205768:	000b0717          	auipc	a4,0xb0
ffffffffc020576c:	f0f73023          	sd	a5,-256(a4) # ffffffffc02b5668 <sched_class>
{
ffffffffc0205770:	e406                	sd	ra,8(sp)
ffffffffc0205772:	000b0797          	auipc	a5,0xb0
ffffffffc0205776:	e5e78793          	addi	a5,a5,-418 # ffffffffc02b55d0 <timer_list>
    rq = &__rq;
ffffffffc020577a:	000b0717          	auipc	a4,0xb0
ffffffffc020577e:	e3670713          	addi	a4,a4,-458 # ffffffffc02b55b0 <__rq>
    rq->max_time_slice = MAX_TIME_SLICE;
ffffffffc0205782:	4615                	li	a2,5
ffffffffc0205784:	e79c                	sd	a5,8(a5)
ffffffffc0205786:	e39c                	sd	a5,0(a5)
    sched_class->init(rq);
ffffffffc0205788:	853a                	mv	a0,a4
    rq->max_time_slice = MAX_TIME_SLICE;
ffffffffc020578a:	cb50                	sw	a2,20(a4)
    rq = &__rq;
ffffffffc020578c:	000b0797          	auipc	a5,0xb0
ffffffffc0205790:	ece7ba23          	sd	a4,-300(a5) # ffffffffc02b5660 <rq>
    sched_class->init(rq);
ffffffffc0205794:	9682                	jalr	a3

    
    cprintf("sched class: %s\n", sched_class->name);
ffffffffc0205796:	000b0797          	auipc	a5,0xb0
ffffffffc020579a:	ed27b783          	ld	a5,-302(a5) # ffffffffc02b5668 <sched_class>
}
ffffffffc020579e:	60a2                	ld	ra,8(sp)
    cprintf("sched class: %s\n", sched_class->name);
ffffffffc02057a0:	00002517          	auipc	a0,0x2
ffffffffc02057a4:	38050513          	addi	a0,a0,896 # ffffffffc0207b20 <etext+0x1c56>
ffffffffc02057a8:	638c                	ld	a1,0(a5)
}
ffffffffc02057aa:	0141                	addi	sp,sp,16
    cprintf("sched class: %s\n", sched_class->name);
ffffffffc02057ac:	9edfa06f          	j	ffffffffc0200198 <cprintf>

ffffffffc02057b0 <wakeup_proc>:
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02057b0:	100027f3          	csrr	a5,sstatus
ffffffffc02057b4:	8b89                	andi	a5,a5,2
ffffffffc02057b6:	e7a9                	bnez	a5,ffffffffc0205800 <wakeup_proc+0x50>
...
ffffffffc02057b8:	4118                	lw	a4,0(a0)
ffffffffc02057ba:	4789                	li	a5,2
ffffffffc02057bc:	04f70163          	beq	a4,a5,ffffffffc02057fe <wakeup_proc+0x4e>
// DEBUG:         cprintf("wakeup_proc: pid=%d state=%d\n", proc->pid, proc->state);
        proc->state = PROC_RUNNABLE;
        proc->wait_state = 0;
        /* only enqueue if it's not the current running thread */
        if (proc != current) {
ffffffffc02057c0:	000b0717          	auipc	a4,0xb0
ffffffffc02057c4:	e8873703          	ld	a4,-376(a4) # ffffffffc02b5648 <current>
        proc->wait_state = 0;
ffffffffc02057c8:	0e052623          	sw	zero,236(a0)
        proc->state = PROC_RUNNABLE;
ffffffffc02057cc:	c11c                	sw	a5,0(a0)
        if (proc != current) {
ffffffffc02057ce:	02e50663          	beq	a0,a4,ffffffffc02057fa <wakeup_proc+0x4a>
    if (proc != idleproc) {
ffffffffc02057d2:	000b0797          	auipc	a5,0xb0
ffffffffc02057d6:	e867b783          	ld	a5,-378(a5) # ffffffffc02b5658 <idleproc>
ffffffffc02057da:	02f50163          	beq	a0,a5,ffffffffc02057fc <wakeup_proc+0x4c>
        sched_class->enqueue(rq, proc);
ffffffffc02057de:	000b0717          	auipc	a4,0xb0
ffffffffc02057e2:	e8a73703          	ld	a4,-374(a4) # ffffffffc02b5668 <sched_class>
        proc->rq = rq;
ffffffffc02057e6:	000b0797          	auipc	a5,0xb0
ffffffffc02057ea:	e7a7b783          	ld	a5,-390(a5) # ffffffffc02b5660 <rq>
        sched_class->enqueue(rq, proc);
ffffffffc02057ee:	85aa                	mv	a1,a0
ffffffffc02057f0:	6b18                	ld	a4,16(a4)
        proc->rq = rq;
ffffffffc02057f2:	10f53423          	sd	a5,264(a0)
        sched_class->enqueue(rq, proc);
ffffffffc02057f6:	853e                	mv	a0,a5
ffffffffc02057f8:	8702                	jr	a4
ffffffffc02057fa:	8082                	ret
ffffffffc02057fc:	8082                	ret
ffffffffc02057fe:	8082                	ret
{
ffffffffc0205800:	1101                	addi	sp,sp,-32
ffffffffc0205802:	e42a                	sd	a0,8(sp)
ffffffffc0205804:	ec06                	sd	ra,24(sp)
        intr_disable();
ffffffffc0205806:	904fb0ef          	jal	ffffffffc020090a <intr_disable>
    if (proc->state != PROC_RUNNABLE) {
ffffffffc020580a:	6522                	ld	a0,8(sp)
ffffffffc020580c:	4789                	li	a5,2
ffffffffc020580e:	4118                	lw	a4,0(a0)
ffffffffc0205810:	02f70f63          	beq	a4,a5,ffffffffc020584e <wakeup_proc+0x9e>
        if (proc != current) {
ffffffffc0205814:	000b0717          	auipc	a4,0xb0
ffffffffc0205818:	e3473703          	ld	a4,-460(a4) # ffffffffc02b5648 <current>
        proc->wait_state = 0;
ffffffffc020581c:	0e052623          	sw	zero,236(a0)
        proc->state = PROC_RUNNABLE;
ffffffffc0205820:	c11c                	sw	a5,0(a0)
        if (proc != current) {
ffffffffc0205822:	02e50663          	beq	a0,a4,ffffffffc020584e <wakeup_proc+0x9e>
    if (proc != idleproc) {
ffffffffc0205826:	000b0797          	auipc	a5,0xb0
ffffffffc020582a:	e327b783          	ld	a5,-462(a5) # ffffffffc02b5658 <idleproc>
ffffffffc020582e:	02f50063          	beq	a0,a5,ffffffffc020584e <wakeup_proc+0x9e>
        sched_class->enqueue(rq, proc);
ffffffffc0205832:	000b0717          	auipc	a4,0xb0
ffffffffc0205836:	e3673703          	ld	a4,-458(a4) # ffffffffc02b5668 <sched_class>
        proc->rq = rq;
ffffffffc020583a:	000b0797          	auipc	a5,0xb0
ffffffffc020583e:	e267b783          	ld	a5,-474(a5) # ffffffffc02b5660 <rq>
        sched_class->enqueue(rq, proc);
ffffffffc0205842:	85aa                	mv	a1,a0
ffffffffc0205844:	6b18                	ld	a4,16(a4)
        proc->rq = rq;
ffffffffc0205846:	10f53423          	sd	a5,264(a0)
        sched_class->enqueue(rq, proc);
ffffffffc020584a:	853e                	mv	a0,a5
ffffffffc020584c:	9702                	jalr	a4
...
ffffffffc020584e:	60e2                	ld	ra,24(sp)
ffffffffc0205850:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205852:	8b2fb06f          	j	ffffffffc0200904 <intr_enable>

ffffffffc0205856 <schedule>:

/* schedule: high level scheduling flow (enqueue current if runnable,
 * pick next, dequeue it and run) */
void schedule(void)
{
ffffffffc0205856:	7139                	addi	sp,sp,-64
ffffffffc0205858:	fc06                	sd	ra,56(sp)
ffffffffc020585a:	f822                	sd	s0,48(sp)
ffffffffc020585c:	f426                	sd	s1,40(sp)
ffffffffc020585e:	f04a                	sd	s2,32(sp)
ffffffffc0205860:	ec4e                	sd	s3,24(sp)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0205862:	100027f3          	csrr	a5,sstatus
ffffffffc0205866:	8b89                	andi	a5,a5,2
ffffffffc0205868:	4981                	li	s3,0
ffffffffc020586a:	efd1                	bnez	a5,ffffffffc0205906 <schedule+0xb0>
    bool intr_flag;
    local_intr_save(intr_flag);

    struct proc_struct *cur = current;
ffffffffc020586c:	000b0417          	auipc	s0,0xb0
ffffffffc0205870:	ddc43403          	ld	s0,-548(s0) # ffffffffc02b5648 <current>
...
ffffffffc0205874:	4789                	li	a5,2
ffffffffc0205876:	000b0497          	auipc	s1,0xb0
ffffffffc020587a:	dea48493          	addi	s1,s1,-534 # ffffffffc02b5660 <rq>
ffffffffc020587e:	4018                	lw	a4,0(s0)
    cur->need_resched = 0;
ffffffffc0205880:	00043c23          	sd	zero,24(s0)
    if (cur->state == PROC_RUNNABLE) {
ffffffffc0205884:	000b0917          	auipc	s2,0xb0
ffffffffc0205888:	de490913          	addi	s2,s2,-540 # ffffffffc02b5668 <sched_class>
ffffffffc020588c:	04f70e63          	beq	a4,a5,ffffffffc02058e8 <schedule+0x92>
    return sched_class->pick_next(rq);
ffffffffc0205890:	00093783          	ld	a5,0(s2)
ffffffffc0205894:	6088                	ld	a0,0(s1)
ffffffffc0205896:	739c                	ld	a5,32(a5)
ffffffffc0205898:	9782                	jalr	a5
ffffffffc020589a:	85aa                	mv	a1,a0
    ...
    if (!next) {
ffffffffc020589c:	c129                	beqz	a0,ffffffffc02058de <schedule+0x88>
    sched_class->dequeue(rq, proc);
ffffffffc020589e:	00093783          	ld	a5,0(s2)
ffffffffc02058a2:	6088                	ld	a0,0(s1)
ffffffffc02058a4:	e42e                	sd	a1,8(sp)
ffffffffc02058a6:	6f9c                	ld	a5,24(a5)
ffffffffc02058a8:	9782                	jalr	a5
ffffffffc02058aa:	65a2                	ld	a1,8(sp)
    ...
    if (next == cur) {
ffffffffc02058ac:	00858863          	beq	a1,s0,ffffffffc02058bc <schedule+0x66>
        return;
    }
    ...
    /* accounting */
    next->runs++;
ffffffffc02058b0:	459c                	lw	a5,8(a1)

    /* context switch */
    proc_run(next);
ffffffffc02058b2:	852e                	mv	a0,a1
    next->runs++;
ffffffffc02058b4:	2785                	addiw	a5,a5,1
ffffffffc02058b6:	c59c                	sw	a5,8(a1)
    proc_run(next);
ffffffffc02058b8:	dcafe0ef          	jal	ffffffffc0203e82 <proc_run>
    if (flag)
ffffffffc02058bc:	00099963          	bnez	s3,ffffffffc02058ce <schedule+0x78>

    /* proc_run should not return here in normal flow, but restore just in case */
    local_intr_restore(intr_flag);
ffffffffc02058c0:	70e2                	ld	ra,56(sp)
ffffffffc02058c2:	7442                	ld	s0,48(sp)
ffffffffc02058c4:	74a2                	ld	s1,40(sp)
ffffffffc02058c6:	7902                	ld	s2,32(sp)
ffffffffc02058c8:	69e2                	ld	s3,24(sp)
ffffffffc02058ca:	6121                	addi	sp,sp,64
ffffffffc02058cc:	8082                	ret
ffffffffc02058ce:	7442                	ld	s0,48(sp)
ffffffffc02058d0:	70e2                	ld	ra,56(sp)
ffffffffc02058d2:	74a2                	ld	s1,40(sp)
ffffffffc02058d4:	7902                	ld	s2,32(sp)
ffffffffc02058d6:	69e2                	ld	s3,24(sp)
ffffffffc02058d8:	6121                	addi	sp,sp,64
        intr_enable();
ffffffffc02058da:	82afb06f          	j	ffffffffc0200904 <intr_enable>
        next = idleproc;
ffffffffc02058de:	000b0597          	auipc	a1,0xb0
ffffffffc02058e2:	d7a5b583          	ld	a1,-646(a1) # ffffffffc02b5658 <idleproc>
ffffffffc02058e6:	b7d9                	j	ffffffffc02058ac <schedule+0x56>
    if (proc != idleproc) {
ffffffffc02058e8:	000b0797          	auipc	a5,0xb0
ffffffffc02058ec:	d707b783          	ld	a5,-656(a5) # ffffffffc02b5658 <idleproc>
ffffffffc02058f0:	faf400e3          	beq	s0,a5,ffffffffc0205890 <schedule+0x3a>
        sched_class->enqueue(rq, proc);
ffffffffc02058f4:	00093783          	ld	a5,0(s2)
        proc->rq = rq;
ffffffffc02058f8:	6088                	ld	a0,0(s1)
        sched_class->enqueue(rq, proc);
ffffffffc02058fa:	85a2                	mv	a1,s0
ffffffffc02058fc:	6b9c                	ld	a5,16(a5)
        proc->rq = rq;
ffffffffc02058fe:	10a43423          	sd	a0,264(s0)
        sched_class->enqueue(rq, proc);
ffffffffc0205902:	9782                	jalr	a5
ffffffffc0205904:	b771                	j	ffffffffc0205890 <schedule+0x3a>
        intr_disable();
ffffffffc0205906:	804fb0ef          	jal	ffffffffc020090a <intr_disable>
        return 1;
ffffffffc020590a:	4985                	li	s3,1
ffffffffc020590c:	b785                	j	ffffffffc020586c <schedule+0x16>

ffffffffc020590e <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc020590e:	000b0797          	auipc	a5,0xb0
ffffffffc0205912:	d3a7b783          	ld	a5,-710(a5) # ffffffffc02b5648 <current>
}
ffffffffc0205916:	43c8                	lw	a0,4(a5)
ffffffffc0205918:	8082                	ret

ffffffffc020591a <sys_pgdir>:
...
ffffffffc020591e <sys_gettime>:
static int sys_gettime(uint64_t arg[]){
    return (int)ticks*10;
ffffffffc020591e:	000b0797          	auipc	a5,0xb0
ffffffffc0205922:	cca7b783          	ld	a5,-822(a5) # ffffffffc02b55e8 <ticks>
ffffffffc0205926:	0027951b          	slliw	a0,a5,0x2
ffffffffc020592a:	9d3d                	addw	a0,a0,a5
ffffffffc020592c:	0015151b          	slliw	a0,a0,0x1
}
ffffffffc0205930:	8082                	ret

ffffffffc0205932 <sys_lab6_set_priority>:
static int sys_lab6_set_priority(uint64_t arg[]){
    uint64_t priority = (uint64_t)arg[0];
    lab6_set_priority(priority);
ffffffffc0205932:	4108                	lw	a0,0(a0)
static int sys_lab6_set_priority(uint64_t arg[]){
ffffffffc0205934:	1141                	addi	sp,sp,-16
ffffffffc0205936:	e406                	sd	ra,8(sp)
    lab6_set_priority(priority);
ffffffffc0205938:	f34ff0ef          	jal	ffffffffc020506c <lab6_set_priority>
    return 0;
}
ffffffffc020593c:	60a2                	ld	ra,8(sp)
ffffffffc020593e:	4501                	li	a0,0
ffffffffc0205940:	0141                	addi	sp,sp,16
ffffffffc0205942:	8082                	ret

ffffffffc0205944 <sys_putc>:
    cputchar(c);
ffffffffc0205944:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0205946:	1141                	addi	sp,sp,-16
ffffffffc0205948:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020594a:	883fa0ef          	jal	ffffffffc02001cc <cputchar>
}
ffffffffc020594e:	60a2                	ld	ra,8(sp)
ffffffffc0205950:	4501                	li	a0,0
ffffffffc0205952:	0141                	addi	sp,sp,16
ffffffffc0205954:	8082                	ret

ffffffffc0205956 <sys_kill>:
    return do_kill(pid);
ffffffffc0205956:	4108                	lw	a0,0(a0)
ffffffffc0205958:	ce2ff06f          	j	ffffffffc0204e3a <do_kill>

ffffffffc020595c <sys_yield>:
    return do_yield();
ffffffffc020595c:	c94ff06f          	j	ffffffffc0204df0 <do_yield>

ffffffffc0205960 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0205960:	6d14                	ld	a3,24(a0)
ffffffffc0205962:	6910                	ld	a2,16(a0)
ffffffffc0205964:	650c                	ld	a1,8(a0)
ffffffffc0205966:	6108                	ld	a0,0(a0)
ffffffffc0205968:	e5dfe06f          	j	ffffffffc02047c4 <do_execve>

ffffffffc020596c <sys_wait>:
    return do_wait(pid, store);
ffffffffc020596c:	650c                	ld	a1,8(a0)
ffffffffc020596e:	4108                	lw	a0,0(a0)
ffffffffc0205970:	c90ff06f          	j	ffffffffc0204e00 <do_wait>

ffffffffc0205974 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0205974:	000b0797          	auipc	a5,0xb0
ffffffffc0205978:	cd47b783          	ld	a5,-812(a5) # ffffffffc02b5648 <current>
    return do_fork(0, stack, tf);
ffffffffc020597c:	4501                	li	a0,0
    struct trapframe *tf = current->tf;
ffffffffc020597e:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0205980:	6a0c                	ld	a1,16(a2)
ffffffffc0205982:	d62fe06f          	j	ffffffffc0203ee4 <do_fork>

ffffffffc0205986 <sys_exit>:
    return do_exit(error_code);
ffffffffc0205986:	4108                	lw	a0,0(a0)
ffffffffc0205988:	9f3fe06f          	j	ffffffffc020437a <do_exit>

ffffffffc020598c <syscall>:
...
syscall(void) {
    struct trapframe *tf = current->tf;
ffffffffc020598c:	000b0697          	auipc	a3,0xb0
ffffffffc0205990:	cbc6b683          	ld	a3,-836(a3) # ffffffffc02b5648 <current>
syscall(void) {
ffffffffc0205994:	715d                	addi	sp,sp,-80
ffffffffc0205996:	e0a2                	sd	s0,64(sp)
    struct trapframe *tf = current->tf;
ffffffffc0205998:	72c0                	ld	s0,160(a3)
syscall(void) {
ffffffffc020599a:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020599c:	0ff00793          	li	a5,255
    int num = tf->gpr.a0;
ffffffffc02059a0:	4834                	lw	a3,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02059a2:	02d7ec63          	bltu	a5,a3,ffffffffc02059da <syscall+0x4e>
        if (syscalls[num] != NULL) {
ffffffffc02059a6:	00002797          	auipc	a5,0x2
ffffffffc02059aa:	3ba78793          	addi	a5,a5,954 # ffffffffc0207d60 <syscalls>
ffffffffc02059ae:	00369613          	slli	a2,a3,0x3
ffffffffc02059b2:	97b2                	add	a5,a5,a2
ffffffffc02059b4:	639c                	ld	a5,0(a5)
ffffffffc02059b6:	c395                	beqz	a5,ffffffffc02059da <syscall+0x4e>
            arg[0] = tf->gpr.a1;
ffffffffc02059b8:	7028                	ld	a0,96(s0)
ffffffffc02059ba:	742c                	ld	a1,104(s0)
ffffffffc02059bc:	7830                	ld	a2,112(s0)
ffffffffc02059be:	7c34                	ld	a3,120(s0)
ffffffffc02059c0:	6c38                	ld	a4,88(s0)
ffffffffc02059c2:	f02a                	sd	a0,32(sp)
ffffffffc02059c4:	f42e                	sd	a1,40(sp)
ffffffffc02059c6:	f832                	sd	a2,48(sp)
ffffffffc02059c8:	fc36                	sd	a3,56(sp)
ffffffffc02059ca:	ec3a                	sd	a4,24(sp)
            arg[1] = tf->gpr.a2;
            arg[2] = tf->gpr.a3;
            arg[3] = tf->gpr.a4;
            arg[4] = tf->gpr.a5;
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02059cc:	0828                	addi	a0,sp,24
ffffffffc02059ce:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02059d0:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02059d2:	e828                	sd	a0,80(s0)
}
ffffffffc02059d4:	6406                	ld	s0,64(sp)
ffffffffc02059d6:	6161                	addi	sp,sp,80
ffffffffc02059d8:	8082                	ret
    print_trapframe(tf);
ffffffffc02059da:	8522                	mv	a0,s0
ffffffffc02059dc:	e436                	sd	a3,8(sp)
ffffffffc02059de:	91cfb0ef          	jal	ffffffffc0200afa <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02059e2:	000b0797          	auipc	a5,0xb0
ffffffffc02059e6:	c667b783          	ld	a5,-922(a5) # ffffffffc02b5648 <current>
ffffffffc02059ea:	66a2                	ld	a3,8(sp)
ffffffffc02059ec:	00002617          	auipc	a2,0x2
ffffffffc02059f0:	14c60613          	addi	a2,a2,332 # ffffffffc0207b38 <etext+0x1c6e>
ffffffffc02059f4:	43d8                	lw	a4,4(a5)
ffffffffc02059f6:	06c00593          	li	a1,108
ffffffffc02059fa:	0b478793          	addi	a5,a5,180
ffffffffc02059fe:	00002517          	auipc	a0,0x2
ffffffffc0205a02:	16a50513          	addi	a0,a0,362 # ffffffffc0207b68 <etext+0x1c9e>
ffffffffc0205a06:	a45fa0ef          	jal	ffffffffc020044a <__panic>

ffffffffc0205a0a <hash32>:
 *
...
ffffffffc0205a0a:	9e3707b7          	lui	a5,0x9e370
ffffffffc0205a0e:	2785                	addiw	a5,a5,1 # ffffffff9e370001 <_binary_obj___user_matrix_out_size+0xffffffff9e364ad1>
ffffffffc0205a10:	02a787bb          	mulw	a5,a5,a0
    return (hash >> (32 - bits));
ffffffffc0205a14:	02000513          	li	a0,32
ffffffffc0205a18:	9d0d                	subw	a0,a0,a1
}
ffffffffc0205a1a:	00a7d53b          	srlw	a0,a5,a0
ffffffffc0205a1e:	8082                	ret

ffffffffc0205a20 <printnum>:
...
ffffffffc0205a20:	7179                	addi	sp,sp,-48
    unsigned long long result = num;
    unsigned mod = do_div(result, base);
ffffffffc0205a22:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205a26:	f022                	sd	s0,32(sp)
ffffffffc0205a28:	ec26                	sd	s1,24(sp)
ffffffffc0205a2a:	e84a                	sd	s2,16(sp)
ffffffffc0205a2c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0205a2e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205a32:	f406                	sd	ra,40(sp)
    unsigned mod = do_div(result, base);
ffffffffc0205a34:	03067a33          	remu	s4,a2,a6
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0205a38:	fff7041b          	addiw	s0,a4,-1
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205a3c:	84aa                	mv	s1,a0
ffffffffc0205a3e:	892e                	mv	s2,a1
    if (num >= base) {
ffffffffc0205a40:	03067d63          	bgeu	a2,a6,ffffffffc0205a7a <printnum+0x5a>
ffffffffc0205a44:	e44e                	sd	s3,8(sp)
ffffffffc0205a46:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0205a48:	4785                	li	a5,1
ffffffffc0205a4a:	00e7d763          	bge	a5,a4,ffffffffc0205a58 <printnum+0x38>
            putch(padc, putdat);
ffffffffc0205a4e:	85ca                	mv	a1,s2
ffffffffc0205a50:	854e                	mv	a0,s3
        while (-- width > 0)
ffffffffc0205a52:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0205a54:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0205a56:	fc65                	bnez	s0,ffffffffc0205a4e <printnum+0x2e>
ffffffffc0205a58:	69a2                	ld	s3,8(sp)
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205a5a:	00002797          	auipc	a5,0x2
ffffffffc0205a5e:	12678793          	addi	a5,a5,294 # ffffffffc0207b80 <etext+0x1cb6>
ffffffffc0205a62:	97d2                	add	a5,a5,s4
...
ffffffffc0205a64:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205a66:	0007c503          	lbu	a0,0(a5)
}
ffffffffc0205a6a:	70a2                	ld	ra,40(sp)
ffffffffc0205a6c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205a6e:	85ca                	mv	a1,s2
ffffffffc0205a70:	87a6                	mv	a5,s1
}
ffffffffc0205a72:	6942                	ld	s2,16(sp)
ffffffffc0205a74:	64e2                	ld	s1,24(sp)
ffffffffc0205a76:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205a78:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0205a7a:	03065633          	divu	a2,a2,a6
ffffffffc0205a7e:	8722                	mv	a4,s0
ffffffffc0205a80:	fa1ff0ef          	jal	ffffffffc0205a20 <printnum>
ffffffffc0205a84:	bfd9                	j	ffffffffc0205a5a <printnum+0x3a>

ffffffffc0205a86 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0205a86:	7119                	addi	sp,sp,-128
ffffffffc0205a88:	f4a6                	sd	s1,104(sp)
ffffffffc0205a8a:	f0ca                	sd	s2,96(sp)
ffffffffc0205a8c:	ecce                	sd	s3,88(sp)
ffffffffc0205a8e:	e8d2                	sd	s4,80(sp)
ffffffffc0205a90:	e4d6                	sd	s5,72(sp)
ffffffffc0205a92:	e0da                	sd	s6,64(sp)
ffffffffc0205a94:	f862                	sd	s8,48(sp)
ffffffffc0205a96:	fc86                	sd	ra,120(sp)
ffffffffc0205a98:	f8a2                	sd	s0,112(sp)
ffffffffc0205a9a:	fc5e                	sd	s7,56(sp)
ffffffffc0205a9c:	f466                	sd	s9,40(sp)
ffffffffc0205a9e:	f06a                	sd	s10,32(sp)
ffffffffc0205aa0:	ec6e                	sd	s11,24(sp)
ffffffffc0205aa2:	84aa                	mv	s1,a0
ffffffffc0205aa4:	8c32                	mv	s8,a2
ffffffffc0205aa6:	8a36                	mv	s4,a3
ffffffffc0205aa8:	892e                	mv	s2,a1
    register int ch, err;
...
ffffffffc0205aaa:	02500993          	li	s3,37
        char padc = ' ';
        width = precision = -1;
        lflag = altflag = 0;
...
ffffffffc0205aae:	05500b13          	li	s6,85
ffffffffc0205ab2:	00003a97          	auipc	s5,0x3
ffffffffc0205ab6:	aaea8a93          	addi	s5,s5,-1362 # ffffffffc0208560 <syscalls+0x800>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0205aba:	000c4503          	lbu	a0,0(s8)
ffffffffc0205abe:	001c0413          	addi	s0,s8,1
ffffffffc0205ac2:	01350a63          	beq	a0,s3,ffffffffc0205ad6 <vprintfmt+0x50>
            if (ch == '\0') {
ffffffffc0205ac6:	cd0d                	beqz	a0,ffffffffc0205b00 <vprintfmt+0x7a>
            putch(ch, putdat);
ffffffffc0205ac8:	85ca                	mv	a1,s2
ffffffffc0205aca:	9482                	jalr	s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0205acc:	00044503          	lbu	a0,0(s0)
ffffffffc0205ad0:	0405                	addi	s0,s0,1
ffffffffc0205ad2:	ff351ae3          	bne	a0,s3,ffffffffc0205ac6 <vprintfmt+0x40>
        width = precision = -1;
ffffffffc0205ad6:	5cfd                	li	s9,-1
ffffffffc0205ad8:	8d66                	mv	s10,s9
        char padc = ' ';
ffffffffc0205ada:	02000d93          	li	s11,32
        lflag = altflag = 0;
ffffffffc0205ade:	4b81                	li	s7,0
ffffffffc0205ae0:	4781                	li	a5,0
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205ae2:	00044683          	lbu	a3,0(s0)
ffffffffc0205ae6:	00140c13          	addi	s8,s0,1
ffffffffc0205aea:	fdd6859b          	addiw	a1,a3,-35
ffffffffc0205aee:	0ff5f593          	zext.b	a1,a1
ffffffffc0205af2:	02bb6663          	bltu	s6,a1,ffffffffc0205b1e <vprintfmt+0x98>
ffffffffc0205af6:	058a                	slli	a1,a1,0x2
ffffffffc0205af8:	95d6                	add	a1,a1,s5
ffffffffc0205afa:	4198                	lw	a4,0(a1)
ffffffffc0205afc:	9756                	add	a4,a4,s5
ffffffffc0205afe:	8702                	jr	a4
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0205b00:	70e6                	ld	ra,120(sp)
ffffffffc0205b02:	7446                	ld	s0,112(sp)
ffffffffc0205b04:	74a6                	ld	s1,104(sp)
ffffffffc0205b06:	7906                	ld	s2,96(sp)
ffffffffc0205b08:	69e6                	ld	s3,88(sp)
ffffffffc0205b0a:	6a46                	ld	s4,80(sp)
ffffffffc0205b0c:	6aa6                	ld	s5,72(sp)
ffffffffc0205b0e:	6b06                	ld	s6,64(sp)
ffffffffc0205b10:	7be2                	ld	s7,56(sp)
ffffffffc0205b12:	7c42                	ld	s8,48(sp)
ffffffffc0205b14:	7ca2                	ld	s9,40(sp)
ffffffffc0205b16:	7d02                	ld	s10,32(sp)
ffffffffc0205b18:	6de2                	ld	s11,24(sp)
ffffffffc0205b1a:	6109                	addi	sp,sp,128
ffffffffc0205b1c:	8082                	ret
            putch('%', putdat);
ffffffffc0205b1e:	85ca                	mv	a1,s2
ffffffffc0205b20:	02500513          	li	a0,37
ffffffffc0205b24:	9482                	jalr	s1
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0205b26:	fff44783          	lbu	a5,-1(s0)
ffffffffc0205b2a:	02500713          	li	a4,37
ffffffffc0205b2e:	8c22                	mv	s8,s0
ffffffffc0205b30:	f8e785e3          	beq	a5,a4,ffffffffc0205aba <vprintfmt+0x34>
ffffffffc0205b34:	ffec4783          	lbu	a5,-2(s8)
ffffffffc0205b38:	1c7d                	addi	s8,s8,-1
ffffffffc0205b3a:	fee79de3          	bne	a5,a4,ffffffffc0205b34 <vprintfmt+0xae>
ffffffffc0205b3e:	bfb5                	j	ffffffffc0205aba <vprintfmt+0x34>
                ch = *fmt;
ffffffffc0205b40:	00144603          	lbu	a2,1(s0)
                if (ch < '0' || ch > '9') {
ffffffffc0205b44:	4525                	li	a0,9
                precision = precision * 10 + ch - '0';
ffffffffc0205b46:	fd068c9b          	addiw	s9,a3,-48
                if (ch < '0' || ch > '9') {
ffffffffc0205b4a:	fd06071b          	addiw	a4,a2,-48
ffffffffc0205b4e:	24e56a63          	bltu	a0,a4,ffffffffc0205da2 <vprintfmt+0x31c>
                ch = *fmt;
ffffffffc0205b52:	2601                	sext.w	a2,a2
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205b54:	8462                	mv	s0,s8
                precision = precision * 10 + ch - '0';
ffffffffc0205b56:	002c971b          	slliw	a4,s9,0x2
                ch = *fmt;
ffffffffc0205b5a:	00144683          	lbu	a3,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0205b5e:	0197073b          	addw	a4,a4,s9
ffffffffc0205b62:	0017171b          	slliw	a4,a4,0x1
ffffffffc0205b66:	9f31                	addw	a4,a4,a2
                if (ch < '0' || ch > '9') {
ffffffffc0205b68:	fd06859b          	addiw	a1,a3,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0205b6c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0205b6e:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0205b72:	0006861b          	sext.w	a2,a3
                if (ch < '0' || ch > '9') {
ffffffffc0205b76:	feb570e3          	bgeu	a0,a1,ffffffffc0205b56 <vprintfmt+0xd0>
            if (width < 0)
ffffffffc0205b7a:	f60d54e3          	bgez	s10,ffffffffc0205ae2 <vprintfmt+0x5c>
                width = precision, precision = -1;
ffffffffc0205b7e:	8d66                	mv	s10,s9
ffffffffc0205b80:	5cfd                	li	s9,-1
ffffffffc0205b82:	b785                	j	ffffffffc0205ae2 <vprintfmt+0x5c>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205b84:	8db6                	mv	s11,a3
ffffffffc0205b86:	8462                	mv	s0,s8
ffffffffc0205b88:	bfa9                	j	ffffffffc0205ae2 <vprintfmt+0x5c>
ffffffffc0205b8a:	8462                	mv	s0,s8
            altflag = 1;
ffffffffc0205b8c:	4b85                	li	s7,1
            goto reswitch;
ffffffffc0205b8e:	bf91                	j	ffffffffc0205ae2 <vprintfmt+0x5c>
    if (lflag >= 2) {
ffffffffc0205b90:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205b92:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205b96:	00f74463          	blt	a4,a5,ffffffffc0205b9e <vprintfmt+0x118>
    else if (lflag) {
ffffffffc0205b9a:	1a078763          	beqz	a5,ffffffffc0205d48 <vprintfmt+0x2c2>
        return va_arg(*ap, unsigned long);
ffffffffc0205b9e:	000a3603          	ld	a2,0(s4)
ffffffffc0205ba2:	46c1                	li	a3,16
ffffffffc0205ba4:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0205ba6:	000d879b          	sext.w	a5,s11
ffffffffc0205baa:	876a                	mv	a4,s10
ffffffffc0205bac:	85ca                	mv	a1,s2
ffffffffc0205bae:	8526                	mv	a0,s1
ffffffffc0205bb0:	e71ff0ef          	jal	ffffffffc0205a20 <printnum>
            break;
ffffffffc0205bb4:	b719                	j	ffffffffc0205aba <vprintfmt+0x34>
            putch(va_arg(ap, int), putdat);
ffffffffc0205bb6:	000a2503          	lw	a0,0(s4)
ffffffffc0205bba:	85ca                	mv	a1,s2
ffffffffc0205bbc:	0a21                	addi	s4,s4,8
ffffffffc0205bbe:	9482                	jalr	s1
            break;
ffffffffc0205bc0:	bded                	j	ffffffffc0205aba <vprintfmt+0x34>
    if (lflag >= 2) {
ffffffffc0205bc2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205bc4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205bc8:	00f74463          	blt	a4,a5,ffffffffc0205bd0 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0205bcc:	16078963          	beqz	a5,ffffffffc0205d3e <vprintfmt+0x2b8>
        return va_arg(*ap, unsigned long);
ffffffffc0205bd0:	000a3603          	ld	a2,0(s4)
ffffffffc0205bd4:	46a9                	li	a3,10
ffffffffc0205bd6:	8a2e                	mv	s4,a1
ffffffffc0205bd8:	b7f9                	j	ffffffffc0205ba6 <vprintfmt+0x120>
            putch('0', putdat);
ffffffffc0205bda:	85ca                	mv	a1,s2
ffffffffc0205bdc:	03000513          	li	a0,48
ffffffffc0205be0:	9482                	jalr	s1
            putch('x', putdat);
ffffffffc0205be2:	85ca                	mv	a1,s2
ffffffffc0205be4:	07800513          	li	a0,120
ffffffffc0205be8:	9482                	jalr	s1
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205bea:	000a3603          	ld	a2,0(s4)
            goto number;
ffffffffc0205bee:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205bf0:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0205bf2:	bf55                	j	ffffffffc0205ba6 <vprintfmt+0x120>
            putch(ch, putdat);
ffffffffc0205bf4:	85ca                	mv	a1,s2
ffffffffc0205bf6:	02500513          	li	a0,37
ffffffffc0205bfa:	9482                	jalr	s1
            break;
ffffffffc0205bfc:	bd7d                	j	ffffffffc0205aba <vprintfmt+0x34>
            precision = va_arg(ap, int);
ffffffffc0205bfe:	000a2c83          	lw	s9,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205c02:	8462                	mv	s0,s8
            precision = va_arg(ap, int);
ffffffffc0205c04:	0a21                	addi	s4,s4,8
            goto process_precision;
ffffffffc0205c06:	bf95                	j	ffffffffc0205b7a <vprintfmt+0xf4>
    if (lflag >= 2) {
ffffffffc0205c08:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205c0a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205c0e:	00f74463          	blt	a4,a5,ffffffffc0205c16 <vprintfmt+0x190>
    else if (lflag) {
ffffffffc0205c12:	12078163          	beqz	a5,ffffffffc0205d34 <vprintfmt+0x2ae>
        return va_arg(*ap, unsigned long);
ffffffffc0205c16:	000a3603          	ld	a2,0(s4)
ffffffffc0205c1a:	46a1                	li	a3,8
ffffffffc0205c1c:	8a2e                	mv	s4,a1
ffffffffc0205c1e:	b761                	j	ffffffffc0205ba6 <vprintfmt+0x120>
            if (width < 0)
ffffffffc0205c20:	876a                	mv	a4,s10
ffffffffc0205c22:	000d5363          	bgez	s10,ffffffffc0205c28 <vprintfmt+0x1a2>
ffffffffc0205c26:	4701                	li	a4,0
ffffffffc0205c28:	00070d1b          	sext.w	s10,a4
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205c2c:	8462                	mv	s0,s8
            goto reswitch;
ffffffffc0205c2e:	bd55                	j	ffffffffc0205ae2 <vprintfmt+0x5c>
            if (width > 0 && padc != '-') {
ffffffffc0205c30:	000d841b          	sext.w	s0,s11
ffffffffc0205c34:	fd340793          	addi	a5,s0,-45
ffffffffc0205c38:	00f037b3          	snez	a5,a5
ffffffffc0205c3c:	01a02733          	sgtz	a4,s10
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205c40:	000a3d83          	ld	s11,0(s4)
            if (width > 0 && padc != '-') {
ffffffffc0205c44:	8f7d                	and	a4,a4,a5
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205c46:	008a0793          	addi	a5,s4,8
ffffffffc0205c4a:	e43e                	sd	a5,8(sp)
ffffffffc0205c4c:	100d8c63          	beqz	s11,ffffffffc0205d64 <vprintfmt+0x2de>
            if (width > 0 && padc != '-') {
ffffffffc0205c50:	12071363          	bnez	a4,ffffffffc0205d76 <vprintfmt+0x2f0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205c54:	000dc783          	lbu	a5,0(s11)
ffffffffc0205c58:	0007851b          	sext.w	a0,a5
ffffffffc0205c5c:	c78d                	beqz	a5,ffffffffc0205c86 <vprintfmt+0x200>
ffffffffc0205c5e:	0d85                	addi	s11,s11,1
ffffffffc0205c60:	547d                	li	s0,-1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205c62:	05e00a13          	li	s4,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205c66:	000cc563          	bltz	s9,ffffffffc0205c70 <vprintfmt+0x1ea>
ffffffffc0205c6a:	3cfd                	addiw	s9,s9,-1
ffffffffc0205c6c:	008c8d63          	beq	s9,s0,ffffffffc0205c86 <vprintfmt+0x200>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205c70:	020b9663          	bnez	s7,ffffffffc0205c9c <vprintfmt+0x216>
                    putch(ch, putdat);
ffffffffc0205c74:	85ca                	mv	a1,s2
ffffffffc0205c76:	9482                	jalr	s1
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205c78:	000dc783          	lbu	a5,0(s11)
ffffffffc0205c7c:	0d85                	addi	s11,s11,1
ffffffffc0205c7e:	3d7d                	addiw	s10,s10,-1
ffffffffc0205c80:	0007851b          	sext.w	a0,a5
ffffffffc0205c84:	f3ed                	bnez	a5,ffffffffc0205c66 <vprintfmt+0x1e0>
            for (; width > 0; width --) {
ffffffffc0205c86:	01a05963          	blez	s10,ffffffffc0205c98 <vprintfmt+0x212>
                putch(' ', putdat);
ffffffffc0205c8a:	85ca                	mv	a1,s2
ffffffffc0205c8c:	02000513          	li	a0,32
            for (; width > 0; width --) {
ffffffffc0205c90:	3d7d                	addiw	s10,s10,-1
                putch(' ', putdat);
ffffffffc0205c92:	9482                	jalr	s1
            for (; width > 0; width --) {
ffffffffc0205c94:	fe0d1be3          	bnez	s10,ffffffffc0205c8a <vprintfmt+0x204>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205c98:	6a22                	ld	s4,8(sp)
ffffffffc0205c9a:	b505                	j	ffffffffc0205aba <vprintfmt+0x34>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205c9c:	3781                	addiw	a5,a5,-32
ffffffffc0205c9e:	fcfa7be3          	bgeu	s4,a5,ffffffffc0205c74 <vprintfmt+0x1ee>
                    putch('?', putdat);
ffffffffc0205ca2:	03f00513          	li	a0,63
ffffffffc0205ca6:	85ca                	mv	a1,s2
ffffffffc0205ca8:	9482                	jalr	s1
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205caa:	000dc783          	lbu	a5,0(s11)
ffffffffc0205cae:	0d85                	addi	s11,s11,1
ffffffffc0205cb0:	3d7d                	addiw	s10,s10,-1
ffffffffc0205cb2:	0007851b          	sext.w	a0,a5
ffffffffc0205cb6:	dbe1                	beqz	a5,ffffffffc0205c86 <vprintfmt+0x200>
ffffffffc0205cb8:	fa0cd9e3          	bgez	s9,ffffffffc0205c6a <vprintfmt+0x1e4>
ffffffffc0205cbc:	b7c5                	j	ffffffffc0205c9c <vprintfmt+0x216>
            if (err < 0) {
ffffffffc0205cbe:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205cc2:	4661                	li	a2,24
            err = va_arg(ap, int);
ffffffffc0205cc4:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0205cc6:	41f7d71b          	sraiw	a4,a5,0x1f
ffffffffc0205cca:	8fb9                	xor	a5,a5,a4
ffffffffc0205ccc:	40e786bb          	subw	a3,a5,a4
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205cd0:	02d64563          	blt	a2,a3,ffffffffc0205cfa <vprintfmt+0x274>
ffffffffc0205cd4:	00003797          	auipc	a5,0x3
ffffffffc0205cd8:	9e478793          	addi	a5,a5,-1564 # ffffffffc02086b8 <error_string>
ffffffffc0205cdc:	00369713          	slli	a4,a3,0x3
ffffffffc0205ce0:	97ba                	add	a5,a5,a4
ffffffffc0205ce2:	639c                	ld	a5,0(a5)
ffffffffc0205ce4:	cb99                	beqz	a5,ffffffffc0205cfa <vprintfmt+0x274>
                printfmt(putch, putdat, "%s", p);
ffffffffc0205ce6:	86be                	mv	a3,a5
ffffffffc0205ce8:	00000617          	auipc	a2,0x0
ffffffffc0205cec:	21060613          	addi	a2,a2,528 # ffffffffc0205ef8 <etext+0x2e>
ffffffffc0205cf0:	85ca                	mv	a1,s2
ffffffffc0205cf2:	8526                	mv	a0,s1
ffffffffc0205cf4:	0d8000ef          	jal	ffffffffc0205dcc <printfmt>
ffffffffc0205cf8:	b3c9                	j	ffffffffc0205aba <vprintfmt+0x34>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0205cfa:	00002617          	auipc	a2,0x2
ffffffffc0205cfe:	ea660613          	addi	a2,a2,-346 # ffffffffc0207ba0 <etext+0x1cd6>
ffffffffc0205d02:	85ca                	mv	a1,s2
ffffffffc0205d04:	8526                	mv	a0,s1
ffffffffc0205d06:	0c6000ef          	jal	ffffffffc0205dcc <printfmt>
ffffffffc0205d0a:	bb45                	j	ffffffffc0205aba <vprintfmt+0x34>
    if (lflag >= 2) {
ffffffffc0205d0c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205d0e:	008a0b93          	addi	s7,s4,8
    if (lflag >= 2) {
ffffffffc0205d12:	00f74363          	blt	a4,a5,ffffffffc0205d18 <vprintfmt+0x292>
    else if (lflag) {
ffffffffc0205d16:	cf81                	beqz	a5,ffffffffc0205d2e <vprintfmt+0x2a8>
        return va_arg(*ap, long);
ffffffffc0205d18:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0205d1c:	02044b63          	bltz	s0,ffffffffc0205d52 <vprintfmt+0x2cc>
            num = getint(&ap, lflag);
ffffffffc0205d20:	8622                	mv	a2,s0
ffffffffc0205d22:	8a5e                	mv	s4,s7
ffffffffc0205d24:	46a9                	li	a3,10
ffffffffc0205d26:	b541                	j	ffffffffc0205ba6 <vprintfmt+0x120>
            lflag ++;
ffffffffc0205d28:	2785                	addiw	a5,a5,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205d2a:	8462                	mv	s0,s8
            goto reswitch;
ffffffffc0205d2c:	bb5d                	j	ffffffffc0205ae2 <vprintfmt+0x5c>
        return va_arg(*ap, int);
ffffffffc0205d2e:	000a2403          	lw	s0,0(s4)
ffffffffc0205d32:	b7ed                	j	ffffffffc0205d1c <vprintfmt+0x296>
        return va_arg(*ap, unsigned int);
ffffffffc0205d34:	000a6603          	lwu	a2,0(s4)
ffffffffc0205d38:	46a1                	li	a3,8
ffffffffc0205d3a:	8a2e                	mv	s4,a1
ffffffffc0205d3c:	b5ad                	j	ffffffffc0205ba6 <vprintfmt+0x120>
ffffffffc0205d3e:	000a6603          	lwu	a2,0(s4)
ffffffffc0205d42:	46a9                	li	a3,10
ffffffffc0205d44:	8a2e                	mv	s4,a1
ffffffffc0205d46:	b585                	j	ffffffffc0205ba6 <vprintfmt+0x120>
ffffffffc0205d48:	000a6603          	lwu	a2,0(s4)
ffffffffc0205d4c:	46c1                	li	a3,16
ffffffffc0205d4e:	8a2e                	mv	s4,a1
ffffffffc0205d50:	bd99                	j	ffffffffc0205ba6 <vprintfmt+0x120>
                putch('-', putdat);
ffffffffc0205d52:	85ca                	mv	a1,s2
ffffffffc0205d54:	02d00513          	li	a0,45
ffffffffc0205d58:	9482                	jalr	s1
                num = -(long long)num;
ffffffffc0205d5a:	40800633          	neg	a2,s0
ffffffffc0205d5e:	8a5e                	mv	s4,s7
ffffffffc0205d60:	46a9                	li	a3,10
ffffffffc0205d62:	b591                	j	ffffffffc0205ba6 <vprintfmt+0x120>
            if (width > 0 && padc != '-') {
ffffffffc0205d64:	e329                	bnez	a4,ffffffffc0205da6 <vprintfmt+0x320>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205d66:	02800793          	li	a5,40
ffffffffc0205d6a:	853e                	mv	a0,a5
ffffffffc0205d6c:	00002d97          	auipc	s11,0x2
ffffffffc0205d70:	e2dd8d93          	addi	s11,s11,-467 # ffffffffc0207b99 <etext+0x1ccf>
ffffffffc0205d74:	b5f5                	j	ffffffffc0205c60 <vprintfmt+0x1da>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205d76:	85e6                	mv	a1,s9
ffffffffc0205d78:	856e                	mv	a0,s11
ffffffffc0205d7a:	08a000ef          	jal	ffffffffc0205e04 <strnlen>
ffffffffc0205d7e:	40ad0d3b          	subw	s10,s10,a0
ffffffffc0205d82:	01a05863          	blez	s10,ffffffffc0205d92 <vprintfmt+0x30c>
                    putch(padc, putdat);
ffffffffc0205d86:	85ca                	mv	a1,s2
ffffffffc0205d88:	8522                	mv	a0,s0
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205d8a:	3d7d                	addiw	s10,s10,-1
                    putch(padc, putdat);
ffffffffc0205d8c:	9482                	jalr	s1
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205d8e:	fe0d1ce3          	bnez	s10,ffffffffc0205d86 <vprintfmt+0x300>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205d92:	000dc783          	lbu	a5,0(s11)
ffffffffc0205d96:	0007851b          	sext.w	a0,a5
ffffffffc0205d9a:	ec0792e3          	bnez	a5,ffffffffc0205c5e <vprintfmt+0x1d8>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205d9e:	6a22                	ld	s4,8(sp)
ffffffffc0205da0:	bb29                	j	ffffffffc0205aba <vprintfmt+0x34>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205da2:	8462                	mv	s0,s8
ffffffffc0205da4:	bbd9                	j	ffffffffc0205b7a <vprintfmt+0xf4>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205da6:	85e6                	mv	a1,s9
ffffffffc0205da8:	00002517          	auipc	a0,0x2
ffffffffc0205dac:	df050513          	addi	a0,a0,-528 # ffffffffc0207b98 <etext+0x1cce>
ffffffffc0205db0:	054000ef          	jal	ffffffffc0205e04 <strnlen>
ffffffffc0205db4:	40ad0d3b          	subw	s10,s10,a0
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205db8:	02800793          	li	a5,40
                p = "(null)";
ffffffffc0205dbc:	00002d97          	auipc	s11,0x2
ffffffffc0205dc0:	ddcd8d93          	addi	s11,s11,-548 # ffffffffc0207b98 <etext+0x1cce>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205dc4:	853e                	mv	a0,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205dc6:	fda040e3          	bgtz	s10,ffffffffc0205d86 <vprintfmt+0x300>
ffffffffc0205dca:	bd51                	j	ffffffffc0205c5e <vprintfmt+0x1d8>

ffffffffc0205dcc <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0205dcc:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0205dce:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0205dd2:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205dd4:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0205dd6:	ec06                	sd	ra,24(sp)
ffffffffc0205dd8:	f83a                	sd	a4,48(sp)
ffffffffc0205dda:	fc3e                	sd	a5,56(sp)
ffffffffc0205ddc:	e0c2                	sd	a6,64(sp)
ffffffffc0205dde:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0205de0:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205de2:	ca5ff0ef          	jal	ffffffffc0205a86 <vprintfmt>
}
ffffffffc0205de6:	60e2                	ld	ra,24(sp)
ffffffffc0205de8:	6161                	addi	sp,sp,80
ffffffffc0205dea:	8082                	ret

ffffffffc0205dec <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0205dec:	00054783          	lbu	a5,0(a0)
ffffffffc0205df0:	cb81                	beqz	a5,ffffffffc0205e00 <strlen+0x14>
    size_t cnt = 0;
ffffffffc0205df2:	4781                	li	a5,0
        cnt ++;
ffffffffc0205df4:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0205df6:	00f50733          	add	a4,a0,a5
ffffffffc0205dfa:	00074703          	lbu	a4,0(a4)
ffffffffc0205dfe:	fb7d                	bnez	a4,ffffffffc0205df4 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0205e00:	853e                	mv	a0,a5
ffffffffc0205e02:	8082                	ret

ffffffffc0205e04 <strnlen>:
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0205e04:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0205e06:	e589                	bnez	a1,ffffffffc0205e10 <strnlen+0xc>
ffffffffc0205e08:	a811                	j	ffffffffc0205e1c <strnlen+0x18>
        cnt ++;
ffffffffc0205e0a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0205e0c:	00f58863          	beq	a1,a5,ffffffffc0205e1c <strnlen+0x18>
ffffffffc0205e10:	00f50733          	add	a4,a0,a5
ffffffffc0205e14:	00074703          	lbu	a4,0(a4)
ffffffffc0205e18:	fb6d                	bnez	a4,ffffffffc0205e0a <strnlen+0x6>
ffffffffc0205e1a:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0205e1c:	852e                	mv	a0,a1
ffffffffc0205e1e:	8082                	ret

ffffffffc0205e20 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0205e20:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0205e22:	0005c703          	lbu	a4,0(a1)
ffffffffc0205e26:	0585                	addi	a1,a1,1
ffffffffc0205e28:	0785                	addi	a5,a5,1
ffffffffc0205e2a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0205e2e:	fb75                	bnez	a4,ffffffffc0205e22 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205e32:	00054783          	lbu	a5,0(a0)
ffffffffc0205e36:	e791                	bnez	a5,ffffffffc0205e42 <strcmp+0x10>
ffffffffc0205e38:	a01d                	j	ffffffffc0205e5e <strcmp+0x2c>
ffffffffc0205e3a:	00054783          	lbu	a5,0(a0)
ffffffffc0205e3e:	cb99                	beqz	a5,ffffffffc0205e54 <strcmp+0x22>
ffffffffc0205e40:	0585                	addi	a1,a1,1
ffffffffc0205e42:	0005c703          	lbu	a4,0(a1)
        s1 ++, s2 ++;
ffffffffc0205e46:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205e48:	fef709e3          	beq	a4,a5,ffffffffc0205e3a <strcmp+0x8>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205e4c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0205e50:	9d19                	subw	a0,a0,a4
ffffffffc0205e52:	8082                	ret
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205e54:	0015c703          	lbu	a4,1(a1)
ffffffffc0205e58:	4501                	li	a0,0
}
ffffffffc0205e5a:	9d19                	subw	a0,a0,a4
ffffffffc0205e5c:	8082                	ret
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205e5e:	0005c703          	lbu	a4,0(a1)
ffffffffc0205e62:	4501                	li	a0,0
ffffffffc0205e64:	b7f5                	j	ffffffffc0205e50 <strcmp+0x1e>

ffffffffc0205e66 <strncmp>:
...
ffffffffc0205e66:	ce01                	beqz	a2,ffffffffc0205e7e <strncmp+0x18>
ffffffffc0205e68:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0205e6c:	167d                	addi	a2,a2,-1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0205e6e:	cb91                	beqz	a5,ffffffffc0205e82 <strncmp+0x1c>
ffffffffc0205e70:	0005c703          	lbu	a4,0(a1)
ffffffffc0205e74:	00f71763          	bne	a4,a5,ffffffffc0205e82 <strncmp+0x1c>
        n --, s1 ++, s2 ++;
ffffffffc0205e78:	0505                	addi	a0,a0,1
ffffffffc0205e7a:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0205e7c:	f675                	bnez	a2,ffffffffc0205e68 <strncmp+0x2>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0205e7e:	4501                	li	a0,0
ffffffffc0205e80:	8082                	ret
ffffffffc0205e82:	00054503          	lbu	a0,0(a0)
ffffffffc0205e86:	0005c783          	lbu	a5,0(a1)
ffffffffc0205e8a:	9d1d                	subw	a0,a0,a5
}
ffffffffc0205e8c:	8082                	ret

ffffffffc0205e8e <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0205e8e:	a021                	j	ffffffffc0205e96 <strchr+0x8>
        if (*s == c) {
ffffffffc0205e90:	00f58763          	beq	a1,a5,ffffffffc0205e9e <strchr+0x10>
            return (char *)s;
        }
        s ++;
ffffffffc0205e94:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0205e96:	00054783          	lbu	a5,0(a0)
ffffffffc0205e9a:	fbfd                	bnez	a5,ffffffffc0205e90 <strchr+0x2>
    }
    return NULL;
ffffffffc0205e9c:	4501                	li	a0,0
}
ffffffffc0205e9e:	8082                	ret

ffffffffc0205ea0 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0205ea0:	ca01                	beqz	a2,ffffffffc0205eb0 <memset+0x10>
ffffffffc0205ea2:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0205ea4:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0205ea6:	0785                	addi	a5,a5,1
ffffffffc0205ea8:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0205eac:	fef61de3          	bne	a2,a5,ffffffffc0205ea6 <memset+0x6>
    }
    return s;
...
ffffffffc0205eb2 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0205eb2:	ca19                	beqz	a2,ffffffffc0205ec8 <memcpy+0x16>
ffffffffc0205eb4:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0205eb6:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0205eb8:	0005c703          	lbu	a4,0(a1)
ffffffffc0205ebc:	0585                	addi	a1,a1,1
ffffffffc0205ebe:	0785                	addi	a5,a5,1
ffffffffc0205ec0:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0205ec4:	feb61ae3          	bne	a2,a1,ffffffffc0205eb8 <memcpy+0x6>
    }
    return dst;
